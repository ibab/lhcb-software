#ifndef MASSMONITOR_IOVDEFINITIONS_HH 
#define MASSMONITOR_IOVDEFINITIONS_HH 1

#include <string>

const std::string iov_data_2011 =
...
const std::string iov_data_2012 =
...
#endif // MASSMONITOR_IOVDEFINITIONS_HH
