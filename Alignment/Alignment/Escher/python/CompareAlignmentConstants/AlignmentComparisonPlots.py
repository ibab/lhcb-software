...
def plotAlignmentParametersTimeSeries( elmGroup, dofs
    ...
    timePeriods = list( period for period in statusPeriodsFromTable("$ESCHERROOT/scripts/DBVisualisationTool/LHCbStatus2011.txt") + statusPeriodsFromTable("$ESCHERROOT/scripts/DBVisualisationTool/LHCbStatus2012.txt") if period.startTime < pUntil and period.endTime > pSince )
