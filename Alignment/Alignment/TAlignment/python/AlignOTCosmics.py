...
if granularity=='layers':
   ...
   elements.OTCFramesASide("TxTyTzRxRyRz")
   elements.OTCFramesCSide("TxTyTzRxRyRz")
   constraints = [
      "T1X1C : /.*?/OT/T1/X1layer/Quarter(0|2)/.*? : Tx Ty Tz Rx Ry Rz",
      "T1X1A : /.*?/OT/T1/X1layer/Quarter(1|3)/.*? : Tx Ty Tz Rx Ry Rz",
      "T3X2C : /.*?/OT/T3/X1layer/Quarter(0|2)/.*? : Tx Ty Tz Rx Ry Rz",
      "T3X2A : /.*?/OT/T3/X1layer/Quarter(1|3)/.*? : Tx Ty Tz Rx Ry Rz"
      ]
