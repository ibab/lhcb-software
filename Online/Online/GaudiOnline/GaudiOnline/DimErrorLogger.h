// $Id: DimErrorLogger.h,v 1.1 2006-04-24 12:18:41 frankb Exp $
...
namespace LHCb  {
  ...
  protected:
    ...
    bool        m_successMsg;
    /// Property: if true accept messages from wildcard matching sources
    std::vector<std::string> m_acceptSources;
