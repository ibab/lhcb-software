...
//
//	===========================================================
#ifndef GAUDIONLINE_HLTMONWRITERRSVC_H
#define GAUDIONLINE_HLTMONWRITERRSVC_H 1
...
namespace MonWriter
{
  ...
  public:
    ...
    FTYPE type;
    time_t m_CloseAt;
    FileDescr(FTYPE t) :m_RunNumber(0),m_Handle(0),m_Sequence(0),m_BytesWritten(0),state(0),type(t),m_CloseAt(0)
    {
    }
  };
  ...
  class HLTMonWriterSvc: public LHCb::OnlineService,
  ...
  public:
    ...
    virtual unsigned int getRunNumber(LHCb::MEPEvent *me);
    /// Open a new file
