// $Id: GaudiOnline.cpp,v 1.19 2007-06-01 17:28:55 frankb Exp $
//====================================================================
//  GaudiOnline_dll.cpp
//--------------------------------------------------------------------
//
...
DECLARE_FACTORY_ENTRIES(GaudiOnline)  {
  ...
  DECLARE_NAMESPACE_ALGORITHM( LHCb,SocketDataSender);
  DECLARE_NAMESPACE_SERVICE(   LHCb,SocketDataReceiver);
}
