...
*/
    ...
    /// Once the end of injection is asked, it is possible that we have to send a MEP which has not reached the Packing Factor.
    if(finalSent) {      
        ...
        if (!m_AutoMode) {
            ...
            /// First, send data MEPS, get their pf and send the odin mep with the pf.
