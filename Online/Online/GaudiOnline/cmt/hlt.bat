...
set UTGID=Moore_0   && start %gaudi_exe% -opt=..\options\ReadMBM.opts      -a
set UTGID=Moore_1   && start %gaudi_exe% -opt=..\options\ReadMBM.opts      -a
set UTGID=Send_0    && start %gaudi_exe% -opt=..\options\FragmentSender.opts  -a
