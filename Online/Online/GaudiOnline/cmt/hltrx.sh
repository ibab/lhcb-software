...
sleep 2
$WIDETERM ErrorLogger@${HOST}    -e "export UTGID=ErrLog; $gaudi_exe2 -opts=$GAUDIONLINEROOT/options/ErrorLogger.opts" &
sleep 3
$MINITERM ErrServ@${HOST} -e "setenv UTGID ErrServ   ; $gaudi_exe -opt=$GAUDIONLINEROOT/options/ErrorSrv.opts" &
#
