...
string DetDesc::XML::_toString(const XMLCh *toTranscode)  {
...
string DetDesc::XML::_toString(Attribute attr)  {
...
string DetDesc::XML::_toString(int v,          const char* fmt)  { return __to_string(v,fmt); }
string DetDesc::XML::_toString(unsigned long v,const char* fmt)  { return __to_string(v,fmt); }
string DetDesc::XML::_toString(unsigned int v, const char* fmt)  { return __to_string(v,fmt); }
string DetDesc::XML::_toString(float  v,       const char* fmt)  { return __to_string(v,fmt); }
string DetDesc::XML::_toString(double v,       const char* fmt)  { return __to_string(v,fmt); }

int DetDesc::XML::_toInt(const XMLCh* value)  {
  if ( value )  {
...
bool   DetDesc::XML::_toBool(const XMLCh* value)   {
  if ( value )  {
    string s = _toString(value);
    return s == "true";
  }
...
float DetDesc::XML::_toFloat(const XMLCh* value)   {
  if ( value )  {
    string s = _toString(value);
    double result = eval.evaluate(s.c_str());
...
double DetDesc::XML::_toDouble(const XMLCh* value)   {
  if ( value )  {
    string s = _toString(value);
    double result = eval.evaluate(s.c_str());
    if (eval.status() != XmlTools::Evaluator::OK) {
...
void DetDesc::XML::_toDictionary(const XMLCh* name, const XMLCh* value)  {
...
Strng_t DetDesc::XML::operator+(const Strng_t& a,     const XMLCh* b)
{  return _toString(a.ptr()) + _toString(b);                      }

Strng_t DetDesc::XML::operator+(const XMLCh* a,       const Strng_t& b)
{  return _toString(a) + _toString(b.ptr());                      }

Strng_t DetDesc::XML::operator+(const XMLCh* a,       const string& b)
{  return _toString(a) + b;                                       }

Strng_t DetDesc::XML::operator+(const string& a, const XMLCh* b)
{  return a + _toString(b);                                       }

Strng_t DetDesc::XML::operator+(const Strng_t& a,     const string& b)  
{  return _toString(a.ptr()) + b;                                  }

Strng_t DetDesc::XML::operator+(const string& a,      const Strng_t& b)  
{  return a + _toString(b.ptr());                                  }

Strng_t DetDesc::XML::operator+(const Strng_t& a,     const char* b)   
{  return _toString(a.ptr()) + b;                                  }

Strng_t DetDesc::XML::operator+(const char* a,        const Strng_t& b)   
{  return string(a) + _toString(b.ptr());                          }

Strng_t DetDesc::XML::operator+(const Strng_t& a,     const Strng_t& b)  
{  return _toString(a.ptr()) + _toString(b.ptr());                 }

Tag_t   DetDesc::XML::operator+(const Tag_t& a,       const char* b)
{  return a.str() + b;                                              }

Tag_t   DetDesc::XML::operator+(const char* a,        const Tag_t& b)
{  return a + b.str();                                              }

Tag_t   DetDesc::XML::operator+(const Tag_t& a,       const XMLCh* b) 
{  return a.str() + _toString(b);                                   }

Tag_t   DetDesc::XML::operator+(const Tag_t& a,       const Strng_t& b)
{  return a.str() + _toString(b);                                   }

Tag_t   DetDesc::XML::operator+(const Tag_t& a,       const string& b)  
{  return a.str() + b;                                              }
