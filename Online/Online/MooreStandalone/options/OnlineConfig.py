...
def serialWriter(name='DstWriter',location='/Event/GaudiSerialize'):
  ...
  ser.Banks = location
  svc.CnvServices.append(ser)
  serial.Output = "DATAFILE='root.buffers' SVC='Gaudi::SerializeCnvSvc' OPT='RECREATE'"
  print '[WARN]  Running GaudiSerializer : Gaudi::SerializeCnvSvc/SerializeCnvSvc'
