...
void *AddSerializer::SerializeHist(void *&ptr, int &siz, bool clear)
{
...
void *AddSerializer::SerializeHist(std::vector<std::string> &nams,void * &ptr,int &siz, bool clear)
{
  int bs=siz;
  void *pp;
...
void *AddSerializer::SerializeHist(char *name, void *&ptr, int &siz, bool clear)
{
  void *pp;
  int bs=siz;
...
void AddSerializer::DeSerializeHist(char *name,void *&ptr)
{
}
void AddSerializer::DeSerializeHist(std::vector<std::string> &nams,void *&ptr)
{
}
