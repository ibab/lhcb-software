...
sleep 2
$WIDETERM ErrorLogger@${HOST}    -e bash -c "export UTGID=ErrLog; $gaudi_exe2 -opts=../options/ErrorLogger.opts" &
sleep 3
$MINITERM ErrServ@${HOST} -e bash -c "export UTGID=ErrServ; $gaudi_exe -opt=../options/ErrorSrv.opts" &
#
