...
export gaudi_exe="${GAUDIONLINEROOT}/${CMTCONFIG}/Gaudi.exe ${GAUDIONLINEROOT}/${CMTCONFIG}/libGaudiOnline.so GaudiOnline -msgsvc=MessageSvc "  

 
#echo Working Directory: $PWD
${gaudi_exe} -options=$LHCBHOME/lhcb/ONLINE/ONLINE_v3r1/Online/OnlineTasks/v1r3/options/GaudiExample.opts -loop
