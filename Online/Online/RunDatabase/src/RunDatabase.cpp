...
//_________________________________________________________________________________________________
RDB::Param RDB::runParam(int run_no, CSTR name)  {
...
//_________________________________________________________________________________________________
RDB::Runs   RDB::runs(int run_low, int run_high)  {
...
//_________________________________________________________________________________________________
RDB::Status RDB::modifyRunParam(int run_no, CSTR name, int value, CSTR type)  {
  _CALL call("modifyRunParam",_OPT(_P("RunNumber",run_no),_P("Name",name),_P("Val",value),_P("Typ",type)));
  return _exec<Status>(this,call);
}
//_________________________________________________________________________________________________
RDB::Status RDB::modifyRunParam(int run_no, CSTR name, float value, CSTR type)  {
  _CALL call("modifyRunParam",_OPT(_P("RunNumber",run_no),_P("Name",name),_P("Val",value),_P("Typ",type)));
  return _exec<Status>(this,call);
}
//_________________________________________________________________________________________________
RDB::Status RDB::modifyRunParam(int run_no, CSTR name, CSTR value, CSTR type)  {
  _CALL call("modifyRunParam",_OPT(_P("RunNumber",run_no),_P("Name",name),_P("Val",value),_P("Typ",type)));
  return _exec<Status>(this,call);
}
//_________________________________________________________________________________________________
RDB::Status RDB::addRunParam(int run_no, CSTR name, int value, CSTR type)  {
  _CALL call("addRunParam",_OPT(_P("RunNumber",run_no),_P("Name",name),_P("Val",value),_P("Typ",type)));
  return _exec<Status>(this,call);
}
//_________________________________________________________________________________________________
RDB::Status RDB::addRunParam(int run_no, CSTR name, float value, CSTR type)  {
  _CALL call("addRunParam",_OPT(_P("RunNumber",run_no),_P("Name",name),_P("Val",value),_P("Typ",type)));
  return _exec<Status>(this,call);
}
//_________________________________________________________________________________________________
RDB::Status RDB::addRunParam(int run_no, CSTR name, CSTR value, CSTR type)  {
  _CALL call("addRunParam",_OPT(_P("RunNumber",run_no),_P("Name",name),_P("Val",value),_P("Typ",type)));
  return _exec<Status>(this,call);
}
//_________________________________________________________________________________________________
RDB::Status RDB::addFile(int run_no, CSTR fname, CSTR s_name)  {
...
//_________________________________________________________________________________________________
RDB::Status RDB::modifyFile(int run_no, CSTR fname, const Options& args)  {
  return _exec<Status>(this,_CALL("modifyFile",_OPT(_P("RunNumber",run_no),_P("FileName",fname),args)));
}
//_________________________________________________________________________________________________
RDB::Status RDB::addFileParam(int run_no, const _OPT& file, CSTR name, int value, CSTR type) {
  _CALL call("addFileParam",_OPT(_P("RunNumber",run_no),_P("Name",name),_P("Val",value),_P("Typ",type), file));
  return _exec<Status>(this,call);
}
//_________________________________________________________________________________________________
RDB::Status RDB::addFileParam(int run_no, const _OPT& file, CSTR name, float value, CSTR type) {
  _CALL call("addFileParam",_OPT(_P("RunNumber",run_no),_P("Name",name),_P("Val",value),_P("Typ",type), file));
  return _exec<Status>(this,call);
}
//_________________________________________________________________________________________________
RDB::Status RDB::addFileParam(int run_no, const _OPT& file, CSTR name, CSTR value, CSTR type) {
  _CALL call("addFileParam",_OPT(_P("RunNumber",run_no),_P("Name",name),_P("Val",value),_P("Typ",type), file));
  return _exec<Status>(this,call);
}
//_________________________________________________________________________________________________
RDB::Status RDB::addFileParam(int run_no, CSTR fname, CSTR name, int value, CSTR type)  {
  return addFileParam(run_no,_OPT("FileName",fname),name,value,type);
}
//_________________________________________________________________________________________________
RDB::Status RDB::addFileParam(int run_no, CSTR fname, CSTR name, float value, CSTR type)  {
  return addFileParam(run_no,_OPT("FileName",fname),name,value,type);
}
//_________________________________________________________________________________________________
RDB::Status RDB::addFileParam(int run_no, CSTR fname, CSTR name, CSTR value, CSTR type)  {
  return addFileParam(run_no,_OPT("FileName",fname),name,value,type);
}
//_________________________________________________________________________________________________
RDB::Status RDB::addFileParam(int run_no, int fid, CSTR name, int value, CSTR type)  {
  return addFileParam(run_no,_OPT("FileID",fid),name,value,type);
}
//_________________________________________________________________________________________________
RDB::Status RDB::addFileParam(int run_no, int fid, CSTR name, float value, CSTR type)  {
  return addFileParam(run_no,_OPT("FileID",fid),name,value,type);
}
//_________________________________________________________________________________________________
RDB::Status RDB::addFileParam(int run_no, int fid, CSTR name, CSTR value, CSTR type)  {
  return addFileParam(run_no,_OPT("FileID",fid),name,value,type);
}
