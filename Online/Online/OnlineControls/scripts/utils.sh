...
stopLocalSubfarm()
{
    ...
    echo "Project stopped: ${PVSS_PROJECT_NAME} `date`"   
}
...
deleteLocalSubfarm()
{
    ...
    echo "Project ${PVSS_PROJECT_NAME} deleted: `date`";
}
...
sshSubfarm() 
{
	...
	echo Executing: ssh -X ${1} bash ${ONLINECONTROLSROOT}/scripts/utils.sh ${1}
