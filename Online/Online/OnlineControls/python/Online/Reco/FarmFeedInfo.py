...
class FarmFeedInfo(General):
  ...
  def defineTasks(self,partition):
    ...
    The result is stored in runInfo datapoints for further processing.
...
class FarmFeedInfoCreator:
  ...
  def showPartition(self,partition,extended=None):
    ...
    partition.show(method=Info.showFarmFeed,extended=extended)
