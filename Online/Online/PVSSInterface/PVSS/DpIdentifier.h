// $Header: /afs/cern.ch/project/cvs/reps/lhcb/Online/PVSSInterface/PVSS/DpIdentifier.h,v 1.1 2007-03-01 10:39:49 frankb Exp $
//  ====================================================================
//  DpIdentifier.h
//  --------------------------------------------------------------------
//
...
#ifndef __GCCXML
  /// PVSS overload: debug
  virtual void debug(ostream &to, int level) const {}
#endif
  /// Assignment operator
