// $Header: /afs/cern.ch/project/cvs/reps/lhcb/Online/PVSSInterface/src/DevTypeElement.cpp,v 1.1 2007-03-01 10:39:50 frankb Exp $
//  ====================================================================
//  DevTypeElement.cpp
//  --------------------------------------------------------------------
//
...
DevTypeElement::DevTypeElement(DevType* typ, int i, const std::string& nam, Type cont)
...
std::string DevTypeElement::typeName()  const  {
  switch(content())  {
#define _PRT(x)   case x:  return "DPELEMENT_"#x
     _PRT(NOELEMENT);
     _PRT(RECORD);
     _PRT(ARRAY);
     _PRT(DYNCHAR);
