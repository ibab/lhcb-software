// $Id: MDFEvtSelectorNFiles.cpp,v 1.1 2009-02-06 09:37:57 frankb Exp $
//====================================================================
//  MDFEvtSelectorNFiles.cpp
//--------------------------------------------------------------------
//
//  Package    : MDF
//
...
namespace LHCb  {
  ...
  *  @version 1.0
  */
  class MDFPollerContext : public TestEvtSelectorNFiles::LoopContext, protected MDFIO {
    /// I/O Buffer holder
    StreamBuffer         m_buff;
  public:
    /// Standard constructor
    MDFPollerContext(const TestEvtSelectorNFiles* sel,bool ignoreChcksum) 
    : TestEvtSelectorNFiles::LoopContext(sel),MDFIO(MDFIO::MDF_RECORDS,sel->name())
  ...
  /** @class MDFEvtSelectorNFiles
    */
  class MDFOnlineEvtSelectorNFiles : public TestEvtSelectorNFiles
  ...
  public:
   ...
   /** Create a new event loop context
    ...
    virtual StatusCode createContext(Context*& refpCtxt) const {
      ...
      TestEvtSelectorNFiles::m_firstConnection = 0;
      TestEvtSelectorNFiles::m_evtCntRecord = 0;
    ...
    /// Service Constructor
    MDFOnlineEvtSelectorNFiles( const std::string& nam, ISvcLocator* svcloc )
    : TestEvtSelectorNFiles( nam, svcloc)  {
      declareProperty("IgnoreChecksum",m_ignoreChecksum="NO");
      
    }
    /// Standard destructor
    virtual ~MDFOnlineEvtSelectorNFiles()  {}
  };
 }


DECLARE_NAMESPACE_SERVICE_FACTORY(LHCb,MDFOnlineEvtSelectorNFiles)
