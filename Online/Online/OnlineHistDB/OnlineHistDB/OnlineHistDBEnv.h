// $Header: /afs/cern.ch/project/cvs/reps/lhcb/Online/OnlineHistDB/OnlineHistDB/OnlineHistDBEnv.h,v 1.26 2008-05-14 15:00:55 ggiacomo Exp $
...
namespace OnlineHistDBEnv_constants {
  ...
  static const std::string version = "v4r9";
