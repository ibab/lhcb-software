...
create table PAGE (
 ...
 CONSTRAINT PG_UNQ UNIQUE (PAGENAME,FOLDER) USING INDEX TABLESPACE INDX01,
 NHisto integer,
...
create table SHOWHISTO (
 ...
 CONSTRAINT SHH_PAGE FOREIGN KEY (PAGE,PAGEFOLDER) REFERENCES PAGE(PageName,Folder) ON DELETE CASCADE,
 HISTO  varchar2(12) NOT NULL CONSTRAINT SHH_HISTO references HISTOGRAM(HID),
 INSTANCE smallint DEFAULT 1 NOT NULL,
 CONSTRAINT SHH_UNQ UNIQUE (PAGE,PAGEFOLDER,HISTO,INSTANCE) USING INDEX TABLESPACE INDX01,
...
CREATE INDEX SHH_PAGEFOLDER_IX on SHOWHISTO(PAGEFOLDER) TABLESPACE INDX01;
