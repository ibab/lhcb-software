...
create table HISTOGRAMSET (
 ...
 HSTYPE varchar2(5) NOT NULL CONSTRAINT HS_TY_CK CHECK (HSTYPE IN ('1D','2D','PROF')),
...
create table DIMSERVICENAME (
 SN varchar2(500) constraint DSN_PK primary key 
...
create table PAGEFOLDER (
 PageFolderName varchar2(30) constraint PGF_pk primary key
...
create table SHOWHISTO (
 ...
 CONSTRAINT SHH_UNQ UNIQUE (PAGE,HISTO,CENTER_X,CENTER_Y) USING INDEX TABLESPACE INDX01,
