...
GaudiOnlineExe.exe libGaudiOnline.so OnlineTask -msgsvc=$msg_svc -tasktype=LHCb::Class2Task -main=/group/online/dataflow/templates/options/Main.opts -opts=../options/SFBsyAdder.opts -auto
