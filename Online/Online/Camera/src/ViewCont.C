...
//       if (cont.name(i)=="DIM1D") nrHistos++;
//       if (cont.name(i)=="DIM2D") nrHistos++;
...
//       divy = (int)sqrt((float)nrHistos);
//       divx = (int)sqrt((float)nrHistos)+1;
...
//       if (cont.name(i)=="TEXT"){
//         iw->appendline("Text: ");
//         iw->appendline((char*)cont.object(i));

//       }
//       if (cont.name(i)=="CTIME"){
//         iw->appendline("Date/Time: ");
//         iw->appendline((char *)cont.object(i));
//       }
//       if (cont.name(i)=="DIM2D"){

//         iw->appendline("2D Histo ");

//         iw->canvas()->cd(HistoCnt++);
//         TH2F * v = (TH2F *)cont.object(i);
//         v->Draw("colz");
//         iw->canvas()->Update();
//       }
//       if (cont.name(i)=="DIM1D"){

//         iw->appendline("1D Histo ");
...
int main(int /* argc */, char ** argv){
  ...
  new TApplication("viewcont",&dummy_argc,dummy_argv);

  if (argv[1]==NULL) return 1;
  else{
    ShowCont(std::string(argv[1]));
