...
HistoPropDialog::HistoPropDialog(PresenterMainFrame* gui, Int_t Width, Int_t Height, MsgLevel v) : 
...
{
  m_mainFrame->m_bulkHistoOptions.m_1DRootDrawOption = dynamic_cast<TGTextLBEntry*>(m_1DRootDrawOptionComboBox->GetSelectedEntry())->GetText()->GetString();
  m_mainFrame->m_bulkHistoOptions.m_2DRootDrawOption = dynamic_cast<TGTextLBEntry*>(m_2DRootDrawOptionComboBox->GetSelectedEntry())->GetText()->GetString();
  m_mainFrame->m_bulkHistoOptions.m_genericRootDrawOption = dynamic_cast<TGTextLBEntry*>(m_genericRootDrawOptionComboBox->GetSelectedEntry())->GetText()->GetString();
  m_mainFrame->m_bulkHistoOptions.m_statsOption = (int) m_statOptionComboBox->GetSelected();
  m_mainFrame->m_bulkHistoOptions.m_xLabel = m_xAxisLabelTextEntry->GetDisplayText();
  m_mainFrame->m_bulkHistoOptions.m_yLabel = m_yAxisLabelTextEntry->GetDisplayText();
  m_mainFrame->m_bulkHistoOptions.m_fillStyle = (int) m_fillStylePatternSelector->GetPattern();
  m_mainFrame->m_bulkHistoOptions.m_fillColour = (int) TColor::GetColor(m_fillColourSelector->GetColor());
  m_mainFrame->m_bulkHistoOptions.m_lineWidth = (int) m_lineWidthComboBox->GetSelected();
  m_mainFrame->m_bulkHistoOptions.m_lineStyle = (int) m_lineStyleComboBox->GetSelected();
  m_mainFrame->m_bulkHistoOptions.m_lineColour = (int) TColor::GetColor(m_lineColourSelector->GetColor());
...
void HistoPropDialog::build()
{
   ...
   // main frame
//   TGMainFrame *fMainFrame916 = new TGMainFrame(gClient->GetRoot(),10,10,kMainFrame | kVerticalFrame);
   ...
   m_cancelButton = new TGTextButton(fCompositeFrame649,"Cancel");
   m_cancelButton->SetTextJustify(36);
   m_cancelButton->Resize(92,24);
   fCompositeFrame649->AddFrame(m_cancelButton, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
   m_cancelButton->MoveResize(536,392,92,24);
   m_cancelButton->Connect("Clicked()", "HistoPropDialog", this, "DeleteWindow()");

   // "Display Options" group frame
   TGGroupFrame *fGroupFrame651 = new TGGroupFrame(fCompositeFrame649,"Display Options");
   ...
   fGroupFrame651->AddFrame(m_xLabelLabel, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
   m_xLabelLabel->MoveResize(16,24,57,18);
   m_lineWidthComboBox = new TGLineWidthComboBox(fGroupFrame651,-1,kHorizontalFrame | kSunkenFrame | kDoubleBorder | kOwnBackground);
   
   fGroupFrame651->AddFrame(m_lineWidthComboBox, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
   ...
   fGroupFrame651->AddFrame(m_yLabelLabel, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
   m_yLabelLabel->MoveResize(296,24,57,18);

   m_yAxisLabelTextEntry = new TGTextEntry(fGroupFrame651, new TGTextBuffer(15),-1);
   m_yAxisLabelTextEntry->SetMaxLength(255);
   m_yAxisLabelTextEntry->SetAlignment(kTextLeft);
   m_yAxisLabelTextEntry->SetText("");
   m_yAxisLabelTextEntry->Resize(184,m_yAxisLabelTextEntry->GetDefaultHeight());
   fGroupFrame651->AddFrame(m_yAxisLabelTextEntry, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
   m_yAxisLabelTextEntry->MoveResize(368,24,184,22);


   // combo box
   m_statOptionComboBox = new TGComboBox(fGroupFrame651,-1,kHorizontalFrame | kSunkenFrame | kDoubleBorder | kOwnBackground);
   ...
   fGroupFrame651->AddFrame(m_statOptionComboBox, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
   ...
   fGroupFrame651->AddFrame(fLabel677, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
   fLabel677->MoveResize(16,56,80,18);
   TGLabel *fLabel678 = new TGLabel(fGroupFrame651,"Fill Style");
   fLabel678->SetTextJustify(36);
   fGroupFrame651->AddFrame(fLabel678, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
   fLabel678->MoveResize(224,56,57,18);

   // combo box
   m_fillStylePatternSelector = new TGedPatternSelect(fGroupFrame651, 0, -1);
   fGroupFrame651->AddFrame(m_fillStylePatternSelector, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
   ...
   fGroupFrame651->AddFrame(fLabel697, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
   fLabel697->MoveResize(424,56,57,18);

   // color select widget
  m_fillColourSelector = new TGColorSelect(fGroupFrame651, 0, -1);

   fGroupFrame651->AddFrame(m_fillColourSelector, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
   ...
   fGroupFrame651->AddFrame(fLabel699, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
   fLabel699->MoveResize(16,88,80,18);
   TGLabel *fLabel700 = new TGLabel(fGroupFrame651,"Line Style");
   fLabel700->SetTextJustify(36);
   fGroupFrame651->AddFrame(fLabel700, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
   fLabel700->MoveResize(216,88,80,18);

   // combo box
  m_lineStyleComboBox = new  TGLineStyleComboBox(fGroupFrame651,-1,kHorizontalFrame | kSunkenFrame | kDoubleBorder | kOwnBackground);

  fGroupFrame651->AddFrame(m_lineStyleComboBox, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
  ...
  fGroupFrame651->AddFrame(fLabel719, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
  fLabel719->MoveResize(424,88,72,18);

   // color select widget
   m_lineColourSelector = new TGColorSelect(fGroupFrame651, 0, -1);
   fGroupFrame651->AddFrame(m_lineColourSelector, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
   m_lineColourSelector->MoveResize(504,88,45,23);
   TGLabel *fLabel721 = new TGLabel(fGroupFrame651,"Generic ROOT Draw Options");
   fLabel721->SetTextJustify(36);
   fGroupFrame651->AddFrame(fLabel721, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
   ...
   fGroupFrame651->AddFrame(fLabel722, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
   fLabel722->MoveResize(16,144,176,18);
   TGLabel *fLabel723 = new TGLabel(fGroupFrame651,"2D ROOT Draw Options");
   fLabel722->SetTextJustify(36);
   fGroupFrame651->AddFrame(fLabel723, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
   fLabel723->MoveResize(16,164,176,18);   

   // combo box
   m_genericRootDrawOptionComboBox = new TGComboBox(fGroupFrame651,"",kHorizontalFrame | kSunkenFrame | kDoubleBorder | kOwnBackground);
   ...
   m_genericRootDrawOptionComboBox->Select(0);
   fGroupFrame651->AddFrame(m_genericRootDrawOptionComboBox, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
   m_genericRootDrawOptionComboBox->MoveResize(200,120,102,22);

   // combo box
   m_1DRootDrawOptionComboBox = new TGComboBox(fGroupFrame651,"",kHorizontalFrame | kSunkenFrame | kDoubleBorder | kOwnBackground);
   ...
   fGroupFrame651->AddFrame(m_1DRootDrawOptionComboBox, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
   m_1DRootDrawOptionComboBox->MoveResize(200,144,102,22);

   // combo box
   m_2DRootDrawOptionComboBox = new TGComboBox(fGroupFrame651,"COLZ",kHorizontalFrame | kSunkenFrame | kDoubleBorder | kOwnBackground);
   ...
   fGroupFrame651->AddFrame(m_2DRootDrawOptionComboBox, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
   m_2DRootDrawOptionComboBox->MoveResize(200,164,102,22);
   
   m_xAxisLabelTextEntry = new TGTextEntry(fGroupFrame651, new TGTextBuffer(15),-1);
   m_xAxisLabelTextEntry->SetMaxLength(255);
   m_xAxisLabelTextEntry->SetAlignment(kTextLeft);
   m_xAxisLabelTextEntry->SetText("");
   m_xAxisLabelTextEntry->Resize(184,m_xAxisLabelTextEntry->GetDefaultHeight());
   fGroupFrame651->AddFrame(m_xAxisLabelTextEntry, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
   ...
   fCompositeFrame649->AddFrame(fGroupFrame651, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
   fGroupFrame651->MoveResize(24,152,608,232);
   TGTextButton *fTextButton760 = new TGTextButton(fCompositeFrame649,"Add");
   fTextButton760->SetTextJustify(36);
   fTextButton760->Resize(92,24);
   fCompositeFrame649->AddFrame(fTextButton760, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
   fTextButton760->MoveResize(432,392,92,24);
   fTextButton760->Connect("Clicked()", "HistoPropDialog", this, "ok()");   

   // "Description" group frame
   TGGroupFrame *fGroupFrame761 = new TGGroupFrame(fCompositeFrame649,"Description");
   TGTextEdit *fTextEdit762 = new TGTextEdit(fGroupFrame761,592,104);
//   fTextEdit762->LoadFile("TxtEdit1101");
   fGroupFrame761->AddFrame(fTextEdit762, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));

   fGroupFrame761->SetLayoutManager(new TGVerticalLayout(fGroupFrame761));
   fGroupFrame761->Resize(608,140);
   fCompositeFrame649->AddFrame(fGroupFrame761, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
   fGroupFrame761->MoveResize(24,16,608,140);

   fMainFrame648->AddFrame(fCompositeFrame649, new TGLayoutHints(kLHintsExpandX | kLHintsExpandY));
   fCompositeFrame649->MoveResize(0,0,664,448);

   AddFrame(fMainFrame648, new TGLayoutHints(kLHintsExpandX | kLHintsExpandY));
