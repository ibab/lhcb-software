...
void HistoPropDialog::build()
{
  ...
  // combo box
  m_genericRootDrawOptionComboBox = new TGComboBox(fGroupFrame651,"HIST",kHorizontalFrame | kSunkenFrame | kDoubleBorder | kOwnBackground);
  ...
  // combo box
  m_1DRootDrawOptionComboBox = new TGComboBox(fGroupFrame651,"HIST",kHorizontalFrame | kSunkenFrame | kDoubleBorder | kOwnBackground);
