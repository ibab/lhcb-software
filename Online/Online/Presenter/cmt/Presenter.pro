...
TEMPLATE = app
TARGET = $(PRESENTERROOT)/$(CMTCONFIG)/Presenter.exe
#DEPENDPATH +=  $(PRESENTERROOT)/src 
#$(PRESENTERROOT)/gui/presenter
win32: INCLUDEPATH += $(PRESENTERROOT)/inc/ $(PRESENTERROOT)/gui/presenter $(ROOTSYS)/include \
...
$(DIMROOT)/dim/ \
$(ONLINEHISTDBROOT)
unix: INCLUDEPATH += $(PRESENTERROOT)/inc/ $(PRESENTERROOT)/gui/presenter $(ROOTSYS)/include \
...
#unix: LDFLAGS += --no-as-needed
unix: QMAKE_LFLAGS += --as-needed,
...
MOC_DIR = $(PRESENTERROOT)/$(CMTCONFIG)
UI_DIR = $(PRESENTERROOT)/$(CMTCONFIG)
OBJECTS_DIR = $(PRESENTERROOT)/$(CMTCONFIG)
#RCC_DIR = $(PRESENTERROOT)/$(CMTCONFIG)

# Input
IMAGES = ../gui/images/h1_t.png \
				../gui/images/h2_t.png \
				../gui/images/splash2.png
HEADERS +=  $(PRESENTERROOT)/gui/presenter/PageEditorMainWindow.ui.h \
					 	$(PRESENTERROOT)/gui/presenter/DatabaseLoginDialog.ui.h
INTERFACES += $(PRESENTERROOT)/gui/presenter/PageEditorMainWindow.ui \
							$(PRESENTERROOT)/gui/presenter/DatabaseLoginDialog.ui
SOURCES +=  $(PRESENTERROOT)/src/main.cpp $(PRESENTERROOT)/src/DimProxy.cpp
