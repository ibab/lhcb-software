##  -*- python -*-  
# db file automatically generated by genconf on: Fri Aug 29 12:21:23 2008
...
def _fillCfgDb():
    ...
    cfgDb.add( configurable = 'RateService',
               package = 'RateService',
               module  = 'RateService.RateServiceConf',
               lib     = 'RateService' )
    return #_fillCfgDb
...
try:
    ...
    print "Py:ConfigurableDb   ERROR   ==> culprit is package [RateService] !"
