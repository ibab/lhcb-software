...
#setenv DIM_DNS_NODE lxplus240.cern.ch
...
cd /afs/cern.ch/user/j/jmenou/cmtuser/Online_v4r10/Online/RateService/v2r1/cmt/
source ./setup.csh 
#echo 'gaudisvcshr  ' $GaudiSvcShr

echo "debug5"
#echo "GAUDIONLINEROOT "$GAUDIONLINEROOT
