...
namespace Framework  {
  ...
  class AVXMemory  : protected std::pair<__m128i*,size_t>  {
    typedef std::pair<__m128i*,size_t>       Memory;
  public:
  ...
  public:
    ...
    /// Retrieve the items set in the mask
    std::vector<size_t> missing(const AVXMemory& copy) const;
