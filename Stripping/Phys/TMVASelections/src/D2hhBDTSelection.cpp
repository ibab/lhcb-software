...
// local
#include "D2hhBDTSelection.h"

//-----------------------------------------------------------------------------
// Implementation file for class : D2hhBDTSelection
//
// 2012-11-11 : Stefano Perazzini
//-----------------------------------------------------------------------------

// Declaration of the Tool Factory
DECLARE_TOOL_FACTORY( D2hhBDTSelection )

//=============================================================================
// Standard constructor, initializes variables
//=============================================================================
  D2hhBDTSelection::D2hhBDTSelection( const std::string& type,
...
// Destructor
//=============================================================================
D2hhBDTSelection::~D2hhBDTSelection()
{
  delete []m_values;
}
...
// Initialize
//=============================================================================
StatusCode D2hhBDTSelection::initialize()
{
...
// Finalize
//=============================================================================
StatusCode D2hhBDTSelection::finalize()
{
  delete m_BDTReader;
  m_BDTReader = NULL;
...
// BDT cut
//====================================================================
bool D2hhBDTSelection::operator()(const LHCb::Particle* p) const
{
  if(0 == p) {
...
//====================================================================
bool D2hhBDTSelection::set (const LHCb::Particle* p) const{
