...
inputfiles = ['LFN:/lhcb/LHCb/Collision12/FULL.DST/00020330/0004/00020330_00042960_1.full.dst',
...
import os
start = int(os.environ["FIRST_FILE"])
stop  = start + 5

IOHelper('ROOT').inputFiles(inputfiles[start:stop], clear=True)
