...
def B2twobody_promptLine(
	...
	MaxBPVIPChi2 = 15.0,   # removed 
	MinBPVVDChi2 = 10.0, # removed
...
#    Charm2Bcut+="& CHILDCUT ( BPVDIRA> %(
    ...
    Jpcut =  "CHILDCUT ( MIPCHI2DV ( PRIMARY ) < %(MinJpDauIPChi2)s , 1 )"%locals()  # changed
    Jpcut+="& CHILDCUT ( MIPCHI2DV ( PRIMARY ) < %(MinJpDauIPChi2)s , 2 )"%locals()  # changed
...
#    AllSel=[PiSel,KSel,pSel,KsSel,LmSel,DzSel,DpSel,DsSel,LcSel,DSSel,JpSel,PhSel,KSSel]
    AllSel_prompt=[LmSel,DzSel,DpSel,DsSel,LcSel,DSSel,JpSel]
    ...
    line = StrippingLine("B2twobody_promptLine",  algos = [BSel_prompt] )
