...
Provides functions to build, KS->LL, Downstream tracks, KS->DD not implemented, Bs selections (Bd to be implemented).
...
__author__ = ['Florin MACIUC','Marianna FONTANA']
__date__ = '26/04/2012'
...
default_config = {'KS_LL_MassWindowP'       : 50.0, # before vertex fit ADAMASS  Ks2PiPi.CombinationCut = "( ADAMASS('KS0') < 50.*MeV )"
...
class Bs2KSKSConf(LineBuilder) :
    ...
    __configuration_keys__ = ('KS_LL_MassWindowP',
                              'KS_LL_MassWindow',
                              'KS_LL_VtxChi2',
                              'KS_LL_FDChi2',
...
########## EndCuts definition
        ...
        # make the Ks from StdNoPIDsPions
