...
#include "RelInfoBKsttautauMuonIsolationBDT.h"
#include "Kernel/RelatedInfoNamed.h"

//-----------------------------------------------------------------------------
// Implementation file for class : RelInfoBKsttautauMuonIsolationBDT
...
DECLARE_TOOL_FACTORY( RelInfoBKsttautauMuonIsolationBDT )

//=============================================================================
// Standard constructor, initializes variables
//=============================================================================
RelInfoBKsttautauMuonIsolationBDT::RelInfoBKsttautauMuonIsolationBDT( const std::string& type,
...
: GaudiTool ( type, name , parent )
{
  ...
  */
  m_keys.push_back( RelatedInfoNamed::BKSTTAUTAUMUONISOBDTFIRSTVALUETAUP );
  m_keys.push_back( RelatedInfoNamed::BKSTTAUTAUMUONISOBDTSECONDVALUETAUP );
  m_keys.push_back( RelatedInfoNamed::BKSTTAUTAUMUONISOBDTTHIRDVALUETAUP );
  m_keys.push_back( RelatedInfoNamed::BKSTTAUTAUMUONISOBDTFIRSTVALUETAUM );
  m_keys.push_back( RelatedInfoNamed::BKSTTAUTAUMUONISOBDTSECONDVALUETAUM );
  m_keys.push_back( RelatedInfoNamed::BKSTTAUTAUMUONISOBDTTHIRDVALUETAUM ); 
...
// Destructor
//=============================================================================
RelInfoBKsttautauMuonIsolationBDT::~RelInfoBKsttautauMuonIsolationBDT() {}


//=============================================================================
// Initialize
//=============================================================================
StatusCode RelInfoBKsttautauMuonIsolationBDT::initialize() {
...
//=============================================================================
StatusCode RelInfoBKsttautauMuonIsolationBDT::calculateRelatedInfo( const LHCb::Particle *top,
                                                                    const LHCb::Particle *top_bis )
{
  ...
  for (i_daug = Daughters.begin(); i_daug != Daughters.end(); i_daug++){
    ...
    if(!part){
      ...
      if(flag_OS==true){
        if(part->charge()>0)
          {
            m_bdt1_TauP_mu = m_bdt1;
            m_bdt2_TauP_mu = m_bdt2;
            m_bdt3_TauP_mu = m_bdt3;
          }
        if(part->charge()<0)
          {
            m_bdt1_TauM_mu = m_bdt1;
            m_bdt2_TauM_mu = m_bdt2;
            m_bdt3_TauM_mu = m_bdt3;
          }
      }else if(flag_OS==false){
        if(P_charge)
          {
            m_bdt1_TauP_mu = m_bdt1;
            m_bdt2_TauP_mu = m_bdt2;
  ...
  if ( msgLevel(MSG::DEBUG) ) debug()<<" m_bdt1_TauP_mu : "<<m_bdt1_TauP_mu<<"  ,  m_bdt2_TauP_mu : "<<m_bdt2_TauP_mu<<"  ,  m_bdt3_TauP_mu : "<<m_bdt3_TauP_mu<<endmsg;
  if ( msgLevel(MSG::DEBUG) ) debug()<<" m_bdt1_TauM_mu : "<<m_bdt1_TauM_mu<<"  ,  m_bdt2_TauM_mu : "<<m_bdt2_TauM_mu<<"  ,  m_bdt3_TauM_mu : "<<m_bdt3_TauM_mu<<endmsg;
  if ( msgLevel(MSG::DEBUG) ) debug()<<"================="<<endmsg;
  ...
  for (ikey = m_keys.begin(); ikey != m_keys.end(); ikey++) {
    ...
    float value = 0;
    switch (*ikey) {
    case RelatedInfoNamed::BKSTTAUTAUMUONISOBDTFIRSTVALUETAUP : value = m_bdt1_TauP_mu; break;
    case RelatedInfoNamed::BKSTTAUTAUMUONISOBDTSECONDVALUETAUP : value = m_bdt2_TauP_mu; break;
    case RelatedInfoNamed::BKSTTAUTAUMUONISOBDTTHIRDVALUETAUP : value = m_bdt3_TauP_mu; break;
    case RelatedInfoNamed::BKSTTAUTAUMUONISOBDTFIRSTVALUETAUM : value = m_bdt1_TauM_mu; break;
    case RelatedInfoNamed::BKSTTAUTAUMUONISOBDTSECONDVALUETAUM : value = m_bdt2_TauM_mu; break;
    case RelatedInfoNamed::BKSTTAUTAUMUONISOBDTTHIRDVALUETAUM : value = m_bdt3_TauM_mu; break;
    }
...
LHCb::RelatedInfoMap* RelInfoBKsttautauMuonIsolationBDT::getInfo(void) {
  return &m_map;
}

std::string RelInfoBKsttautauMuonIsolationBDT::infoPath(void) {
  std::stringstream ss;
...
//=============================================================================
void RelInfoBKsttautauMuonIsolationBDT::saveDecayParticles( const LHCb::Particle *top)
{
...
//=============================================================================
bool RelInfoBKsttautauMuonIsolationBDT::isTrackInDecay(const LHCb::Track* track){
...
bool RelInfoBKsttautauMuonIsolationBDT::calcBDTValue( const LHCb::Particle * part
...
double RelInfoBKsttautauMuonIsolationBDT::calcIPToAnyPV( const LHCb::Track * track )
{
  IDVAlgorithm* dva = Gaudi::Utils::getIDVAlgorithm( contextSvc() ) ;
  if ( !dva ) { return Error("Could not get parent DVAlgorithm"); }
...
///============================================================================
void RelInfoBKsttautauMuonIsolationBDT::getPerpFeet(Gaudi::XYZPoint track_pos,
...
double RelInfoBKsttautauMuonIsolationBDT::calcFC( Gaudi::XYZVector p,
...
double RelInfoBKsttautauMuonIsolationBDT::arcosine(Gaudi::XYZVector p1,Gaudi::XYZVector p2) {
...
///--------------------------------------------
double RelInfoBKsttautauMuonIsolationBDT::enclosedAngle(Gaudi::XYZVector p1,Gaudi::XYZVector p2) {
  double den      = p1.R()*p2.R();
...
double RelInfoBKsttautauMuonIsolationBDT::calcVertexDist(Gaudi::XYZPoint muTrack, const LHCb::VertexBase* v){
  if (v==NULL) return 0 ;
