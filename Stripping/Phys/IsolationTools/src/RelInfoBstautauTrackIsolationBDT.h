...
class RelInfoBstautauTrackIsolationBDT : public GaudiTool, virtual public IRelatedInfoTool {
    public:
        /// Standard constructor
        RelInfoBstautauTrackIsolationBDT( const std::string& type,
        ...
        virtual ~RelInfoBstautauTrackIsolationBDT( ); ///< Destructor
