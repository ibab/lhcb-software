...
class RelInfoBstautauTauIsolation : public GaudiTool, virtual public IRelatedInfoTool {
    public:
        /// Standard constructor
        RelInfoBstautauTauIsolation( const std::string& type,
        ...
        virtual ~RelInfoBstautauTauIsolation( ); ///< Destructor
