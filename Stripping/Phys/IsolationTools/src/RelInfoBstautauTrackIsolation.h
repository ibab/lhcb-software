...
class RelInfoBstautauTrackIsolation : public GaudiTool, virtual public IRelatedInfoTool {
    public:
        /// Standard constructor
        RelInfoBstautauTrackIsolation( const std::string& type,
        ...
        virtual ~RelInfoBstautauTrackIsolation( ); ///< Destructor
