...
/** @class RelInfoBstautauTauIsolationBDT RelInfoBstautauTauIsolationBDT.h
 *
...
class RelInfoBstautauTauIsolationBDT : public GaudiTool, virtual public IRelatedInfoTool {
    public:
        /// Standard constructor
        RelInfoBstautauTauIsolationBDT( const std::string& type,
        ...
        virtual ~RelInfoBstautauTauIsolationBDT( ); ///< Destructor
