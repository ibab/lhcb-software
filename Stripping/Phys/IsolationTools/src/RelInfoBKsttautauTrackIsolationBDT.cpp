...
#include "RelInfoBKsttautauTrackIsolationBDT.h"
#include "Kernel/RelatedInfoNamed.h"

//-----------------------------------------------------------------------------
// Implementation file for class : RelInfoBKsttautauTrackIsolationBDT
...
DECLARE_TOOL_FACTORY( RelInfoBKsttautauTrackIsolationBDT )

//=============================================================================
// Standard constructor, initializes variables
//=============================================================================
RelInfoBKsttautauTrackIsolationBDT::RelInfoBKsttautauTrackIsolationBDT( const std::string& type,
                                                                    ...
                                                                    const IInterface* parent) : GaudiTool ( type, name , parent )
{
  ...
  */
  m_keys.push_back( RelatedInfoNamed::BKSTTAUTAUTRKISOBDTFIRSTVALUETAUPPIM );
  m_keys.push_back( RelatedInfoNamed::BKSTTAUTAUTRKISOBDTSECONDVALUETAUPPIM );
  m_keys.push_back( RelatedInfoNamed::BKSTTAUTAUTRKISOBDTTHIRDVALUETAUPPIM );
  m_keys.push_back( RelatedInfoNamed::BKSTTAUTAUTRKISOBDTFIRSTVALUETAUPPIP1 );
  m_keys.push_back( RelatedInfoNamed::BKSTTAUTAUTRKISOBDTSECONDVALUETAUPPIP1 );
  m_keys.push_back( RelatedInfoNamed::BKSTTAUTAUTRKISOBDTTHIRDVALUETAUPPIP1 );
  m_keys.push_back( RelatedInfoNamed::BKSTTAUTAUTRKISOBDTFIRSTVALUETAUPPIP2 );
  m_keys.push_back( RelatedInfoNamed::BKSTTAUTAUTRKISOBDTSECONDVALUETAUPPIP2 );
  m_keys.push_back( RelatedInfoNamed::BKSTTAUTAUTRKISOBDTTHIRDVALUETAUPPIP2 );


  m_keys.push_back( RelatedInfoNamed::BKSTTAUTAUTRKISOBDTFIRSTVALUETAUMPIP );
  m_keys.push_back( RelatedInfoNamed::BKSTTAUTAUTRKISOBDTSECONDVALUETAUMPIP );
  m_keys.push_back( RelatedInfoNamed::BKSTTAUTAUTRKISOBDTTHIRDVALUETAUMPIP );
  m_keys.push_back( RelatedInfoNamed::BKSTTAUTAUTRKISOBDTFIRSTVALUETAUMPIM1 );
  m_keys.push_back( RelatedInfoNamed::BKSTTAUTAUTRKISOBDTSECONDVALUETAUMPIM1 );
  m_keys.push_back( RelatedInfoNamed::BKSTTAUTAUTRKISOBDTTHIRDVALUETAUMPIM1 );
  m_keys.push_back( RelatedInfoNamed::BKSTTAUTAUTRKISOBDTFIRSTVALUETAUMPIM2 );
  m_keys.push_back( RelatedInfoNamed::BKSTTAUTAUTRKISOBDTSECONDVALUETAUMPIM2 );
  m_keys.push_back( RelatedInfoNamed::BKSTTAUTAUTRKISOBDTTHIRDVALUETAUMPIM2 );

  m_keys.push_back( RelatedInfoNamed::BKSTTAUTAUTRKISOBDTFIRSTVALUEKSTK );
  m_keys.push_back( RelatedInfoNamed::BKSTTAUTAUTRKISOBDTSECONDVALUEKSTK );
  m_keys.push_back( RelatedInfoNamed::BKSTTAUTAUTRKISOBDTTHIRDVALUEKSTK );
  m_keys.push_back( RelatedInfoNamed::BKSTTAUTAUTRKISOBDTFIRSTVALUEKSTPI );
  m_keys.push_back( RelatedInfoNamed::BKSTTAUTAUTRKISOBDTSECONDVALUEKSTPI );
  m_keys.push_back( RelatedInfoNamed::BKSTTAUTAUTRKISOBDTTHIRDVALUEKSTPI );
...
// Destructor
//=============================================================================
RelInfoBKsttautauTrackIsolationBDT::~RelInfoBKsttautauTrackIsolationBDT() {}


//=============================================================================
// Initialize
//=============================================================================
StatusCode RelInfoBKsttautauTrackIsolationBDT::initialize() {
...
//=============================================================================
StatusCode RelInfoBKsttautauTrackIsolationBDT::calculateRelatedInfo( const LHCb::Particle *top,
                                                                   const LHCb::Particle *top_bis )
{
  ...
  m_bdt2 = -1000. ;
  m_bdt3 = -1000. ;
  m_bdt1_TauP_piM = -1000.;
  m_bdt2_TauP_piM = -1000.;
  m_bdt3_TauP_piM = -1000.;
  m_bdt1_TauP_piP1 = -1000.;
  m_bdt2_TauP_piP1 = -1000.;
  m_bdt3_TauP_piP1 = -1000.;
  m_bdt1_TauP_piP2 = -1000.;
  m_bdt2_TauP_piP2 = -1000.;
  m_bdt3_TauP_piP2 = -1000.;
  m_bdt1_TauM_piP = -1000.;
  m_bdt2_TauM_piP = -1000.;
  m_bdt3_TauM_piP = -1000.;
  m_bdt1_TauM_piM1 = -1000.;
  m_bdt2_TauM_piM1 = -1000.;
  m_bdt3_TauM_piM1 = -1000.;
  m_bdt1_TauM_piM2 = -1000.;
  m_bdt2_TauM_piM2 = -1000.;
  m_bdt3_TauM_piM2 = -1000.;
  m_bdt1_Kst_K = -1000.;
  m_bdt2_Kst_K = -1000.;
  m_bdt3_Kst_K = -1000.;
  m_bdt1_Kst_pi = -1000.;
 ...
 // Int_t flag(0);
  ...
  for( SmartRefVector< LHCb::Particle >::const_iterator idau = daughters.begin() ; idau != daughters.end() ; ++idau){//
	...
	if(! part ) {
	  ...
	  if(isKst==true){
	    if(abs(part->particleID().pid())==321){
	      m_bdt1_Kst_K=m_bdt1;
	      m_bdt2_Kst_K=m_bdt2;
	      m_bdt3_Kst_K=m_bdt3;
	    }else{
	      m_bdt1_Kst_pi=m_bdt1;
	      m_bdt2_Kst_pi=m_bdt2;
	      m_bdt3_Kst_pi=m_bdt3;
	    }
	  }else{
  ...
  if ( msgLevel(MSG::DEBUG) ) debug()<<" m_bdt1_TauP_piM : "<<m_bdt1_TauP_piM<<"  ,  m_bdt2_TauP_piM : "<<m_bdt2_TauP_piM<<"  ,  m_bdt3_TauP_piM : "<<m_bdt3_TauP_piM<<endmsg;
  if ( msgLevel(MSG::DEBUG) ) debug()<<" m_bdt1_TauP_piP1 : "<<m_bdt1_TauP_piP1<<"  ,  m_bdt2_TauP_piP1 : "<<m_bdt2_TauP_piP1<<"  ,  m_bdt3_TauP_piP1 : "<<m_bdt3_TauP_piP1<<endmsg;
  if ( msgLevel(MSG::DEBUG) ) debug()<<" m_bdt1_TauP_piP2 : "<<m_bdt1_TauP_piP2<<"  ,  m_bdt2_TauP_piP2 : "<<m_bdt2_TauP_piP2<<"  ,  m_bdt3_TauP_piP2 : "<<m_bdt3_TauP_piP2<<endmsg;

   if ( msgLevel(MSG::DEBUG) ) debug()<<" m_bdt1_TauM_piP : "<<m_bdt1_TauM_piP<<"  ,  m_bdt2_TauM_piP : "<<m_bdt2_TauM_piP<<"  ,  m_bdt3_TauM_piP : "<<m_bdt3_TauM_piP<<endmsg;
  if ( msgLevel(MSG::DEBUG) ) debug()<<" m_bdt1_TauM_piM1 : "<<m_bdt1_TauM_piM1<<"  ,  m_bdt2_TauM_piM1 : "<<m_bdt2_TauM_piM1<<"  ,  m_bdt3_TauM_piM1 : "<<m_bdt3_TauM_piM1<<endmsg;
  if ( msgLevel(MSG::DEBUG) ) debug()<<" m_bdt1_TauM_piM2 : "<<m_bdt1_TauM_piM2<<"  ,  m_bdt2_TauM_piM2 : "<<m_bdt2_TauM_piM2<<"  ,  m_bdt3_TauM_piM2 : "<<m_bdt3_TauM_piM2<<endmsg; 
  
  if ( msgLevel(MSG::DEBUG) ) debug()<<" m_bdt1_Kst_K : "<<m_bdt1_Kst_K<<"  ,  m_bdt2_Kst_K : "<<m_bdt2_Kst_K<<"  ,  m_bdt3_Kst_K : "<<m_bdt3_Kst_K<<endmsg;
  if ( msgLevel(MSG::DEBUG) ) debug()<<" m_bdt1_Kst_pi : "<<m_bdt1_Kst_pi<<"  ,  m_bdt2_Kst_pi : "<<m_bdt2_Kst_pi<<"  ,  m_bdt3_Kst_pi : "<<m_bdt3_Kst_pi<<endmsg;
  ...
  for (ikey = m_keys.begin(); ikey != m_keys.end(); ikey++) {
    ...
    case RelatedInfoNamed::BKSTTAUTAUTRKISOBDTFIRSTVALUETAUPPIM : value = m_bdt1_TauP_piM ; break;//
    case RelatedInfoNamed::BKSTTAUTAUTRKISOBDTSECONDVALUETAUPPIM : value = m_bdt2_TauP_piM ; break;//
    case RelatedInfoNamed::BKSTTAUTAUTRKISOBDTTHIRDVALUETAUPPIM : value = m_bdt3_TauP_piM ; break;//
    case RelatedInfoNamed::BKSTTAUTAUTRKISOBDTFIRSTVALUETAUPPIP1 : value = m_bdt1_TauP_piP1 ; break;//
    case RelatedInfoNamed::BKSTTAUTAUTRKISOBDTSECONDVALUETAUPPIP1 : value = m_bdt2_TauP_piP1 ; break;//
    case RelatedInfoNamed::BKSTTAUTAUTRKISOBDTTHIRDVALUETAUPPIP1 : value = m_bdt3_TauP_piP1 ; break;//
    case RelatedInfoNamed::BKSTTAUTAUTRKISOBDTFIRSTVALUETAUPPIP2 : value = m_bdt1_TauP_piP2 ; break;//
    case RelatedInfoNamed::BKSTTAUTAUTRKISOBDTSECONDVALUETAUPPIP2 : value = m_bdt2_TauP_piP2 ; break;//
    case RelatedInfoNamed::BKSTTAUTAUTRKISOBDTTHIRDVALUETAUPPIP2 : value = m_bdt3_TauP_piP2 ; break;//
      
      
    case RelatedInfoNamed::BKSTTAUTAUTRKISOBDTFIRSTVALUETAUMPIP : value = m_bdt1_TauM_piP ; break;//
    case RelatedInfoNamed::BKSTTAUTAUTRKISOBDTSECONDVALUETAUMPIP : value = m_bdt2_TauM_piP ; break;//
    case RelatedInfoNamed::BKSTTAUTAUTRKISOBDTTHIRDVALUETAUMPIP : value = m_bdt3_TauM_piP; break;//
    case RelatedInfoNamed::BKSTTAUTAUTRKISOBDTFIRSTVALUETAUMPIM1 : value = m_bdt1_TauM_piM1 ; break;//
    case RelatedInfoNamed::BKSTTAUTAUTRKISOBDTSECONDVALUETAUMPIM1 : value = m_bdt2_TauM_piM1 ; break;//
    case RelatedInfoNamed::BKSTTAUTAUTRKISOBDTTHIRDVALUETAUMPIM1 : value = m_bdt3_TauM_piM1 ; break;//
    case RelatedInfoNamed::BKSTTAUTAUTRKISOBDTFIRSTVALUETAUMPIM2 : value = m_bdt1_TauM_piM2 ; break;//
    case RelatedInfoNamed::BKSTTAUTAUTRKISOBDTSECONDVALUETAUMPIM2 : value = m_bdt2_TauM_piM2 ; break;//
    case RelatedInfoNamed::BKSTTAUTAUTRKISOBDTTHIRDVALUETAUMPIM2 : value = m_bdt3_TauM_piM2 ; break;//
      
    case RelatedInfoNamed::BKSTTAUTAUTRKISOBDTFIRSTVALUEKSTK : value = m_bdt1_Kst_K ; break;//
    case RelatedInfoNamed::BKSTTAUTAUTRKISOBDTSECONDVALUEKSTK : value = m_bdt2_Kst_K ; break;//
    case RelatedInfoNamed::BKSTTAUTAUTRKISOBDTTHIRDVALUEKSTK : value = m_bdt3_Kst_K ; break;//
    case RelatedInfoNamed::BKSTTAUTAUTRKISOBDTFIRSTVALUEKSTPI : value = m_bdt1_Kst_pi ; break;//
    case RelatedInfoNamed::BKSTTAUTAUTRKISOBDTSECONDVALUEKSTPI : value = m_bdt2_Kst_pi ; break;//
    case RelatedInfoNamed::BKSTTAUTAUTRKISOBDTTHIRDVALUEKSTPI : value = m_bdt3_Kst_pi ; break;//
      
      //   case RelatedInfoNamed::BKSTTAUTAUTRKISOBDTFIRSTVALUE : value = m_bdt1; break;
      //   case RelatedInfoNamed::BKSTTAUTAUTRKISOBDTSECONDVALUE : value = m_bdt2; break;
      //   case RelatedInfoNamed::BKSTTAUTAUTRKISOBDTTHIRDVALUE : value = m_bdt3; break;
    }
...
LHCb::RelatedInfoMap* RelInfoBKsttautauTrackIsolationBDT::getInfo(void) {
  return &m_map;
}

std::string RelInfoBKsttautauTrackIsolationBDT::infoPath(void) {
  std::stringstream ss;
...
//=============================================================================
void RelInfoBKsttautauTrackIsolationBDT::saveDecayParticles( const LHCb::Particle *top)
{
...
//=============================================================================
bool RelInfoBKsttautauTrackIsolationBDT::isTrackInDecay(const LHCb::Track* track){
...
bool RelInfoBKsttautauTrackIsolationBDT::calcBDTValue( const LHCb::Particle * part
...
double RelInfoBKsttautauTrackIsolationBDT::calcIPToAnyPV( const LHCb::Track * track )
{
  IDVAlgorithm* dva = Gaudi::Utils::getIDVAlgorithm( contextSvc() ) ;
  if ( !dva ) { return Error("Could not get parent DVAlgorithm"); }
...
///============================================================================
void RelInfoBKsttautauTrackIsolationBDT::getPerpFeet(Gaudi::XYZPoint track_pos,
...
double RelInfoBKsttautauTrackIsolationBDT::calcFC( Gaudi::XYZVector p,
...
double RelInfoBKsttautauTrackIsolationBDT::arcosine(Gaudi::XYZVector p1,Gaudi::XYZVector p2) {
...
///--------------------------------------------
double RelInfoBKsttautauTrackIsolationBDT::enclosedAngle(Gaudi::XYZVector p1,Gaudi::XYZVector p2) {
  double den      = p1.R()*p2.R();
...
double RelInfoBKsttautauTrackIsolationBDT::calcVertexDist(Gaudi::XYZPoint muTrack, const LHCb::VertexBase* v){
  if (v==NULL) return 0 ;
