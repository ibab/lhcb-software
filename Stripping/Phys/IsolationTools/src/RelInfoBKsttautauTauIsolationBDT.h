...
/** @class RelInfoBKsttautauTauIsolationBDT RelInfoBKsttautauTauIsolationBDT.h
 *
 * \brief Calculate tau isolation.
 *    Compare daughter
 *
 *    m_bdt1 : bdt value
 *
...
class RelInfoBKsttautauTauIsolationBDT : public GaudiTool, virtual public IRelatedInfoTool {
    public:
        /// Standard constructor
        RelInfoBKsttautauTauIsolationBDT( const std::string& type,
        ...
        virtual ~RelInfoBKsttautauTauIsolationBDT( ); ///< Destructor
