...
StdLooseDplus2KPiPi.Inputs = [ "Phys/StdNoPIDsKaons/Particles",
...
StdLooseDplus2PiPiPi.Inputs = [ "Phys/StdNoPIDsPions/Particles" ]
...
StdLooseDplus2hhh.Inputs = [ "Phys/StdNoPIDsPions/Particles" ]
