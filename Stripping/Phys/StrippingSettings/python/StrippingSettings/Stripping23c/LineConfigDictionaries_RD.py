...
B2KstTauTau = {
    ...
    "CONFIG": {
        ...
        "TRACKCHI2_HAD_ALL_FINAL_STATE": "3", 
        "TRACKCHI2_MU": "3", 
        "TRGHOPROB_HAD_ALL_FINAL_STATE": "0.3", 
        "VCHI2_B": "100", 
        "VCHI2_B_Mu": "150", 
        "VCHI2_B_Mu_KMM": "100", 
        "VCHI2_D": "16", 
...
Beauty2XGamma = {
    ...
    "CONFIG": {
        ...
        "TISTOSLinesDict": {
            ...
            "Hlt2RadiativeTopo.*Decision%TIS": 0, 
            "Hlt2RadiativeTopo.*Decision%TOS": 0, 
            "Hlt2Topo(2|3|4)Body.*Decision%TIS": 0, 
            "Hlt2Topo(2|3|4)Body.*Decision%TOS": 0, 
            "Hlt2TopoRad.*Decision%TIS": 0, 
            "Hlt2TopoRad.*Decision%TOS": 0
        }, 
        "TrackGhostProb": 0.4
    }, 
    "STREAMS": [ "Leptonic" ], 
...
Bs2GammaGamma = {
    ...
    "CONFIG": {
        "BsHighMass": 5800, 
        "BsHighMassDouble": 5800, 
        "BsHighMassNone": 6000, 
        "BsLowMass": 4600, 
        "BsLowMassDouble": 4300, 
        "BsLowMassNone": 4900, 
        "BsNonePT": 2000, 
        "BsPT": 1000, 
        "BsVertexCHI2pDOF": 20, 
