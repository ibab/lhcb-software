...
TrackEffMuonTT = {
    ...
    'VertexChi2'                  : 10,
    'LongMuonPID'                 : 0,
    'JpsiHlt1Triggers'            :  { "Hlt1TrackMuonDecision%TOS" : 0, "Hlt1SingleMuonNoIPL0Decision%TOS" : 0, "Hlt1SingleMuonIPCL0Decision%TOS" : 0},
    'UpsilonHlt1Triggers'         :  { "Hlt1SingleMuonNoIPL0Decision%TOS" : 0},
    'ZHlt1Triggers'               :  { "Hlt1SingleMuonNoIPL0Decision%TOS" : 0, "Hlt1SingleMuonNoIPL0HighPT%TOS" : 0},
    'JpsiHlt2Triggers'            :  { "Hlt2SingleMuon.*Decision%TOS" : 0, "Hlt2PassThroughDecision%TOS" : 0 },
    'UpsilonHlt2Triggers'         :  { "Hlt2PassThroughDecision%TOS" : 0}, #there does not seem to be a good trigger
    'ZHlt2Triggers'               :  { "Hlt2SingleHighPTMuonDecision%TOS" : 0},
    'BJpsiKHlt2TriggersTUS'       :  { "Hlt2MuTrackDecision%TUS" : 0},
    'BJpsiKHlt2TriggersTOS'       :  { "Hlt2MuTrackDecision%TOS" : 0},
    'JpsiPrescale'                : 1,
    'UpsilonPrescale'             : 1,
    'ZPrescale'                   : 1,
    'BJpsiKPrescale'              : 1,
