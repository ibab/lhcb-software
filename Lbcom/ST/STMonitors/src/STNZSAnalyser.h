// $Id: STNZSAnalyser.h,v 1.1.1.1 2009-03-02 19:13:44 mtobin Exp $
#ifndef STNZSAnalyser_H
#define STNZSAnalyser_H 1

#include "GaudiAlg/GaudiHistoAlg.h"

/** @class STNZSAnalyser STNZSAnalyser.h
 *
...
class STNZSAnalyser : public GaudiHistoAlg{

public:
 
  /// constructer
  STNZSAnalyser( const std::string& name, ISvcLocator *svcloc );

  /// destructer
  virtual ~STNZSAnalyser();
