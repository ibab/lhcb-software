...
DECLARE_ALGORITHM_FACTORY( STNZSAnalyser);
...
STNZSAnalyser::STNZSAnalyser( const std::string& name, ISvcLocator* pSvcLocator ) :
...
STNZSAnalyser::~STNZSAnalyser()
{
  // destructer
}

StatusCode STNZSAnalyser::initialize()
{
...
StatusCode STNZSAnalyser::execute()
{ 
  m_evtNumber++;
...
StatusCode STNZSAnalyser::finalize()
{
  //printHistos();
