...
class L0MuonMonCompare( ConfigurableAlgorithm ) :
  __slots__ = { 
    'OutputLevel' : 0, # int
    'Enable' : True, # bool
    'ErrorMax' : 1, # int
  ...
  def __init__(self, name = Configurable.DefaultName, **kwargs):
      super(L0MuonMonCompare, self).__init__(name)
      for n,v in kwargs.items():
         setattr(self, n, v)
  def getDlls( self ):
      return 'L0MuonMonitor'
  def getType( self ):
      return 'L0MuonMonCompare'
  pass # class L0MuonMonCompare
