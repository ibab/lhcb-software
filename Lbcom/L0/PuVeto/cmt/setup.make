...
L0DUROOT = /afs/cern.ch/user/o/ocallot/newmycmt/L0/L0DU/v3r0
L0CALOROOT = /afs/cern.ch/user/o/ocallot/newmycmt/L0/L0Calo/v4r0
L0EVENTROOT = /afs/cern.ch/user/o/ocallot/newmycmt/Event/L0Event/v10r0
...
VELODETROOT = /afs/cern.ch/lhcb/software/NEW/Det/VeloDet/v3r0
CALODETROOT = /afs/cern.ch/lhcb/software/NEW/Det/CaloDet/v3r0
DETDESCROOT = /afs/cern.ch/lhcb/software/NEW/Det/DetDesc/v9r2
EVENTKERNELROOT = /afs/cern.ch/lhcb/software/DEV/Event/EventKernel/v1r0
...
EXTERNALLIBSROOT = /afs/cern.ch/sw/Gaudi/releases/ExternalLibs/v3r4
use_requirements = requirements $(CMTROOT)/mgr/requirements $(L1EVENTROOT)/cmt/requirements $(VELOEVENTROOT)/cmt/requirements $(L0DUROOT)/cmt/requirements $(L0CALOROOT)/cmt/requirements $(L0EVENTROOT)/cmt/requirements $(CALOEVENTROOT)/cmt/requirements $(L0MUONROOT)/cmt/requirements $(LHCBEVENTROOT)/cmt/requirements $(GAUDIOBJDESCROOT)/cmt/requirements $(GAUDIINTROSPECTIONROOT)/cmt/requirements $(VELODETROOT)/cmt/requirements $(CALODETROOT)/cmt/requirements $(DETDESCROOT)/cmt/requirements $(EVENTKERNELROOT)/cmt/requirements $(CALOKERNELROOT)/cmt/requirements $(GAUDIKERNELROOT)/cmt/requirements $(GAUDIPOLICYROOT)/cmt/requirements $(AIDAROOT)/cmt/requirements $(CLHEPROOT)/cmt/requirements $(XERCESROOT)/cmt/requirements $(EXTERNALLIBSROOT)/cmt/requirements 
constituents = PuVeto 
