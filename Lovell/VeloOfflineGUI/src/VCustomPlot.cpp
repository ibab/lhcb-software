...
VCustomPlot::VCustomPlot(std::string title, bool isPopUp, VPlot * plot, VPlotOps * plotOps) {
  ...
  // Fonts.
  QFont ftick(font().family(), 9);
  QFont faxistitle(font().family(), 9, QFont::Bold);
  QFont flegend(font().family(), 9);
  QFont ftitle(font().family(), 9, QFont::Bold);
