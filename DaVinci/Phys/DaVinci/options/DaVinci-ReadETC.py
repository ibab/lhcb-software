## $Id: DaVinci-ReadETC.py,v 1.1 2009-02-10 12:07:35 pkoppenb Exp $
## ============================================================================
...
EventSelector().Input   = [
    "COLLECTION='TagCreator/1' DATAFILE='DVPresel_ETC2.root' TYP='POOL_ROOT' SEL='(PreselBd2KstarMuMu>0)'" ]
