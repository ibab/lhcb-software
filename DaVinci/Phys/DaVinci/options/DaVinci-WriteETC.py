## $Id: DaVinci-WriteETC.py,v 1.1 2009-02-10 12:07:35 pkoppenb Exp $
## ============================================================================
...
DaVinci().MainOptions  = "$DAVINCIROOT/options/Presel.opts"
DaVinci().EvtMax = 500
DaVinci().PrintFreq  = 1
...
DaVinci().ETCItemList = [ "/NTUPLES/EVTTAGS/TagCreator/1" ]
