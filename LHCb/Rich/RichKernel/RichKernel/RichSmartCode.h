...
namespace RichSmartCode {
  ...
  /// The number of bits dedicated to the RICH pixel row number (0-31)
  // need 1 extra bit for SICB
  static const ShortType BitsPixelRow   = 6;

  /// The number of bits dedicated to the RICH pixel column number (0-31)
  // need 1 extra bit for SICB
  ...
  static const ShortType BitsRichOK     = 0;

  /// Status bit for RICH panel field
  // Disable until SICB retires due to lack of bits
  static const ShortType BitsPanelOK    = 0;
  ...
  static const LongType SetRichOK  = ( (LongType)1 << ShiftRichOK ) & MaskRichOK;
  static const LongType SetPanelOK = ( (LongType)1 << ShiftPanelOK ) & MaskPanelOK;
  static const LongType SetPDRowOK = ( (LongType)1 << ShiftPDRowOK ) & MaskPDRowOK;
  static const LongType SetPDColOK = ( (LongType)1 << ShiftPDColOK ) & MaskPDColOK;
  static const LongType SetPixelRowOK = ( (LongType)1 << ShiftPixelRowOK ) & MaskPixelRowOK;
  static const LongType SetPixelColOK = ( (LongType)1 << ShiftPixelColOK ) & MaskPixelColOK;
  static const LongType SetSubPixelOK = ( (LongType)1 << ShiftSubPixelOK ) & MaskSubPixelOK;
