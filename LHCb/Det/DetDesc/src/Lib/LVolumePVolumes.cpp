...
// ===========================================================================
/** @defgroup Create1 
 *  imeplementation of CreatePV* methods of class LVplume
 *  @{ 
 */
// ===========================================================================
...
// ===========================================================================
// ===========================================================================
IPVolume* LVolume::createPVolume() 
                                  ...
                                  const HepRotation&    Rotation       ) 
{
  ...
  try{ pv = new  PVolume( PVname , LVnameForPV , Position , Rotation ); }
    ...
    { Assert( false , "createPVolume() (3) , unknown exception!"); } 
  ///
  Assert( 0 != pv , 
                                  ...
                                  const HepTransform3D& Transform      )
{
  ...
  try{ pv = new  PVolume( PVname , LVnameForPV , Transform ); }
    ...
    { Assert( false , 
              "LVolume::createPVolume(), exception caught! " , 
              Exception ); } 
  catch(...)                        
    { Assert( false , "LVolume::createPVolume(), unknown exception"); } 
  ///
  Assert( 0 != pv , 
          "LVolume::createPVolume, could not create volume " + 
          PVname+"(lv="+LVnameForPV+")" );
