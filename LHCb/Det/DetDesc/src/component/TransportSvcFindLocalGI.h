                                           ...
                                           IGeometryInfo*    gi     ) const  
{
  ...
  try {  
    ...
    ///
    /// points are located in different geometry elements, or geometry element is not good!
    /// 
    ...
    m_vGi1.clear();   
    for( vgi = gi1 ; 0 != vgi ; vgi = vgi->parentIGeometryInfo()  ) { m_vGi1.push_back( vgi ); }  
    ...
    m_vGi2.clear(); 
    for( vgi = gi2 ; 0 != vgi ; vgi = vgi->parentIGeometryInfo()  ) { m_vGi2.push_back( vgi ); }  
    ...
    if( m_vGi.empty() ) { return 0 ; }                                                                        /// RETURN !!! 
    ...
    for( rGeoIt it = m_vGi.rbegin() ; m_vGi.rend() != it && 0 == goodGI ; ++it ) 
