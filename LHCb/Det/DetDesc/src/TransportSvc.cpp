...
///
/// some methods are placed in other files:
///

#include "DetDesc/TransportSvc.distanceInRadUnits.h" 
#include "DetDesc/TransportSvc.findLocalGI.h" 
#include "DetDesc/TransportSvc.goodLocalGI.h" 
#include "DetDesc/TransportSvc.intersections.h" 
...
StatusCode TransportSvc::initialize()
{
  ...
  { 
    ...
    StatusCode statusCode = 
      serviceLocator()->getService( m_chronoStatSvc_name , IID_IChronoStatSvc , (IInterface*&) m_chronoStatSvc ) ;
  ...
  { 
    ...
    ///
    StatusCode statusCode = 
      serviceLocator()->getService( m_magFieldSvc_name , IID_IMagneticFieldSvc , (IInterface*&) m_magFieldSvc ) ;
  ...
  { 
    ...
    ///
    StatusCode statusCode = 
      serviceLocator()->getService( m_detDataSvc_name , IID_IDataProviderSvc , (IInterface*&) m_detDataSvc ) ;
