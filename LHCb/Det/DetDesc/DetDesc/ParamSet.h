//$Id: ParamSet.h,v 1.1 2003-04-23 10:06:42 sponce Exp $
#ifndef DETDESC_PARAMSET_H 
#define DETDESC_PARAMSET_H 1
...
class ParamSet: virtual public IParamSet
{
...
public:
  ...
  ParamSet( IParamSet& obj );

  /// Assignment operator from an IParamSet
  ParamSet& operator= ( IParamSet& obj );
...
public:
  ...
  // Implementation of IParamSet interface.
...
public:
  ...
  // Implementation of IParam interface.
...
public:
   ...
   * (this is only a clue for the user, it is not used by ParamSet)
