// $Id: DeVeloPileUpType.cpp,v 1.1 2004-01-29 01:02:18 mtobin Exp $
//==============================================================================
#define VELODET_DEVELOPILEUPTYPE_CPP 1
//==============================================================================
// Include files 
#include "VeloDet/DeVeloPileUpType.h"

/** @file DeVeloPileUpType.cpp
 *
 *  Implementation of class : DeVeloPileUpType
 *
...
//==============================================================================
DeVeloPileUpType::DeVeloPileUpType(const std::string& name) : DeVeloSensor(name)
{
}
//==============================================================================
/// Destructor
//==============================================================================
DeVeloPileUpType::~DeVeloPileUpType()
{
}
//==============================================================================
/// Object identification
//==============================================================================
const CLID& DeVeloPileUpType::clID() 
  const { return DeVeloPileUpType::classID(); }
//==============================================================================
/// Initialisation method
//==============================================================================
StatusCode DeVeloPileUpType::initialize() 
{
  MsgStream msg(msgSvc(), "DeVeloPileUpType");
  ...
  jobSvc->setMyProperties("DeVeloPileUpType", pmgr);
  if ( 0 < outputLevel ) {
    msgSvc()->setOutputLevel("DeVeloPileUpType", outputLevel);
  }
  delete pmgr;
...
//==============================================================================
StatusCode DeVeloPileUpType::pointToChannel(const HepPoint3D& point,
...
//==============================================================================
StatusCode DeVeloPileUpType::isInside(const HepPoint3D& point)
{
  // check boundaries....  
...
//==============================================================================
bool DeVeloPileUpType::isCutOff(double x, double y)
{
...
//==============================================================================
StatusCode DeVeloPileUpType::neighbour(const VeloChannelID& start, 
                                  const int& nOffset, 
                                  VeloChannelID& channel)
{
...
//==============================================================================
StatusCode DeVeloPileUpType::channelDistance(const VeloChannelID& start,
...
//==============================================================================
StatusCode DeVeloPileUpType::residual(const HepPoint3D& point, 
...
//==============================================================================
unsigned int DeVeloPileUpType::numberOfZones()
{
...
//==============================================================================
unsigned int DeVeloPileUpType::zoneOfStrip(const unsigned int strip)
{
...
//==============================================================================
unsigned int DeVeloPileUpType::zoneOfPhi(double phi)
{
  unsigned int zone=0;
...
//==============================================================================
unsigned int DeVeloPileUpType::firstStrip(unsigned int zone)
{
  return zone*512;
}
...
//==============================================================================
unsigned int DeVeloPileUpType::stripsInZone(const unsigned int /*zone*/)
{
...
//==============================================================================
void DeVeloPileUpType::calcStripLimits()
{
  MsgStream msg( msgSvc(), "DeVeloPileUpType" );
...
//==============================================================================
void DeVeloPileUpType::cornerLimits()
{
...
//==============================================================================
void DeVeloPileUpType::phiZoneLimits()
{
...
//==============================================================================
double DeVeloPileUpType::rOfStrip(const unsigned int strip)
{
...
//==============================================================================
double DeVeloPileUpType::rOfStrip(unsigned int strip, double fraction)
{
...
//==============================================================================
double DeVeloPileUpType::rPitch(unsigned int strip)
{
...
//==============================================================================
double DeVeloPileUpType::rPitch(double radius)
{
...
//==============================================================================
double DeVeloPileUpType::phiMinZone(unsigned int zone)
{
...
//==============================================================================
double DeVeloPileUpType::phiMinZone(unsigned int zone, double radius)
{
  double phiMin;
  if(0 == zone){
...
//==============================================================================
double DeVeloPileUpType::phiMaxZone(unsigned int zone)
{
...
//==============================================================================
double DeVeloPileUpType::phiMaxZone(unsigned int zone, double radius)
{
  double phiMax;
  if(1 == zone){
    phiMax = asin(m_phiGap/radius);
...
//==============================================================================
double DeVeloPileUpType::stripCapacitance(unsigned int /*strip*/)
{
  double C=0.0;
  return C;
}
...
//==============================================================================
StatusCode DeVeloPileUpType::stripLimits(unsigned int strip, double &radius,
...
double DeVeloPileUpType::phiMinStrip(unsigned int strip)
{
  return m_stripLimits[strip].first;
}
double DeVeloPileUpType::phiMaxStrip(unsigned int strip)
{
