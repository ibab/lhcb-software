// $Id: MDFSelector.h,v 1.1 2005-12-20 16:33:38 frankb Exp $
//====================================================================
//	MDFSelector.h
//--------------------------------------------------------------------
//
//  Description: The MDFSelector component is able
...
//
//====================================================================
// $Header: /afs/cern.ch/project/cvs/reps/lhcb/DAQ/MDF/MDF/MDFSelector.h,v 1.1 2005-12-20 16:33:38 frankb Exp $

#ifndef MDF_MDFSELECTOR_H
#define MDF_MDFSELECTOR_H 1
...
namespace LHCb  {
  ...
  */
  class MDFSelector : public Service, virtual public IEvtSelector  {
  public:
    ...
    */
    ...
    /// Service Constructor
    MDFSelector( const std::string& name, ISvcLocator* svcloc );
