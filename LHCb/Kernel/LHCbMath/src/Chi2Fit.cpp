...
namespace 
{
  ...
  {
    // ========================================================================
    friend  class Gaudi::Math::Chi2Fit ;
    // ========================================================================
  public:
    // ========================================================================
    typedef Gaudi::Math::Chi2Fit::VE    VE   ;
    typedef Gaudi::Math::Chi2Fit::DATA  DATA ;
    typedef Gaudi::Math::Chi2Fit::CMPS  CMPS ;
    // ========================================================================
  protected : // protected interface 
    // ========================================================================
    Chi2 ( const Gaudi::Math::Chi2Fit& fit ) ;
    // ========================================================================
    ~Chi2 () ; // destructor
    // ========================================================================
  protected:
  ...
  private: 
    // ========================================================================
    const Gaudi::Math::Chi2Fit* m_fit         ;
    //
  ...
  // constructor 
  // ==========================================================================
  Chi2::Chi2 ( const Gaudi::Math::Chi2Fit& fit ) 
    : m_fit          ( &fit ) 
    , m_calls_f      ( 0 )
    , m_calls_df     ( 0 ) 
    , m_calls_fdf    ( 0 ) 
  ...
  StatusCode Chi2::fit () 
  {
    ...
    StatusCode sc = Gaudi::Math::GSL::invert_LU_2 ( m_hessian , m_covariance  ) ;
...
namespace 
{
  Gaudi::Math::Chi2Fit::VE
  _adjust_ ( const Gaudi::Math::Chi2Fit::DATA& data ,
             Gaudi::Math::Chi2Fit::DATA&       comp ,
             const std::size_t                 ncmp )  
  {
    ...
    //
    VE sumd = Gaudi::Math::sum     ( data ) ;
    VE sumc = Gaudi::Math::sum     ( comp ) ;
    //
    if ( 0 != sumc.value() ) 
    {
      //
    ...
    //
    VE asumd = Gaudi::Math::abssum ( data ) ;
    VE asumc = Gaudi::Math::abssum ( data ) ;
    //
    if ( 0 != asumc ) 
    {
      //
...
// ============================================================================
Gaudi::Math::Chi2Fit::Chi2Fit 
( const Gaudi::Math::Chi2Fit::DATA& data , 
  const Gaudi::Math::Chi2Fit::DATA& cmps )
//
  : m_data (     data )
  , m_cmps ( 1 , cmps ) 
  , m_init () 
...
Gaudi::Math::Chi2Fit::Chi2Fit 
( const Gaudi::Math::Chi2Fit::DATA& data , 
  const Gaudi::Math::Chi2Fit::CMPS& cmps )
  : m_data ( data )
  , m_cmps ( cmps ) 
  , m_init () 
//
...
// destructor 
// ============================================================================
Gaudi::Math::Chi2Fit::~Chi2Fit () // destructor 
{
  //
  if ( 0 != m_solu )
  {
...
// ============================================================================
Gaudi::Math::Chi2Fit::VE          
Gaudi::Math::Chi2Fit::param  ( const unsigned int index ) const 
{
  // 
...
// ============================================================================
Gaudi::Math::Chi2Fit::DATA
Gaudi::Math::Chi2Fit::params () const            // get all parameters at once
{
  Gaudi::Math::Chi2Fit::DATA pars ;
  //
...
// ============================================================================
double Gaudi::Math::Chi2Fit::cov2   ( const unsigned int i1 , 
...
// ============================================================================
std::ostream& 
Gaudi::Math::Chi2Fit::fillStream ( std::ostream& s ) const 
{
...
// output 
// ============================================================================
std::string Gaudi::Math::Chi2Fit::toString () const 
{
  std::ostringstream s;
  fillStream ( s ) ;
  return s.str();
