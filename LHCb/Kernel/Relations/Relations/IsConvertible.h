// $Id: IsConvertible.h,v 1.4 2008-11-29 16:25:30 ibelyaev Exp $
// ============================================================================
...
namespace Relations 
{
   ...
   *
   *  @todo re-enable boost::is_cinvertible 
   *  @warning temporary disable boost::ins_convertible, 
   *           since it is not compatible with Reflex 
   *           for VC7.1 and gcc4.3
   *
