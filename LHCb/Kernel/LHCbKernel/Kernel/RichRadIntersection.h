...
namespace Rich
{
  ...
  public:
    ...
    /// Constructor from (copied) entry and exit points and momentum vectors, and a pointer to a DeRichRadiator
    ...
    /// Constructor from (moved) entry and exit points and momentum vectors, and a pointer to a DeRichRadiator
