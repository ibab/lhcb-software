// $Id: LineTraj.cpp,v 1.2 2006-02-06 11:13:07 ebos Exp $
// Include files
...
Gaudi::XYZPoint LineTraj::position( const double& arclength ) const
{
  return m_pos + arclength * m_dir;
}

/// First derivative of the trajectory at arclength from the starting point
Gaudi::XYZVector LineTraj::direction( const double& arclength ) const
{
  return m_dir;
}

/// Second derivative of the trajectory at arclength from the starting point
Gaudi::XYZVector LineTraj::curvature( const double& arclength ) const 
{
...
void LineTraj::expansion( const double& arclength,
                          Gaudi::XYZPoint& p,
                          Gaudi::XYZVector& dp,
...
ROOT::Math::SMatrix<double,3,LineTraj::kSize> LineTraj::derivative( const double& arclength ) const
{
  ROOT::Math::SMatrix<double,3,LineTraj::kSize> deriv = ROOT::Math::SMatrix<double,3,LineTraj::kSize>();
...
double LineTraj::distanceToPoint( const Gaudi::XYZPoint& point ) const
{
  Gaudi::XYZVector vec = Gaudi::XYZVector();
...
// Not yet implemented
double LineTraj::distTo1stError( double& , const double& , int ) const 
{
  return 10*km;
}

// Not yet implemented
double LineTraj::distTo2ndError( double& , const double& , int ) const
{
  return 10*km;
}
...
std::pair<double,double> LineTraj::range() const
{
  return m_range;
}
