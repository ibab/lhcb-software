// $Id: CaloSpdBitFromRaw.cpp,v 1.3 2005-09-06 14:50:01 ocallot Exp $
// Include files 
...
//  Initialisation
//=========================================================================
StatusCode CaloSpdBitFromRaw::initialize ( ) {
    ...
    while ( m_banks->end() != m_itB ) {
      ...
      while( 0 != m_dataSize ) {
        ...
        while ( 0 < m_lenTrig ) {
          ...
          int isSet = (  m_lastData >> (m_offset +7)) & 1;
          if ( msgLevel( MSG::DEBUG) ) {
            debug() << format( "  data %8x len %3d offset %2d num %2d spd %1d",
