...
static const InterfaceID IID_IPatUTCounter ( "IPatUTCounter", 1, 0 );

/** @class IPatUTCounter IPatUTCounter.h PatKernel/IPatUTCounter.h
 *  
 *
 *  @author Wenbin Qian
 *  @date   2011-03-21
 */
class IPatUTCounter : virtual public IAlgTool {
public: 

  // Return the interface ID
  static const InterfaceID& interfaceID() { return IID_IPatUTCounter; }
