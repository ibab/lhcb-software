...
#  Document OTDictsGen
#
#   Generated Mon Sep  6 10:23:39 2010  by dvaneijk
#
#====================================
...
ifndef QUICK
$(bin)OTDictsGen_dependencies.make : /afs/cern.ch/user/d/dvaneijk/cmtuser/Bender_v14r5/Dicts/OTDicts/dict/OTDicts.h $(use_requirements) $(cmt_final_setup_OTDictsGen)
	$(echo) "(OTDictsGen.make) Rebuilding $@"; \
	  $(build_dependencies) OTDictsGen -all_sources -out=$@ /afs/cern.ch/user/d/dvaneijk/cmtuser/Bender_v14r5/Dicts/OTDicts/dict/OTDicts.h
endif
...
$(gensrcdict) $(rootmapdict) :: $(OTDicts_h_dependencies) $(OTDicts_reflex_selection_file)
	echo $@ OTDicts.h
	@-mkdir -p $(dictdir)
	$(genreflex_cmd) /afs/cern.ch/user/d/dvaneijk/cmtuser/Bender_v14r5/Dicts/OTDicts/dict/OTDicts.h -o $(gensrcdict) $(OTDicts_reflex_options)  \
