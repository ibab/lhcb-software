...
#  Library OTDictsDict
#
#   Generated Tue Oct 26 14:03:54 2010  by dvaneijk
#
#====================================
...
ifndef QUICK
$(bin)OTDictsDict_dependencies.make : ../x86_64-slc5-gcc43-opt/dict/OTDicts/OTDicts_dict.cpp $(use_requirements) $(cmt_final_setup_OTDictsDict)
	$(echo) "(OTDictsDict.make) Rebuilding $@"; \
	  $(build_dependencies) OTDictsDict -all_sources -out=$@ ../x86_64-slc5-gcc43-opt/dict/OTDicts/OTDicts_dict.cpp
endif
...
$(bin)$(binobj)OTDicts_dict.d : ../x86_64-slc5-gcc43-opt/dict/OTDicts/OTDicts_dict.cpp
	$(dep_echo) $@
	$(cpp_silent) $(cppcomp) $(cppdepflags) -o $(@D)/OTDicts_dict.dep $(use_pp_cppflags) $(OTDictsDict_pp_cppflags) $(lib_OTDictsDict_pp_cppflags) $(OTDicts_dict_pp_cppflags) $(use_cppflags) $(OTDictsDict_cppflags) $(lib_OTDictsDict_cppflags) $(OTDicts_dict_cppflags) $(OTDicts_dict_cpp_cppflags) -I../x86_64-slc5-gcc43-opt/dict/OTDicts ../x86_64-slc5-gcc43-opt/dict/OTDicts/OTDicts_dict.cpp
	$(cpp_silent) $(format_dependencies) $@ $(@D)/OTDicts_dict.o ../x86_64-slc5-gcc43-opt/dict/OTDicts/OTDicts_dict.cpp $(@D)/OTDicts_dict.dep
endif
endif

$(bin)$(binobj)OTDicts_dict.o : ../x86_64-slc5-gcc43-opt/dict/OTDicts/OTDicts_dict.cpp
else
$(bin)OTDictsDict_dependencies.make : $(OTDicts_dict_cpp_dependencies)

$(bin)$(binobj)OTDicts_dict.o : $(OTDicts_dict_cpp_dependencies)
endif
	$(cpp_echo) ../x86_64-slc5-gcc43-opt/dict/OTDicts/OTDicts_dict.cpp
	$(cpp_silent) $(cppcomp) -o $@ $(use_pp_cppflags) $(OTDictsDict_pp_cppflags) $(lib_OTDictsDict_pp_cppflags) $(OTDicts_dict_pp_cppflags) $(use_cppflags) $(OTDictsDict_cppflags) $(lib_OTDictsDict_cppflags) $(OTDicts_dict_cppflags) $(OTDicts_dict_cpp_cppflags) -I../x86_64-slc5-gcc43-opt/dict/OTDicts ../x86_64-slc5-gcc43-opt/dict/OTDicts/OTDicts_dict.cpp
