...
{
  // ==========================================================================
  class _TC : public LoKi::Functor<void,bool>
  {
  public:
    // ========================================================================
    _TC ( const LoKi::TES::Get&                                 obj , 
    ...
    // ========================================================================     
    virtual ~_TC () {}
    virtual  _TC* clone() const { return new _TC(*this) ; }
    // ========================================================================
    ...
    {
      //
      if ( 0 == m_rep || !sameEvent() ) 
      { 
        m_rep = LoKi::TES::get_<LHCb::HltDecReports> ( m_get ) ; 
        setEvent () ;
      }
      //
      if ( 0 == m_rep ) 
      {
        Error ("No valid HltDecReports is found, return False") ;
        return false ;
      }
      //
      return m_cut ( m_rep ) ;
  ...
  private:
    ...
    _TC() ;                                // default constructor is disabled 
    // ========================================================================
  private:
    // ========================================================================
    LoKi::TES::Get                                            m_get ;
    LoKi::FunctorFromFunctor<const LHCb::HltDecReports*,bool> m_cut ;
    mutable const LHCb::HltDecReports*                        m_rep ;
    // ======================================================================== 
  };
  // ==========================================================================
  class _TF : public LoKi::Functor<void,double>
  {
  public:
    // ========================================================================
    _TF ( const LoKi::TES::Get&                                   obj , 
    ...
    // ========================================================================     
    virtual ~_TF () {}
    virtual  _TF* clone() const { return new _TF(*this) ; }
    // ========================================================================
    virtual std::ostream& fillStream ( std::ostream& s ) const 
    ...
    virtual result_type operator() ( /* argument */ ) const 
    {
      ...
      if ( 0 == m_rep ) 
      {
        Error ("No valid HltDecReports is found, return NegativeInfinity") ;
  ...
  private:
    // ========================================================================
    /// default constructor is disabled 
    _TF() ;                                 // default constructor is disabled 
    // ========================================================================
  private:
    // ========================================================================
    LoKi::TES::Get                                              m_get ;
    LoKi::FunctorFromFunctor<const LHCb::HltDecReports*,double> m_fun ;
    mutable const LHCb::HltDecReports*                          m_rep  ;
    // ========================================================================    
  };
  // ==========================================================================
