...
{
  // ==========================================================================
  class _O1C : public LoKi::Functor<void,bool>
  {
  public:
    // ========================================================================
    _O1C ( const LoKi::TES::Get&                        obj , 
    ...
    // ========================================================================     
    virtual ~_O1C () {}
    virtual  _O1C* clone() const { return new _O1C(*this) ; }
    // ========================================================================
    ...
    virtual result_type operator() ( /* argument */ ) const 
    {
      ...
      if ( 0 == m_o1 || !sameEvent() ) 
      { 
        m_o1 = LoKi::TES::get_<LHCb::ODIN> ( m_get ) ; 
        setEvent () ;
      }
      //
      if ( 0 == m_o1 ) 
      {
        Error ("No valid ODIN is found, return False") ;
        return false ;
      }
      //
      return m_cut ( m_o1 ) ;
  ...
  private:
    ...
    _O1C() ;                                // default constructor is disabled 
    // ========================================================================
  private:
    // ========================================================================
    LoKi::TES::Get                                   m_get ;
    LoKi::FunctorFromFunctor<const LHCb::ODIN*,bool> m_cut ;
    mutable const LHCb::ODIN*                        m_o1  ;
    // ========================================================================    
  };
  // ==========================================================================
  class _O1F : public LoKi::Functor<void,double>
  {
  public:
    // ========================================================================
    _O1F ( const LoKi::TES::Get&                          obj , 
    ...
    // ========================================================================     
    virtual ~_O1F () {}
    virtual  _O1F* clone() const { return new _O1F(*this) ; }
    // ========================================================================
    virtual std::ostream& fillStream ( std::ostream& s ) const 
    ...
    virtual result_type operator() ( /* argument */ ) const 
    {
      ...
      if ( 0 == m_o1 ) 
      {
        Error ("No valid ODIN is found, return NegativeInfinity") ;
  ...
  private:
    // ========================================================================
    /// default constructor is disabled 
    _O1F() ;                                 // default constructor is disabled 
    // ========================================================================
  private:
    // ========================================================================
    LoKi::TES::Get                                     m_get ;
    LoKi::FunctorFromFunctor<const LHCb::ODIN*,double> m_fun ;
    mutable const LHCb::ODIN*                          m_o1  ;
    // ========================================================================    
  };
  // ==========================================================================
