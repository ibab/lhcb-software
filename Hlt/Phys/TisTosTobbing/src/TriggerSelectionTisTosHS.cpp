// $Id: TriggerSelectionTisTosHS.cpp,v 1.3 2009-01-19 17:12:30 tskwarni Exp $
// Include files 
#include <algorithm>
...
//-----------------------------------------------------------------------------
// Implementation file for class : TriggerSelectionTisTosHS
//
// 2007-08-06 : Tomasz Skwarnicki
//-----------------------------------------------------------------------------

// Declaration of the Tool Factory
DECLARE_TOOL_FACTORY( TriggerSelectionTisTosHS );


//=============================================================================
// Standard constructor, initializes variables
//=============================================================================
TriggerSelectionTisTosHS::TriggerSelectionTisTosHS( const std::string& type,
...
// Destructor
//=============================================================================
TriggerSelectionTisTosHS::~TriggerSelectionTisTosHS() {} 

//=============================================================================
// Initialization
//=============================================================================
StatusCode TriggerSelectionTisTosHS::initialize() {
...
// see HitType enum
// =====================================================================
int TriggerSelectionTisTosHS::hitMatchType(const LHCbID & id)
{  
...
//    off-line track)
//============================================================================
void TriggerSelectionTisTosHS::matchIDs(const LHCb::Track & track, 
...
//=============================================================================  
std::vector<const LHCb::Particle*> TriggerSelectionTisTosHS::finalStateParticles(const LHCb::Particle* particle) 
{
...
//=============================================================================  
void TriggerSelectionTisTosHS::trackListTISTOS(const std::vector<Track*> & ontracks,
...
//=============================================================================  
void TriggerSelectionTisTosHS::vertexListTISTOS(const std::vector<RecVertex*> & onvertices,
                                 const ClassifiedHits offidlist[],
                                 bool& TIS,bool& TOS) const
{
...
//=============================================================================  
void TriggerSelectionTisTosHS::particleListTISTOS(const SmartRefVector<LHCb::Particle> & onparticles,
                                 const ClassifiedHits offidlist[],
                                 bool& TIS,bool& TOS) 
{
    TIS=false;TOS=false;
...
void TriggerSelectionTisTosHS::getHltSummary()
{
  if( m_summary == 0 ){
...
void TriggerSelectionTisTosHS::setOfflineInput( )
{
  for( int hitType=0; hitType!=nHitTypes; ++hitType ){
...
//    hit list input ---------------------------------------------------------------
void TriggerSelectionTisTosHS::addToOfflineInput( const std::vector<LHCb::LHCbID> & hitlist, ClassifiedHits hitidlist[] )
{
  bool modified(false);
...
//    calo hit list input ---------------------------------------------------------------
void TriggerSelectionTisTosHS::addToOfflineInput( const std::vector<LHCb::CaloCellID> & hitlist, ClassifiedHits hitidlist[] )
{
  bool modified(false);
...
//    Track input ---------------------------------------------------------------
void TriggerSelectionTisTosHS::addToOfflineInput( const LHCb::Track & track, ClassifiedHits hitidlist[]) 
{
...
void TriggerSelectionTisTosHS::addToOfflineInput( const LHCb::ProtoParticle & protoParticle,
...
void TriggerSelectionTisTosHS::addToOfflineInput( const LHCb::Particle & particle, ClassifiedHits hitidlist[]  )
{
...
void TriggerSelectionTisTosHS::selectionTisTos( const std::string & selectionName,  
...
void TriggerSelectionTisTosHS::selectionTisTos( const std::vector< std::string > & selectionNames,
                                bool & decision, bool & tis, bool & tos ,
                                bool selectionOR)
{
  if( selectionOR ){
...
std::vector<LHCb::LHCbID> TriggerSelectionTisTosHS::offlineLHCbIDs() 
{
...
std::vector<const LHCb::Track*>     TriggerSelectionTisTosHS::matchedTOSTracks( const std::string & selectionName )
{
...
std::vector<const LHCb::RecVertex*> TriggerSelectionTisTosHS::matchedTOSVertices( const std::string & selectionName )
{
...
std::vector<const LHCb::Particle*>  TriggerSelectionTisTosHS::matchedTOSParticles( const std::string & selectionName )
{
...
std::vector<const LHCb::HltObjectSummary*> TriggerSelectionTisTosHS::hltSelectionObjectSummaries(
                                                                                       const std::string & ,
                                                                                       unsigned int ,
                                                                                       unsigned int )
{ 
  // Warning(" Dummy TriggerSelectionTisTosHS::hltObjectSummaries was called ",StatusCode::SUCCESS, 10 );
  return std::vector<const LHCb::HltObjectSummary*>(); 
}
