...
namespace LoKi
{
  ...
  namespace Tracks
  {
    ...
    { 
      typedef LoKi::BasicFunctors<LHCb::Track*>::Source _Source;
    public:
      ...
      ( const std::string&              path                    , 
        ...
        LoKi::BasicFunctors<LHCb::Track>::BooleanConstant(true) ) ; 
      /// constructor from the service, TES location and cuts 
      SourceTES 
    ...
    /** @class SourceDirect
     * 
     *  @see LoKi::Cuts::TrSOURCEDIRECT
     *  simple "direct source for the tracks"
     *  @author Vanya BELYAEV ibelyav@physics.syr.edu
     *  @date 2006-12-07
     */
    class SourceDirect
    ...
    public:
      ...
      SourceDirect ( const LHCb::Track::Vector* data  ) ;
    ...
    public:
      /// get the data:
      const LHCb::Track::Vector* data() const { return m_data ; }
      /// set the data 
      void setData ( const LHCb::Track::Vector* value ) { m_data = value ; }
      /// set the data 
    ...
    private:
      ...
      const LHCb::Track::Vector* m_data ; ///< pointer to the container of tracks:
    } ;
    // ========================================================================
