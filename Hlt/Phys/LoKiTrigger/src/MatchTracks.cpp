...
LoKi::Hlt1::MatchTracks::MatchTracks( const Source & candidates, 
...
LoKi::Hlt1::MatchTracks::MatchTracks( const std::string candidates, 
                         const LoKi::Hlt1::MatchConf & config ) 
            :  LoKi::Hlt1::MatchTool ( config )
             , m_source2    { LoKi::Hlt1::Selection{ std::move(candidates)  } } 
{
        ;
}
