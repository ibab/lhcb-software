...
//       BindAbsMin ,  // bind using LHCb::Math::abs_less
//       BindMax    ,  // bind using std::greater 
//       BindAbsMax    // bind using LHCb::Math::abs_greater
//     };
//     // ========================================================================
...
//      */
//     // ========================================================================
//     template <class TYPE,class TYPE2, class BINOP>
...
//         this->m_binder.binder().setContainer ( 0 ) ;
        
//         /// nothing to be filtered? 
//         if ( this->m_input && a1.empty() ) { return a1 ; } // RETURN
