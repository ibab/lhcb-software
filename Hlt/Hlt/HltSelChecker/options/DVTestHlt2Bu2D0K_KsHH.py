### $Id: DVTestHlt2Bu2D0K_KsHH.py,v 1.22 2009-10-15 12:32:16 pkoppenb Exp $
 #
...
DaVinci().Input = [
  "DATAFILE='PFN:castor:/castor/cern.ch/user/d/dijkstra/Selections-DC06/Bu2KD-KSPiPi-lum2-fixedL0.dst' TYP='POOL_ROOTTREE' OPT='READ'" ]
