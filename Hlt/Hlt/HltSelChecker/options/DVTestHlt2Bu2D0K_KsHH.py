...
HltCorrelations("Hlt2SelectionsCorrs").Algorithms += [ "PreselBu2D0K_D02KsPiPi" ]
...
FilterTrueTracks("FilterTrueMuons").MCDecayFinder.Decay =  "[B+ -> (D~0 -> (KS0 -> ^pi+ ^pi- {,gamma}{,gamma}{,gamma}) ^pi+ ^pi- {,gamma}{,gamma}{,gamma}) ^K+ {,gamma}{,gamma}]cc" 
#
