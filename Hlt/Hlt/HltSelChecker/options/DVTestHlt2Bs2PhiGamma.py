...
DecayTreeTuple("Hlt2DecayTreeTuple").PhysDesktop.InputLocations = ["Hlt2Bs2PhiGammaCombineParticlesCombine"]
...
DaVinci().Input = [
  "DATAFILE='PFN:castor:/castor/cern.ch/user/d/dijkstra/Selections-DC06/Bs2PhiGamma.dst' TYP='POOL_ROOTTREE' OPT='READ'" ]
