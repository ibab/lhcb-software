...
DecayTreeTuple("Hlt2DecayTreeTuple").PhysDesktop.InputLocations = ["Hlt2Bd2JpsiMuMuKsLLUnbiasedCombineParticlesCombine", "Hlt2Bd2JpsiMuMuKsDDUnbiasedCombineParticlesCombine"]
