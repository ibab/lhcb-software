...
DecayTreeTuple("Hlt2DecayTreeTuple").PhysDesktop.InputLocations = ["Hlt2SelBs2PhiPhi"]
...
DaVinci().Input = [
  "DATAFILE='PFN:castor:/castor/cern.ch/user/d/dijkstra/Selections-DC06/Bs2PhiPhi.dst' TYP='POOL_ROOTTREE' OPT='READ'" ]
