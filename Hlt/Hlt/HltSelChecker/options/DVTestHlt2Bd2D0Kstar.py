...
HltCorrelations("Hlt2SelectionsCorrs").Algorithms += [ "PreselBd2D0Kst_D02HH" ]
PrintHeader("PrintPreselBd2D0Kst_D02HH").OutputLevel = 3 
#
# Hlt test
#
...
DecayTreeTuple("Hlt2DecayTreeTuple").PhysDesktop.InputLocations = ["Phys/Hlt2SelBd2D0Kstar"]
