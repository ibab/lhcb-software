...
HltCorrelations("Hlt2SelectionsCorrs").Algorithms += [ "DoDC06SelBd2JpsiKS_Jpsi2MuMu_lifetime_unbiased" ]
#
# Hlt test
#
...
DecayTreeTuple("Hlt2DecayTreeTuple").PhysDesktop.InputLocations = ["Phys/Hlt2SelBd2JpsiMuMuKsLLUnbiased"]
