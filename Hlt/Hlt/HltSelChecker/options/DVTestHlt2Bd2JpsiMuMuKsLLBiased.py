...
CheckSelResult("CheckOffline").Algorithms += [ "DC06SelBd2Jpsi2MuMuKs" ]
#
# Hlt test
#
...
NTupleSvc().Output =  [ "FILE1 DATAFILE='HLT-Bd2JpsiMuMuKsLLBiased.root' TYP='ROOT' OPT='NEW'" ] 
HistogramPersistencySvc().OutputFile = "DVHlt2-Bd2JpsiMuMuKsLLBiased.root"
...
DecayTreeTuple("Hlt2DecayTreeTuple").PhysDesktop.InputLocations = ["Phys/Hlt2SelBd2JpsiMuMuKsLLBiased"]
