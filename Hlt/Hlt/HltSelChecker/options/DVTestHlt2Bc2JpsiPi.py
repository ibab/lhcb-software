### @Id: $
 #
 #  Test file for HLT Bc->J/psiPi selection
 #
 #  @author P. Koppenburg
 #  @date 2009-07-21
###
...
FilterTrueTracks().MCDecayFinder.Decay =  "[B_c+ -> (J/psi(1S) -> ^mu+ ^mu- {,gamma} {,gamma}) ^pi+ {,gamma} {,gamma}]cc"
#
...
DaVinci().Input = [
  "DATAFILE='PFN:castor:/castor/cern.ch/user/j/jhe/Bc2JpsiPi/offline_Bc2JpsiPi.dst' TYP='POOL_ROOTTREE' OPT='READ'" ]
