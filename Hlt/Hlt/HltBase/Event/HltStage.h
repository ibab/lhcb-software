...
// ========================================================================
  ...
  public: // cache
    ...
    template <typename T> bool hasInfo_( const std::string &key ) const {
    ...
    template <typename T> void updateInfo( const std::string &key, const T &value );
  ...
  private:
    ...
    //
    template <typename T> bool _insertInfo( const std::string &key, const T &value );
    //
    template <typename T> void _updateInfo( const std::string &key, const T &value );
    //
    template <typename T>
...
// Stage
// ==========================================================================
template <> inline const Hlt::Stage *Hlt::Stage::get<Hlt::Stage>() const {
    return m_stage;
}
// ==========================================================================
template <> inline Hlt::Stage *Hlt::Stage::get<Hlt::Stage>() {
    _checkLock();
    return m_stage;
}
// ==========================================================================
template <> inline void Hlt::Stage::set<Hlt::Stage>( const Hlt::Stage *value ) {
    SetAllToNull();
    m_stage = value;
}
// ==========================================================================
template <> inline bool Hlt::Stage::is<Hlt::Stage>() const { return m_stage != 0; }
// ==========================================================================
// Track
// ==========================================================================
template <> inline const LHCb::Track *Hlt::Stage::get<LHCb::Track>() const {
    return m_track;
}
// ============================================================================
template <> inline LHCb::Track *Hlt::Stage::get<LHCb::Track>() {
    _checkLock();
    return m_track;
}
// ============================================================================
template <> inline void Hlt::Stage::set<LHCb::Track>( const LHCb::Track *value ) {
    SetAllToNull();
    m_track = value;
}
// ==========================================================================
template <> inline bool Hlt::Stage::is<LHCb::Track>() const { return m_track != 0; }
// ==========================================================================
// RecVertex
// ==========================================================================
template <> inline const LHCb::RecVertex *Hlt::Stage::get<LHCb::RecVertex>() const {
    return m_rec_vertex;
}
// ==========================================================================
template <> inline LHCb::RecVertex *Hlt::Stage::get<LHCb::RecVertex>() {
    _checkLock();
    return m_rec_vertex;
}
// ==========================================================================
...
// ==========================================================================
template <> inline LHCb::VertexBase *Hlt::Stage::get<LHCb::VertexBase>() {
    return this->get<LHCb::RecVertex>();
}
// ==========================================================================
template <> inline bool Hlt::Stage::is<LHCb::VertexBase>() const {
...
// ==========================================================================
template <> inline LHCb::L0CaloCandidate *Hlt::Stage::get<LHCb::L0CaloCandidate>() {
    _checkLock();
    return m_l0_calo_candidate;
}
// ==========================================================================
...
// ==========================================================================
template <> inline LHCb::L0MuonCandidate *Hlt::Stage::get<LHCb::L0MuonCandidate>() {
    _checkLock();
    return m_l0_muon_candidate;
}
// ==========================================================================
...
// MultiTrack
// ==========================================================================
template <> inline const Hlt::MultiTrack *Hlt::Stage::get<Hlt::MultiTrack>() const {
    return m_multitrack;
}
// ==========================================================================
template <> inline Hlt::MultiTrack *Hlt::Stage::get<Hlt::MultiTrack>() {
    _checkLock();
    return m_multitrack;
}
// ==========================================================================
...
// ==========================================================================
template <> inline bool Hlt::Stage::is<Hlt::L0DiMuonCandidate>() const {
...
// ==========================================================================
template <>
inline bool Stage::insertInfo<double>( const std::string &key,
                                       const double &value ) {
    return _insertInfo( key, value );
}
// ==========================================================================
...
// ==========================================================================
template <>
inline void Stage::updateInfo<double>( const std::string &key,
                                       const double &value ) {
    _updateInfo( key, value );
}
// ==========================================================================
...
// ==========================================================================
template <>
inline int Stage::info<int>( const std::string &key,
