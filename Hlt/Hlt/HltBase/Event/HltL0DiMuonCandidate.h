   ...
   virtual std::ostream& fillStream(std::ostream& s) const;
    ...
    static void* operator new ( size_t size )
    {
      return ( sizeof(L0DiMuonCandidate) == size ? 
               boost::singleton_pool<L0DiMuonCandidate, sizeof(L0DiMuonCandidate)>::malloc() :
               ::operator new(size) );
    }
    ...
    {
      boost::singleton_pool<L0DiMuonCandidate, sizeof(L0DiMuonCandidate)>::is_from(p) ?
      boost::singleton_pool<L0DiMuonCandidate, sizeof(L0DiMuonCandidate)>::free(p) :
      ::operator delete(p);
    }
...
inline LHCb::L0MuonCandidate* Hlt::L0DiMuonCandidate::first()
{
  return m_first;
}

inline void Hlt::L0DiMuonCandidate::setFirst(const SmartRef<LHCb::L0MuonCandidate>& value)
{
  m_first = value;
}
...
inline LHCb::L0MuonCandidate* Hlt::L0DiMuonCandidate::second()
{
  return m_second;
}

inline void Hlt::L0DiMuonCandidate::setSecond(const SmartRef<LHCb::L0MuonCandidate>& value)
{
  m_second = value;
}
