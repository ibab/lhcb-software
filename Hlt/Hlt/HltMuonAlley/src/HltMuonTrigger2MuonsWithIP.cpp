...
//  bool ok  = HltAlgorithm::beginExecute();
  ...
  ELoop::map_compare_value(m_otrack,*m_primaryVertices,  
                           *_ipFun, Estd::abs_min(),
                           m_IPKey);
  ELoop::map_compare_value(m_otrack2,*m_primaryVertices,  
                           *_ipFun, Estd::abs_min(),
                           m_IPKey);
  m_overtices.clear();
...
void HltMuonTrigger2MuonsWithIP::makeDiMuonPair(const Hlt::TrackContainer& tcon1,
