                                         ...
                                         const LHCb::Track& seed )
{
    ...
    double zForX = m_zMagnet + m_zMagnetTx2 * vState.tx() * vState.tx() +
...
StatusCode PatMatchL0MuonTool::match( const LHCb::Track& velo,
                                      const LHCb::Track& seed,
                                      LHCb::Track& matchedTrack, double& quality,
                                      double& quality2 )
{
...
//=============================================================================
void PatMatchL0MuonTool::makeTrack( const LHCb::Track& velo, const LHCb::Track& seed,
                                    LHCb::Track& output, double chi2 )
{
    ...
    // FIXME true or false??
    StatusCode sc =
        m_fastMomentumTool->calculate( &vState, &sState, qOverP, sigmaQOverP, true );
