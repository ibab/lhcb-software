...
# =============================================================================
# $Id: HltHadronLines.py,v 1.1 2009-01-09 10:39:27 graven Exp $
# =============================================================================
## @file
...
Line ( 'SingleHadron' 
    ...
    , Member ( 'TF', '1Velo', FilterDescriptor = [ 'IP_PV2D,||>,'+str(HADMAIN_IPCUT)])
    ...
    , Member ( 'TF' , 'GuidedForward' , FilterDescriptor = ['PT,>,'+str(SINGLEHADRON_PTCUT)])
    , Member ( 'TU' , 'FitTrack' ,      RecoName = "FitTrack")
    , Member ( 'TF' , '1FitTrack' ,     FilterDescriptor = ["FitIP_PV2D,||>,"+str(HADMAIN_IPCUT)])
    , Member ( 'TF' , '2FitTrack'
...
Line ('DiHadron'
    ...
    , Member ( 'TF', 'GuidedForward' , FilterDescriptor = ['PT,>,'+str(HADMAIN_PTCUT)])
    ...
    , Member ( 'VF', 'Velo2',      FilterDescriptor = [ 'VertexDz_PV2D,>,'+str(HADVERTEX_DZCUT)])
    , Member ( 'VU', 'Forward',    RecoName = 'Forward')
    , Member ( 'VF', '1Forward',   FilterDescriptor = [ 'VertexMinPT,>,'+str(HADVERTEX_MINPTCUT)])
    , Member ( 'VF', '2Forward',   FilterDescriptor = [ 'VertexPointing_PV2D,<,'+str(HADVERTEX_POINTINGCUT)])
    , Member ( 'VU', 'FitTrack',   RecoName = 'FitTrack')
    , Member ( 'VF', '1FitTrack',  FilterDescriptor = [ 'FitVertexMinIP_PV2D,||>,'+str(HADVERTEX_MINIPCUT)])
    , Member ( 'VF', '2FitTrack'
             , OutputSelection = "%Decision"
...
if (SOFTDIHADRON):
    getLine("DiHadron").clone("SoftDiHadron"
                              , L0DU = L0ALL
                              , TFL0Hadrons     = { "FilterDescriptor": ["L0ET,>,"+str(HADL0_SOFTETCUT)] }
                              , TFGuidedForward = { "FilterDescriptor": ["PT,>,"+str(HADMAIN_SOFTPTCUT)] }
                              )
