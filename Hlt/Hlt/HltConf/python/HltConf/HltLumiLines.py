...
class HltLumiLinesConf(LHCbConfigurableUser) :
    ...
    def __apply_configuration__(self) : 
        ...
        # list to collect the counters created using _createCounter and _createL0Counter
        createdCounters = []
        ...
        #        _combine( _createCounter( LumiCountTracks,   seqName , lumiCountSequence),
        #               {   'Velo'   : 'Hlt/Track/Velo'
        ...
        #
        #createdCounters.extend(
        #        _combine( _createCounter( LumiCountVertices, seqName, lumiCountSequence ),
        ...
        #createdCounters.extend(
        #    _combine( _createCounter( LumiCountHltTracks,   seqName , lumiCountSequence),
        #             { 'RZVeloBW' : 'RZVeloBW'
        #             } )
        #    )

        createdCounters.extend(
            _combine( _createL0Counter( seqName, lumiCountSequence ),
                     { 'SPDMult'  : 'Spd(Mult)'
                     , 'PUMult'   : 'PUHits(Mult)'
                     , 'CaloEt'   : 'Sum(Et)' 
                     } )
