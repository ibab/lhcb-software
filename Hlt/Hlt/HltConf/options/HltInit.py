...
HltANNSvc().Hlt1SelectionID = {
    ...
    "Hlt1L0DiMuonDecision"                  :   11,
    "Hlt1L0Muon,lowMultDecision"            :   12,
    "Hlt1L0DiMuon,lowMultDecision"          :   13,
    "Hlt1L0ElectronDecision"                :   14,
    "Hlt1L0PhotonDecision"                  :   15,
    "Hlt1L0HadronDecision"                  :   16,
    "Hlt1L0GlobalPi0Decision"               :   17,
    "Hlt1L0LocalPi0Decision"                :   18,
    # Misc...
...
HltANNSvc().InfoID = {
    ...
    "DeltaP"                                :  501,
    "DoShareM3"                             :  601,
    "DoShareM3_Hlt1SingleMuonNoPVPrepTMVeloT":  602,
