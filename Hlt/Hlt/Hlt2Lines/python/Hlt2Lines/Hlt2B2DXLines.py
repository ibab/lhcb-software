...
#                                , extracode = '(M>1600*MeV) & (M<2100*MeV) & (BPVVDCHI2> %(ComTFVtxPVDDispChi2LL)s ) & (SUMQ == 0)' % self.getProps() )
        ...
        line = Hlt2Line('B2D2hhBachelorReq3BodySignal', prescale = self.prescale , algos = [ Robust3BodySeq, B2D2hhBachelorSeqSignalFilter], postscale = self.postscale)
        HltANNSvc().Hlt2SelectionID.update( { "Hlt2B2D2hhBachelorReq3BodySignalDecision" : 52100 } )
        line = Hlt2Line('B2D2hhBachelorReq4BodySignal', prescale = self.prescale , algos = [ Robust4BodySeq, B2D2hhBachelorSeqSignalFilter], postscale = self.postscale)
        HltANNSvc().Hlt2SelectionID.update( { "Hlt2B2D2hhBachelorReq4BodySignalDecision" : 52110 } )
        line = Hlt2Line('B2D2hhhBachelorReq3BodySignal', prescale = self.prescale , algos = [ Robust3BodySeq, B2D2hhhBachelorSeqSignalFilter], postscale = self.postscale)
        HltANNSvc().Hlt2SelectionID.update( { "Hlt2B2D2hhhBachelorReq3BodySignalDecision" : 52120 } )
        line = Hlt2Line('B2D2hhhBachelorReq4BodySignal', prescale = self.prescale , algos = [ Robust4BodySeq, B2D2hhhBachelorSeqSignalFilter], postscale = self.postscale)
        HltANNSvc().Hlt2SelectionID.update( { "Hlt2B2D2hhhBachelorReq4BodySignalDecision" : 52130 } )
        line = Hlt2Line('B2D2hhKstarReq3BodySignal', prescale = self.prescale , algos = [ Robust3BodySeq, B2D2hhKstarPhiSeqSignalFilter], postscale = self.postscale)
        HltANNSvc().Hlt2SelectionID.update( { "Hlt2B2D2hhKstarReq3BodySignalDecision" : 52140 } )
        line = Hlt2Line('B2D2hhKstarReq4BodySignal', prescale = self.prescale , algos = [ Robust4BodySeq, B2D2hhKstarPhiSeqSignalFilter], postscale = self.postscale)
        HltANNSvc().Hlt2SelectionID.update( { "Hlt2B2D2hhKstarReq4BodySignalDecision" : 52150 } )

        # and for the broader mass windows
        line = Hlt2Line('B2D2hhBachelorReq3BodyMW', prescale = 0.01 , algos = [ Robust3BodySeq, B2D2hhBachelorSeqMWFilter], postscale = self.postscale)
        HltANNSvc().Hlt2SelectionID.update( { "Hlt2B2D2hhBachelorReq3BodyMWDecision" : 52160 } )
        line = Hlt2Line('B2D2hhBachelorReq4BodyMW', prescale = 0.01 , algos = [ Robust4BodySeq, B2D2hhBachelorSeqMWFilter], postscale = self.postscale)
        HltANNSvc().Hlt2SelectionID.update( { "Hlt2B2D2hhBachelorReq4BodyMWDecision" : 52170 } )
        line = Hlt2Line('B2D2hhhBachelorReq3BodyMW', prescale = 0.01 , algos = [ Robust3BodySeq, B2D2hhhBachelorSeqMWFilter], postscale = self.postscale)
        HltANNSvc().Hlt2SelectionID.update( { "Hlt2B2D2hhhBachelorReq3BodyMWDecision" : 52180 } )
        line = Hlt2Line('B2D2hhhBachelorReq4BodyMW', prescale = 0.01 , algos = [ Robust4BodySeq, B2D2hhhBachelorSeqMWFilter], postscale = self.postscale)
        HltANNSvc().Hlt2SelectionID.update( { "Hlt2B2D2hhhBachelorReq4BodyMWDecision" : 52190 } )
        line = Hlt2Line('B2D2hhKstarReq3BodyMW', prescale = 0.01 , algos = [ Robust3BodySeq, B2D2hhKstarPhiSeqMWFilter], postscale = self.postscale)
        HltANNSvc().Hlt2SelectionID.update( { "Hlt2B2D2hhKstarReq3BodyMWDecision" : 52200 } )
        line = Hlt2Line('B2D2hhKstarReq4BodyMW', prescale = 0.01 , algos = [ Robust4BodySeq, B2D2hhKstarPhiSeqMWFilter], postscale = self.postscale)
        HltANNSvc().Hlt2SelectionID.update( { "Hlt2B2D2hhKstarReq4BodyMWDecision" : 52210 } )


        #Robust Lines
        line = Hlt2Line('B2D2XRobust3Body', prescale = 0.001 , algos = [ Robust3BodySeq], postscale = self.postscale)
        HltANNSvc().Hlt2SelectionID.update( { "Hlt2B2D2XRobust3BodyDecision" : 52220 } )
        line = Hlt2Line('B2D2XRobust4Body', prescale = 0.001 , algos = [ Robust4BodySeq], postscale = self.postscale)
