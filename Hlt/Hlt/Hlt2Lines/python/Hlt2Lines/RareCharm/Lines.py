...
class RareCharmLines(Hlt2LinesConfigurableUser):
    ...
    def stages(self, nickname=""):
        ...
        self._stages = { 'D02MuMu'   : [ D02mumuComb ],
                   ...
                   'D02KMu'  :  [ D02kmuComb ],
                   'D02EMu'  :  [ D02emuComb ],
                   'TwoMuonForD2MuMuX': [TwoMuonForD2MuMuX],
                   'KaonsHHMuMu' : [InPartFilterHHMuMu_Kaons],
                   'PionsHHMuMu' : [InPartFilterHHMuMu_Pions],
                   'KaonsHMuMu' : [InPartFilterHMuMu_Kaons],
                   'PionsHMuMu' : [InPartFilterHMuMu_Pions],
                   'ProtonsHMuMu' : [InPartFilterHMuMu_Protons],
                   'D2PiMuMuComb' : [ D2PiMuMuComb ],
                   'D2KMuMuComb' : [ D2KMuMuComb ],
                   'D2PiMuMuSSComb' : [ D2PiMuMuSSComb ],
                   'D2KMuMuSSComb' : [ D2KMuMuSSComb ],
                   'Lc2PMuMuComb' : [ Lc2PMuMuComb ],
                   'Lc2PMuMuSSComb' : [ Lc2PMuMuSSComb ],
                   'D02PiPiMuMuComb' : [ D02PiPiMuMuComb ],
                   'D02KKMuMuComb' : [ D02KKMuMuComb ],
                   'D02KPiMuMuComb' : [ D02KPiMuMuComb ],
