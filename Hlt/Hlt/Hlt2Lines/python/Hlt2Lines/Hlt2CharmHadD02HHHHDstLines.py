...
class Hlt2CharmHadD02HHHHDstLinesConf(HltLinesConfigurableUser) :
    ...
    def __apply_configuration__(self) :
        ...
        line = Hlt2Line(NoTag, prescale = self.prescale
                        , algos = [ PV3D('Hlt2'), Hlt2CharmKillTooManyInTrk,  Hlt2Charm2BodyFor4Body, kaonsF, pionsF, Charm4BodyMassWin4pi]
                        , postscale = self.postscale
                        )
        ...
        line = Hlt2Line(NoTagWM, prescale = self.prescale
                        , algos = [ PV3D('Hlt2'),Hlt2CharmKillTooManyInTrk,  Hlt2Charm2BodyFor4Body, kaonsF, pionsF, Charm4BodyWideMassWin4pi]
                        , postscale = self.postscale
                        )
        ...
        line = Hlt2Line(NoTag, prescale = self.prescale
                        , algos = [ PV3D('Hlt2'), Hlt2CharmKillTooManyInTrk,  Hlt2Charm2BodyFor4Body, kaonsF, pionsF, Charm4BodyMassWinKm3pi]
                        , postscale = self.postscale
                        )
        decName = 'Hlt2' + NoTag + 'Decision'
        annSvcID = self._scale(decName,'HltANNSvcID')
        ...
        line = Hlt2Line(NoTagWM, prescale = self.prescale
                        , algos = [ PV3D('Hlt2'),Hlt2CharmKillTooManyInTrk,  Hlt2Charm2BodyFor4Body, kaonsF, pionsF, Charm4BodyWideMassWinKm3pi]
                        , postscale = self.postscale
                        )
        decName = 'Hlt2' + NoTagWM  + 'Decision'
        annSvcID = self._scale(decName,'HltANNSvcID')
        ...
        line = Hlt2Line(NoTag, prescale = self.prescale
                        , algos = [ PV3D('Hlt2'), Hlt2CharmKillTooManyInTrk,  Hlt2Charm2BodyFor4Body, kaonsF, pionsF, Charm4BodyMassWinKKpipi]
                        , postscale = self.postscale
                        )
        decName = 'Hlt2' + NoTag + 'Decision'
        annSvcID = self._scale(decName,'HltANNSvcID')
        ...
        line = Hlt2Line(NoTagWM, prescale = self.prescale
                        , algos = [ PV3D('Hlt2'),Hlt2CharmKillTooManyInTrk,  Hlt2Charm2BodyFor4Body, kaonsF, pionsF, Charm4BodyWideMassWinKKpipi]
                        , postscale = self.postscale
                        )
        decName = 'Hlt2' + NoTagWM  + 'Decision'
        annSvcID = self._scale(decName,'HltANNSvcID')
        ...
        line = Hlt2Line(NoTag, prescale = self.prescale
                        , algos = [ PV3D('Hlt2'), Hlt2CharmKillTooManyInTrk,  Hlt2Charm2BodyFor4Body, kaonsF, pionsF, Charm4BodyMassWin2Kp2Pm]
                        , postscale = self.postscale
                        )
        decName = 'Hlt2' + NoTag + 'Decision'
        annSvcID = self._scale(decName,'HltANNSvcID')
        ...
        line = Hlt2Line(NoTagWM, prescale = self.prescale
                        , algos = [ PV3D('Hlt2'),Hlt2CharmKillTooManyInTrk,  Hlt2Charm2BodyFor4Body, kaonsF, pionsF, Charm4BodyWideMassWin2Kp2Pm]
                        , postscale = self.postscale
                        )
        decName = 'Hlt2' + NoTagWM  + 'Decision'
        annSvcID = self._scale(decName,'HltANNSvcID')
        ...
        line = Hlt2Line(NoTag, prescale = self.prescale
                        , algos = [ PV3D('Hlt2'), Hlt2CharmKillTooManyInTrk,  Hlt2Charm2BodyFor4Body, kaonsF, pionsF, Charm4BodyMassWin3KPm]
                        , postscale = self.postscale
                        )
        decName = 'Hlt2' + NoTag + 'Decision'
        annSvcID = self._scale(decName,'HltANNSvcID')
        ...
        line = Hlt2Line(NoTagWM, prescale = self.prescale
                        , algos = [ PV3D('Hlt2'),Hlt2CharmKillTooManyInTrk,  Hlt2Charm2BodyFor4Body, kaonsF, pionsF, Charm4BodyWideMassWin3KPm]
                        , postscale = self.postscale
                        )
        decName = 'Hlt2' + NoTagWM  + 'Decision'
        annSvcID = self._scale(decName,'HltANNSvcID')
        ...
        line = Hlt2Line(NoTag, prescale = self.prescale
                        , algos = [ PV3D('Hlt2'), Hlt2CharmKillTooManyInTrk,  Hlt2Charm2BodyFor4Body, kaonsF, pionsF, Charm4BodyMassWinCh2]
                        , postscale = self.postscale
                        )
        decName = 'Hlt2' + NoTag + 'Decision'
        annSvcID = self._scale(decName,'HltANNSvcID')
        ...
        line = Hlt2Line(NoTagWM, prescale = self.prescale
                        , algos = [ PV3D('Hlt2'),Hlt2CharmKillTooManyInTrk,  Hlt2Charm2BodyFor4Body, kaonsF, pionsF, Charm4BodyWideMassWinCh2]
                        , postscale = self.postscale
                        )
        decName = 'Hlt2' + NoTagWM  + 'Decision'
        annSvcID = self._scale(decName,'HltANNSvcID')
