# =============================================================================
# $Id: Hlt2CommissioningLines.py,v 1.18 2010-02-26 04:56:17 gligorov Exp $
# =============================================================================
## @file
...
class Hlt2CommissioningLinesConf(HltLinesConfigurableUser):
   ...
   def __apply_configuration__(self):
        ...
        Line('Transparent' ,  HLT = "HLT_PASS_RE('^Hlt1(ODIN.*|L0.*|Lumi.*|NoBias.*|MiniBias.*|Velo.*|Align.*|Incident|Tell1Error)Decision$')"
            , prescale = self.prescale
            , postscale = self.postscale
            )
        ...
        tracks = Hlt2Tracking().hlt2PrepareTracks()
