...
theseslots = {   'Prescale' : { 'Hlt2CharmHadDpToKmPipPip_LTUNBTurbo'         : 0.05,
                 ...
                 'PersistReco' : {'Hlt2CharmHadD02KmPipTurbo'				        : True,
                                  ...
                                  'Hlt2CharmHadXicpToPpKmPipTurbo'			        : True,
                                  'Hlt2CharmHadDstp2D0Pip_D02KS0KmKp_KS0DDTurbo'		: True,
                                  'Hlt2CharmHadDstp2D0Pip_D02KS0KmKp_KS0DD_LTUNBTurbo'	        : True,
                                  'Hlt2CharmHadDstp2D0Pip_D02KS0KmKp_KS0LLTurbo'		: True,
                                  'Hlt2CharmHadDstp2D0Pip_D02KS0KmKp_KS0LL_LTUNBTurbo'	        : True,
                                  'Hlt2CharmHadDstp2D0Pip_D02KS0KmPip_KS0DDTurbo'		: True,
                                  'Hlt2CharmHadDstp2D0Pip_D02KS0KmPip_KS0DD_LTUNBTurbo'	        : True,
                                  'Hlt2CharmHadDstp2D0Pip_D02KS0KmPip_KS0LLTurbo'		: True,
                                  'Hlt2CharmHadDstp2D0Pip_D02KS0KmPip_KS0LL_LTUNBTurbo'	        : True,
                                  'Hlt2CharmHadDstp2D0Pip_D02KS0KpPim_KS0DDTurbo'		: True,
                                  'Hlt2CharmHadDstp2D0Pip_D02KS0KpPim_KS0DD_LTUNBTurbo'	        : True,
                                  'Hlt2CharmHadDstp2D0Pip_D02KS0KpPim_KS0LLTurbo'		: True,
                                  'Hlt2CharmHadDstp2D0Pip_D02KS0KpPim_KS0LL_LTUNBTurbo'	        : True,
                                  'Hlt2CharmHadDstp2D0Pip_D02KS0PimPip_KS0DDTurbo'		: True,
                                  'Hlt2CharmHadDstp2D0Pip_D02KS0PimPip_KS0DD_LTUNBTurbo'	: True,
                                  'Hlt2CharmHadDstp2D0Pip_D02KS0PimPip_KS0LLTurbo'		: True,
                                  'Hlt2CharmHadDstp2D0Pip_D02KS0PimPip_KS0LL_LTUNBTurbo'	: True,
                                  'Hlt2CharmHadXim2LamPim_DDDTurbo'				: True,
                                  'Hlt2CharmHadXim2LamPim_DDLTurbo'				: True,
                                  'Hlt2CharmHadXim2LamPim_LLLTurbo'				: True,
                                  'Hlt2CharmHadOmm2LamKm_DDDTurbo'				: True,
                                  'Hlt2CharmHadOmm2LamKm_DDLTurbo'				: True,
                                  'Hlt2CharmHadOmm2LamKm_LLLTurbo'				: True },
		 'Postscale' : {},
    ...
    def __apply_configuration__(self):
        ...
        for nickname, algos, relatedInfo in self.algorithms( _stages ):
            ...
            Hlt2Line('CharmHad' + nickname,
                     ...
                     Turbo = doturbo,
                     PersistReco = self.getProps()['PersistReco'].get('Hlt2CharmHad' + nickname, False),
