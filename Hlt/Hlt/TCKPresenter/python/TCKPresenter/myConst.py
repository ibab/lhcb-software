...
NODE_PLAIN                  = ['n', '#ffffff', '0'   , '#ffffff', '12'        , '10'             , ''      , '7'    ]
NODE_RARE                   = ['n', '#ffffff', '1'   , '#e0ffff', '12'        , '10'             , ''      , '7'    ]
NODE_SCALERLIKE             = ['n', '#ffffff', '0'   , '#ffffff', '12'        , '10'             , ''      , '7'    ]
NODE_CUT                    = ['n', '#ffffff', '1'   , '#eee8aa', '12'        , '10'             , ''      , '7'    ]
NODE_TECHNICAL              = ['y', '#000000', '1'   , '#e6e6fa', '12'        , '10'             , 'out'   , '7'    ]
NODE_PHYSICS                = ['y', '#000000', '1'   , '#f0fff0', '12'        , '10'             , 'out'   , '7'    ]
NODE_SPECIAL                = ['y', '#000000', '1'   , '#ffefd5', '12'        , '10'             , 'out'   , '7'    ]
NODE_CUT_WITHOUTRATE        = ['f', '#ffffff', '1'   , '#eee8aa', '12'        , '10'             , ''      , '7'    ]
NODE_TECHNICAL_WITHOUTRATE  = ['y', '#000000', '1'   , '#e6e6fa', '12'        , '10'             , ''      , '7'    ]
NODE_PHYSICS_WITHOUTRATE    = ['y', '#000000', '1'   , '#f0fff0', '12'        , '10'             , ''      , '7'    ]
NODE_SPECIAL_WITHOUTRATE    = ['y', '#000000', '1'   , '#ffefd5', '12'        , '10'             , ''      , '7'    ]
LABEL_PLAIN1                = ['y', '#000000', '1'   , '#f0fff0', '12'        , '10'             , ''      , '7'    ]
LABEL_PLAIN2                = ['y', '#000000', '1'   , '#e0eee0', '12'        , '10'             , ''      , '7'    ]
