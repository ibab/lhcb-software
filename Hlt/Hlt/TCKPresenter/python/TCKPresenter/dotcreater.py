...
def makefile(graphobject, Path):
    graphobject.write_svg(Path, prog='dot')
    fileread = open(Path, 'r')
    content = fileread.read()
    lowind = content.find('<!-- Generated by Graphviz')
    content = content[lowind:len(content)]
    content = '<html xmlns="http://www.w3.org/1999/xhtml"><head><title>SVG embedded inline in XHTML</title><meta http-equiv="refresh" content="60" /></head><body>' + content + '</body></html>'
    fileread.close() 
...
def create(TCK, Path):
    ...
    makefile(graphobject, Path + TCK + '/basic/basic_Hlt.xhtml')
    ...
    makefile(graphobject, Path + TCK + '/offline/extended_Hlt.xhtml')    
    ...
    for level_1_instance in level_1_instances:      #level_1_instance is a system
        ...
        makefile(graphobject, Path + TCK + '/basic/basic_Hlt_'+level_1_instance+'.xhtml')
        ...
        makefile(graphobject, Path + TCK + '/offline/extended_Hlt_'+level_1_instance+'.xhtml' )
        ...
        for level_2_instance in level_2_instances:      #level_2_instance is a alley
            ...
            makefile(graphobject, Path + TCK + '/basic/basic_Hlt_'+level_1_instance+'_'+level_2_instance+'.xhtml')
            ...
            makefile(graphobject, Path + TCK + '/offline/extended_Hlt_'+level_1_instance+'_'+level_2_instance+'.xhtml') 
            ...
            for level_3_instance in level_3_instances:      #level_3_instance is a line
                ...
                ## attention:tuple of instances and graph
                ## they are in the tupel because to get the cuts takes some time and its better to do it just once
                ...
                makefile(graphobject, Path + TCK + '/basic/basic_Hlt_'+level_1_instance+'_'+level_2_instance+'_'+level_3_instance+'.xhtml') 
                ...
                makefile(graphobject, Path + TCK + '/offline/extended_Hlt_'+level_1_instance+'_'+level_2_instance+'_'+level_3_instance+'.xhtml')  
