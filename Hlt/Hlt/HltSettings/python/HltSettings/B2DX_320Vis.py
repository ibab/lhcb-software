class B2DX_320Vis :
    ...
    def ActiveHlt2Lines(self) :
        ...
        lines = [ 'Hlt2B2D2hhBachelorBroadMW'    
                  , 'Hlt2B2D2hhhBachelorBroadMW'
                  , 'Hlt2B2D2hhKstarBroadMW'
                  , 'Hlt2B2D2hhhBachelorWithKsBroadMW'
                  , 'Hlt2B2D2hhBachelorOSTFBroadMW' #OSTF    
                  , 'Hlt2B2D2hhhBachelorOSTFBroadMW'
                  , 'Hlt2B2D2hhKstarOSTFBroadMW'
                  , 'Hlt2B2D2hhhBachelorWithKsOSTFBroadMW'
                  , 'Hlt2B2D2hhBachelorSignal'    
                  , 'Hlt2B2D2hhhBachelorSignal'
                  , 'Hlt2B2D2hhKstarSignal'
                  , 'Hlt2B2D2hhhBachelorWithKsSignal'                
                  , 'Hlt2B2D2hhBachelorOSTFSignal' #OSTF
                  , 'Hlt2B2D2hhhBachelorOSTFSignal'
                  , 'Hlt2B2D2hhKstarOSTFSignal'
                  , 'Hlt2B2D2hhhBachelorWithKsOSTFSignal'
