...
class EW_25ns_Draft2016( object ) :
	"""
	...
	def Thresholds( self ) :
		...
		d.update( { EWLines : {
					'Prescale' : {'Hlt2EWDiMuonDY1'        :  0.02,
						      ...
						      'Hlt2EWSingleTauHighPt2Prong' : 0.001,  # The two tau lines are pre-scaled as 
						      'Hlt2EWSingleTauHighPt3Prong' : 0.001}, # the only change from August25ns!!!
					# DiMuon
