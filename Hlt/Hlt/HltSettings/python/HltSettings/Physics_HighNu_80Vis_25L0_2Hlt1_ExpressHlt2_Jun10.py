class Physics_HighNu_80Vis_25L0_2Hlt1_ExpressHlt2_Jun10 :
    """
    ...
    def HltType(self) :
        self.verifyType( Physics_HighNu_80Vis_25L0_2Hlt1_ExpressHlt2_Jun10 )
        return          'Physics_HighNu_80Vis_25L0_2Hlt1_ExpressHlt2_Jun10'
    ...
    def Thresholds(self) :
        ...
        thresholds =  { Hlt1HadronLinesConf : {  'SingleHadron_PTCut' : 2000
                                         , 'HadSingle_IPChi2Cut' : 80
                                         , 'HadMain_PTCut' : 3100
                                         , 'HadCompanion_DZCut' : 2.0
                                         , 'HadDi_VDChi2Cut' :120
                                         , 'HadCompanion_PTCut' :1100
                 ...
                 , Hlt1ElectronLinesConf : { 'Ele_EtCut'               : 2000.0
                                            , 'EleIP_PtCut'            : 1700
                                            , 'EleIP_IPCut'            : 0.13
                                            , 'EleIPCompanion_PtCut'   : 2500
                                            , 'EleCompanion_PtCut'     : 4750
                                            , 'DiEle_HighMassCut'      : -1 # only applied if >0
                                            }
                 , Hlt1MuonLinesConf : {  'DiMuon_SumPtCut' : 1000.0
                                          , 'Muon_DeltaPCut'               :   -1
