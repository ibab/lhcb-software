...
class Physics_LowLumi_Mar2011( object ):
    """
    ...
    def HltType(self) :
        self.verifyType( Physics_LowLumi_Mar2011 ) 
        return          'Physics_LowLumi_Mar2011'
    ...
    def Thresholds(self) :
        ...
        from Muons_LowLumi_draft2011 import Muons_LowLumi_draft2011
        __update_conf__(thresholds,  Muons_LowLumi_draft2011().Thresholds() )


        from Electrons_draft2011 import Electrons_draft2011
        __update_conf__(thresholds,  Electrons_draft2011().Thresholds() )

        from Hadrons_LowLumi_draft2011 import Hadrons_LowLumi_draft2011
        __update_conf__(thresholds,  Hadrons_LowLumi_draft2011().Thresholds() )
    ...
    def ActiveHlt2Lines(self) :
        ...
        from Muons_LowLumi_draft2011 import Muons_LowLumi_draft2011
        hlt2.extend( Muons_LowLumi_draft2011().ActiveHlt2Lines() )

        from Electrons_draft2011 import Electrons_draft2011
        hlt2.extend( Electrons_draft2011().ActiveHlt2Lines() )

        from Hadrons_LowLumi_draft2011 import Hadrons_LowLumi_draft2011
        hlt2.extend( Hadrons_LowLumi_draft2011().ActiveHlt2Lines() )
