...
class Physics_September2012_VeloTT( object ):
    """
    ...
    def ActiveHlt1Lines(self) :
        ...
        #lines =  [ 'Hlt1TrackAllL0VeloTT', ]
        lines =  [ 'Hlt1TrackAllL0VeloTTForw', ]
        # ines = [ 'Hlt1TrackAllL0', 'Hlt1TrackAllL0VeloTT','Hlt1TrackAllL0VeloTTForw', ]
        #lines = [ 'Hlt1TrackAllL0', 'Hlt1TrackAllL0VeloTTForw', ]
