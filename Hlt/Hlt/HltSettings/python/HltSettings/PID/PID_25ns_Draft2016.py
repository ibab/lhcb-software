...
class PID_25ns_Draft2016:
    """
    Threshold settings for Hlt2 PID lines: 25ns for early 2016 running
        ...
        d = {
            PIDLines : {
              'Prescale' :  { 'Hlt2PID' + k + 'TurboCalib' : v for k, v in {
                                ...
                                'DetPhiMuMuPosTagged'   : 0.001,
                                'DetPhiMuMuNegTagged'   : 0.001,
                                ...
                                'DetJPsiPPPosTagged'    : 0.0,
                                'DetJPsiPPNegTagged'    : 0.0,
                                'B2KJPsiPPPosTagged'    : 0.0,
                                'B2KJPsiPPNegTagged'    : 0.0,
                                'Sc02LcPi'              : 0.0,
                                'Scpp2LcPi'             : 0.0,
                                'Lb2LcPi'               : 1.0,
                                'Lb2LcMuNu'             : 1.0,
                 ...
                 'PhiMuMu'  :  {'LLCombAMLow'   : (1020-110) * MeV, # Bumped up to 100(10) MeV after
                                ...
                                'LLCombMLow'    : (1020-100) * MeV, # 151118
