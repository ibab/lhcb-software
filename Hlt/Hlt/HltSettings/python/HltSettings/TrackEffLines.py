...
class TrackEffLines( object ):
    """
    Settings for tracking efficiency line debugging

    WARNING :: DO NOT EDIT WITHOUT PERMISSION OF THE AUTHORS
    
    Hlt1Setup taken from Physics_September2012.py by:
    @author J. Albrecht, V. Gligorov
    @date 2012-04-17

    TrackEff version by M. Kolpin (michael.kolpin@cern.ch)
    """
    ...
    def HltType(self) :
        self.verifyType( TrackEffLines ) 
        return          'TrackEffLines'
