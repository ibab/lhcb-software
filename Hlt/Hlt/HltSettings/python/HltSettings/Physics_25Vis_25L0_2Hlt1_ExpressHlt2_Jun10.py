...
class Physics_25Vis_25L0_2Hlt1_ExpressHlt2_Jun10              ( Physics_MinBiasL0_PassThroughHlt1_ExpressHlt2_Jun10 ):
    """
    ...
    def HltType(self) :
        self.verifyType( Physics_25Vis_25L0_2Hlt1_ExpressHlt2_Jun10 )
        return          'Physics_25Vis_25L0_2Hlt1_ExpressHlt2_Jun10'
    ...
    def Thresholds(self) :
        ...
        thresholds[Hlt1LumiLinesConf].update( { 'Prescale'  : { 'Hlt1LumiLow.*(?<!RateLimited)$'    : 0.001 
                                                              , 'Hlt1LumiMid.*(?<!RateLimited)$'    : 0.02
                                                              }
