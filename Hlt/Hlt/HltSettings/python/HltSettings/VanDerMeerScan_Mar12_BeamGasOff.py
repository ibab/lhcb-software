class VanDerMeerScan_Mar12_BeamGasOff:
    """
    Threshold settings for VDM scans with all beam-gas lines desactived.
    Intended to be used when the beams are scanned.
    ...
    def HltType(self) :
        self.verifyType( VanDerMeerScan_Mar12_BeamGasOff )
        return          'VanDerMeerScan_Mar12_BeamGasOff'
    ...
    def Thresholds(self) :
        ...
        from VanDerMeerScan_BeamGasConf_Mar12 import VanDerMeerScan_BeamGasConf_Mar12
        bgThres = VanDerMeerScan_BeamGasConf_Mar12().Thresholds('BeamGasOff')
