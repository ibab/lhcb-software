...
class Physics_HighNu_80Vis_30L0_5Hlt1_CorePileUpHlt2_Jun10 ( Physics_HighNu_80Vis_30L0_5Hlt1_CoreHlt2_Jun10) :
    ...
    def __init__(self) :
        ...
        pv3d = _vertexLocation(HltSharedVerticesPrefix,HltGlobalVertexLocation,Hlt3DPrimaryVerticesName)
        from HltTracking.HltReco import MinimalVelo 
        velo = MinimalVelo.outputSelection()
        self.Hlt2DefaultVoidFilter = "CONTAINS( '%s' ) < 4 & CONTAINS( '%s') < 350" %  (pv3d,velo) 
