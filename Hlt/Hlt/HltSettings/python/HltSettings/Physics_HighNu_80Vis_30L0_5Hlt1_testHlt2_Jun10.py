...
class Physics_HighNu_80Vis_30L0_5Hlt1_testHlt2_Jun10           ( Physics_HighNu_40Vis_15L0_2Hlt1_ExpressHlt2_Jun10 ):
    """
    Threshold settings for Hlt1 and HLT2for 2010 conditions
    
    THIS IS MENT AS (OFFLINE) TESTING SETTING.
    please commit your tests as you like.

    THIS IS NOT INTENDET TO RUN IN THE PIT. 
    ...
    def HltType(self) :
        self.verifyType( Physics_HighNu_80Vis_30L0_5Hlt1_testHlt2_Jun10 )
        return          'Physics_HighNu_80Vis_30L0_5Hlt1_testHlt2_Jun10'
