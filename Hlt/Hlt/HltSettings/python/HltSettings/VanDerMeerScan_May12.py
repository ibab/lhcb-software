...
class VanDerMeerScan_May12:
    ...
    TCK3: Hlt1BeamGasCrossingForcedRecoFullZ: prescale = 1/5.;  The other 5 BG Lines: prescale = 1.
    TCK4: Hlt1BeamGasCrossingForcedRecoFullZ: prescale = 1/10.; The other 5 BG Lines: prescale = 1.
    TCK5: Hlt1BeamGasCrossingForcedRecoFullZ: prescale = 1/20.; The other 5 BG Lines: prescale = 1.
    TCK6: Hlt1BeamGasCrossingForcedRecoFullZ: prescale = 1/50.; The other 5 BG Lines: prescale = 1.
    ...
    def HltType(self) :
        self.verifyType( VanDerMeerScan_May12 )
        return          'VanDerMeerScan_May12'
    ...
    def ActiveHlt1Lines(self) :
        ...
        from VanDerMeerScan_BeamGasConf_May12 import VanDerMeerScan_BeamGasConf_May12
        lines.extend(VanDerMeerScan_BeamGasConf_May12().ActiveHlt1Lines())
    ...
    def Thresholds(self) :
        ...
        from VanDerMeerScan_BeamGasConf_May12 import VanDerMeerScan_BeamGasConf_May12
        bgThres = VanDerMeerScan_BeamGasConf_May12().Thresholds()
