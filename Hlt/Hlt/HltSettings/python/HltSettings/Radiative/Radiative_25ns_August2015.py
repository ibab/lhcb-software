# =============================================================================
# @file   Radiative_25ns_August2015.py
...
class Radiative_25ns_August2015(object):
    """Threshold settings for Hlt2 Radiative lines for 2015."""
    ...
    def Thresholds(self):
        ...
        # Prescales
        ##########################################################################
        prescales = {'Prescale': {'Hlt2RadiativeB2GammaGamma'  : 0.1,
                                  'Hlt2RadiativeB2GammaGammaDD': 0.1}}
