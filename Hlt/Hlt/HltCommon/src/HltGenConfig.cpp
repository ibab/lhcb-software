// $Id: HltGenConfig.cpp,v 1.6 2008-05-28 18:53:36 graven Exp $
// Include files 
#include <algorithm>
...
StatusCode HltGenConfig::generateConfig( ) const {
  ...
  ConfigTreeNode topConfig( ConfigTreeNode::digest_type::createInvalid(),depRefs,"head of ConfigTree generated by HltGenConfig");
