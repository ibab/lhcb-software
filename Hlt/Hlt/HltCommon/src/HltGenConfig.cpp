// $Id: HltGenConfig.cpp,v 1.5 2008-05-22 14:15:29 graven Exp $
// Include files 
#include <algorithm>
...
StatusCode HltGenConfig::generateConfig( ) const {
  ...
  ConfigTreeNode topConfig( Gaudi::Math::MD5::createInvalidDigest(),depRefs,"head of ConfigTree generated by HltGenConfig");
