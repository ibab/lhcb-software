...
class LLParticlesFromRecVertices : public DaVinciAlgorithm
{
  ...
  private:
    ...
    bool RecVertex2Particle( const LHCb::RecVertex* rv,
                             LHCb::ProtoParticles* container );
    ...
    double m_LLPMaxFractEFromOne; ///< Maximal allowed fraction of the energy
                                  ///contributed by one daughter

    double m_LLPMaxFractTrWithUpstream; ///< Maximal allowed fraction of daughters
                                        ///with a hit upstream of the vertex
    ...
    LoKi::BasicFunctors<std::vector<const LHCb::RecVertex*>>::FunctionFromFunction
    m_UPPVZ;
