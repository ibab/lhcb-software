...
class Hlt1HadronForSwimmingLinesConf(HltLinesConfigurableUser) :
    #--------------------------------
    #
    ...
    def __apply_configuration__(self) : 
        ...
        def confirmation(type=""):
            ...
            conf =  l0.members()  + [ RZVelo
				    ...
				    , Member ( 'SelectTracksForSwimming','SelectRZVeloFS',InputSelection = 'RZVelo', OutputSelection = 'RZVeloSW')   
                                    ...
                                    , Member ( 'TF', '2Velo'
                                             , FilterDescriptor = [ 'IP_PV2DSW,||>,%s' % min( self.getProp(type+"HadDi_IPCut"),self.getProp("HadSingle_IPCut") )]
                                             , HistogramUpdatePeriod = 1
                                             , HistoDescriptor = histosfilter('IP_PV2DSW',-0.2,1.8,200)
                                             )
                                    , Member ( 'TM' , 'VeloCalo'
        ...
        def singlehadron():
            sh = [ Member ( 'TF' , 'SingleHadronPT' ,
                   ...
                   Member ( 'TF' , 'SingleHadronIP' ,
                            FilterDescriptor = [ 'IP_PV2DSW,||>,%(HadSingle_IPCut)s'% self.getProps()],
                            HistogramUpdatePeriod = 1,
                            HistoDescriptor = histosfilter('IP_PV2DSW',-0.2,1.8,200)
                          )
                   ]
        ...
        def companion(type=""):
            ...
            comp = [ RZVelo , PV2D.ignoreOutputSelection()
                ...
                , Member ( 'TF', 'Companion'
                           ...
                           , HistogramUpdatePeriod = 1
                           , HistoDescriptor  = histosfilter('IP_PV2DSW',-0.3,30.,200)
                           )
                ]
            return comp
        ...
        def dihadron(type=""):
            ...
            dih = [ PV2D.ignoreOutputSelection()
                ...
                , Member ( 'VF', 'UVelo'
                           , FilterDescriptor = [ 'VertexDz_PV2DSW,>,%s'%self.getProp('HadCompanion_DZCut')]
                           , HistogramUpdatePeriod = 1
                ...
                , Member ( 'VF', 'DiHadron',
                           FilterDescriptor = [ 'VertexPointing_PV2DSW,<,%s'%self.getProp("HadCompanion_PointingCut")],
                           HistogramUpdatePeriod = 1,
                           HistoDescriptor  = histosfilter('VertexPointing_PV2DSW',0.1,1.1,200)                       
                           )
                ]
            return dih
        ...
        def afterburn():
            after = [ PV2D.ignoreOutputSelection()
                ...
                , Member ( 'TF' , '1FitTrack' ,
                           ...
                           HistogramUpdatePeriod = 1,
                           HistoDescriptor  = histosfilter('FitIP_PV2DSW',-.3,3.,200)
                           )
                , Member ( 'TF' , '2FitTrack'
        ...
        def vafterburn(type=""):
            vafter =  [ PV2D.ignoreOutputSelection()
                ...
                , Member ( 'VF', '1FitTrack',
                           ...
                           HistogramUpdatePeriod = 1,
                           HistoDescriptor  = histosfilter('FitVertexMinIP_PV2DSW',-0.3,3.,200)                       
                           )
                , Member ( 'VF', '2FitTrack'
                           , OutputSelection = "%Decision"
