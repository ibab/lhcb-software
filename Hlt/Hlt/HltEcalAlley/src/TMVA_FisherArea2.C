...
NVar 5
showershape                   showershape                       'F'    [0.0323100052774,0.312639951706]
showerasym                    showerasym                        'F'    [0.00112766958773,0.695411264896]
showerkappa                   showerkappa                       'F'    [0.0218575261533,0.768901109695]
showertail                    showertail                        'F'    [0.431539028883,0.921696722507]
showerenergy                  showerenergy                      'F'    [0.0699442625046,0.99998998642]
...
class ReadFisherArea2 : public IClassifierReader {

 public:

   // constructor
   ReadFisherArea2( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadFisherArea2" ),
        fStatusIsClean( true ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
      ...
      fVmin[0] = 0.0323100052773952;
      fVmax[0] = 0.312639951705933;
      fVmin[1] = 0.00112766958773136;
      fVmax[1] = 0.695411264896393;
      fVmin[2] = 0.021857526153326;
      fVmax[2] = 0.768901109695435;
      fVmin[3] = 0.43153902888298;
      fVmax[3] = 0.921696722507477;
      fVmin[4] = 0.0699442625045776;
...
inline void ReadFisherArea2::Initialize() 
{
   fFisher0 = -0.48827484672;
   fFisherCoefficients.push_back( -2.01285055176 );
   fFisherCoefficients.push_back( -0.261318753986 );
   fFisherCoefficients.push_back( -1.22126937459 );
   fFisherCoefficients.push_back( 1.18378613737 );
   fFisherCoefficients.push_back( 0.550903728571 );
...
inline double ReadFisherArea2::GetMvaValue__( const std::vector<double>& inputValues ) const
{
...
// Clean up
inline void ReadFisherArea2::Clear() 
{
   // clear coefficients
   fFisherCoefficients.clear(); 
}
inline double ReadFisherArea2::GetMvaValue( const std::vector<double>& inputValues ) const
{
