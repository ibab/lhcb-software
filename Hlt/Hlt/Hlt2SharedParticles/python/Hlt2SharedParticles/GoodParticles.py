...
from HltLine.HltReco import PV3D, PV2D
...
GoodKaons = bindMembers( None, [ NoCutsKaons, PV2D, Hlt2GoodKaons ] )
GoodPions = bindMembers( None, [ NoCutsPions, PV2D, Hlt2GoodPions ] )
