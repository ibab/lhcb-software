// $Id: IL0ConfExtrapolator.h,v 1.1 2008-03-20 14:14:37 albrecht Exp $
...
public: 
  ...
  virtual void muon2T( const LHCb::Track& muonTrack, LHCb::State& stateAtT ) const = 0;
  
  virtual void ecal2T( const LHCb::Track& ecalTrack, 
                       LHCb::State& statePosAtT, LHCb::State& stateNegAtT ) const = 0;
  
  virtual void hcal2T( const LHCb::Track& ecalTrack, 
                       LHCb::State& statePosAtT, LHCb::State& stateNegAtT ) const = 0;
