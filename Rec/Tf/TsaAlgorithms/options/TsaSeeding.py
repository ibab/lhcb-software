...
if  TrackSys().earlyData():
    ...
    tsaSeed.xSearchS0.outlierCut = 6.0
    tsaSeed.xSearchS1.outlierCut = 6.0
    tsaSeed.xSearchS2.outlierCut = 6.0
    tsaSeed.xSearchS3.outlierCut = 6.0
    tsaSeed.xSearchS4.outlierCut = 6.0
    tsaSeed.stereoS0.outlierCut = 6.0
    tsaSeed.stereoS1.outlierCut = 6.0
    tsaSeed.stereoS2.outlierCut = 6.0
    tsaSeed.stereoS3.outlierCut = 6.0
    tsaSeed.stereoS4.outlierCut = 6.0
    tsaSeed.xSearchS0.deltaX = 0.7
    tsaSeed.xSearchS1.deltaX = 0.7
    tsaSeed.xSearchS2.deltaX = 0.7
    tsaSeed.xSearchS0.x0Cut = 2000.
    tsaSeed.xSearchS1.x0Cut = 2000.
    tsaSeed.xSearchS2.x0Cut = 2000.
    tsaSeed.xSearchS3.deltaX = 1.2
    tsaSeed.xSearchS4.deltaX = 1.2
    tsaSeed.xSearchS0.dthCut = 0.45
    tsaSeed.xSearchS1.dthCut = 0.45
    tsaSeed.xSearchS2.dthCut = 0.45
    tsaSeed.xSearchS3.dthCut = 0.75
    tsaSeed.xSearchS4.dthCut = 0.75
    tsaSeed.stereoS0.syCut = 0.02
    tsaSeed.stereoS1.syCut = 0.02
    tsaSeed.stereoS2.syCut = 0.02
    tsaSeed.stereoS0.yTol = 10.0
    tsaSeed.stereoS1.yTol = 10.0
    tsaSeed.stereoS2.yTol = 10.0
    tsaSeed.stereoS3.nHit = 14
    tsaSeed.stereoS4.nHit = 14
    tsaSeed.stereoS3.syCut = 0.1
    tsaSeed.stereoS4.syCut = 0.1
    tsaSeed.stereoS3.yTol2 = 11.0
    tsaSeed.stereoS4.yTol2 = 11.0
    ...
    tsaSeed.stubExtender.dxCut = 1.5
