// $Id: ExtendedVeloPhiHitManager.h,v 1.4 2008-02-27 14:32:35 krinnert Exp $
...
namespace Tf {
  ...
  template<typename HITEXTENSION>
    ...
    : VeloHitManager<DeVeloPhiType,HITEXTENSION,2>(type, name, parent)
    {
      ...
      GaudiTool::declareProperty("DefaultHitManagerName", m_defaultHitManagerName="DefaultVeloPhiHitManager");
    }
  ...
  template<typename HITEXTENSION>
    StatusCode ExtendedVeloPhiHitManager<HITEXTENSION>::initialize()
    {
      ...
      m_defaultHitManager = GaudiTool::tool<Tf::DefaultVeloPhiHitManager>( "Tf::DefaultVeloPhiHitManager", m_defaultHitManagerName );
