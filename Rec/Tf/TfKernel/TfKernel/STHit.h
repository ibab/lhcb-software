...
namespace Tf
{
  ...
  public: // Simple accessors to internal data members
    ...
    inline const LHCb::STLiteCluster& cluster() const noexcept { return m_cluster; }

    /** accessor to the channelID of this hit */
    inline LHCb::STChannelID channelID() const noexcept {return cluster().channelID();}
    ...
    inline const DeSTSector&    sector() const noexcept { return *m_sector; }
  ...
  inline const STHit* HitBase::sthit() const noexcept
  {
    return ( type()==RegionID::IT || type()==RegionID::TT|| type()==RegionID::UT
             ? static_cast<const STHit*>(this) : nullptr ) ;
  }
