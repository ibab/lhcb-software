...
//-----------------------------------------------------------------------------
// Implementation file for class : PatVeloUT
//
...
DECLARE_ALGORITHM_FACTORY( PatVeloUT )
  

//=============================================================================
// Standard constructor, initializes variables
//=============================================================================
PatVeloUT::PatVeloUT( const std::string& name,
  ...
  , m_veloUTTime(0)
{
  if ( "Hlt" == context() ) {
    ...
    m_outputTracksName = LHCb::TrackLocation::VeloUT;
  } 
...
// Initialization
//=============================================================================
StatusCode PatVeloUT::initialize() {
  StatusCode sc = GaudiAlgorithm::initialize(); // must be executed first
  if ( sc.isFailure() ) return sc;  // error printed already by GaudiAlgorithm

  if(msgLevel(MSG::DEBUG)) debug() << "==> Initialize" << endmsg;

  m_veloUTTool = tool<PatVeloUTTool>("PatVeloUTTool", "PatVeloUTTool");
...
//=============================================================================
bool PatVeloUT::acceptTrack(const LHCb::Track& track) 
{
...
//=========================================================================
void PatVeloUT::removeUsedTracks( std::vector<LHCb::Track*>& veloTracks){
...
//=========================================================================
bool PatVeloUT::matchingTracks( LHCb::Track* vttcand, LHCb::Track* trackused) 
{
