...
//-----------------------------------------------------------------------------
// Implementation file for class : PatUTMagnetTool
//
...
DECLARE_TOOL_FACTORY( PatUTMagnetTool )

// Standard Constructor
PatUTMagnetTool::PatUTMagnetTool( const std::string& type,
  ...
  , m_STDet(0)
{
  declareInterface<PatUTMagnetTool>(this);
}

//=========================================================================
//  setMidUT
//=========================================================================
StatusCode PatUTMagnetTool::initialize ( ) {
  ...
  m_updMgrSvc->registerCondition( this,m_fieldSvc,&PatUTMagnetTool::updateField) ;
...
//=========================================================================
StatusCode PatUTMagnetTool::updateField() 
{
  prepareBdlTables();
...
//=========================================================================
double PatUTMagnetTool::zMidField() {
  if( m_noField ) { 
...
// averageDist2mom
//=========================================================================
double PatUTMagnetTool::averageDist2mom() {
  if( m_noField ) { 
...
// prepareBdlTables
//=========================================================================
void PatUTMagnetTool::prepareBdlTables() {
...
// prepareDeflectionTables
//=========================================================================
void PatUTMagnetTool::prepareDeflectionTables() {
...
//  Destructor
//=========================================================================
PatUTMagnetTool::~PatUTMagnetTool() {}

//****************************************************************************
double PatUTMagnetTool::bdlIntegral(double ySlopeVelo, double zOrigin, double zVelo) {
...
//****************************************************************************
double PatUTMagnetTool::zBdlMiddle(double ySlopeVelo, double zOrigin, double zVelo) {
...
//****************************************************************************
double PatUTMagnetTool::dist2mom(double ySlope) {
...
//****************************************************************************
void PatUTMagnetTool::dxNormFactorsUT(double ySlope, std::vector<double>& nfact) {
...
//****************************************************************************
void PatUTMagnetTool::f_bdl( double slopeY, double zOrigin,
