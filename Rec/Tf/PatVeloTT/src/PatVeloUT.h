// $Id: PatVeloUT.h,v 1.5 2007-10-10 18:42:24 smenzeme Exp $
#ifndef PATVELOUT_H
#define PATVELOUT_H 1
...
#include "PatKernel/PatTTHit.h"
  ...
  /** @class PatVeloUT PatVeloUT.h
   *
   *  Pat VeloUT algorithm
   *  
  ...
  class PatVeloUT : public GaudiAlgorithm {
  public:
    /// Standard constructor
    PatVeloUT( const std::string& name, ISvcLocator* pSvcLocator );

    virtual ~PatVeloUT( ); ///< Destructor
