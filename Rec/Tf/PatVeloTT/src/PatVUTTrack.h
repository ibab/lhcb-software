#ifndef PATVUTTRACK_H
#define PATVUTTRACK_H 1
...
#include "PatKernel/PatTTHit.h"
  ...
  /** @class PatVUTTrack PatVUTTrack.h
  ...
  public:
    ...
    virtual ~PatVUTTrack( ) {}; ///< Destructor
