...
//=========================================================================
StatusCode PatVeloTTTool::tracksFromTrack(const LHCb::Track & velotrack, std::vector<LHCb::Track*>& outtracks )
{
...
//=========================================================================
void PatVeloTTTool::getCandidates(const LHCb::Track& veloTrack,std::vector<LHCb::Track*>& outtracks ){
  ...
  for(PatVTTTrack cand : m_vuttracks){
    simpleFit(cand);
  }
...
void PatVeloTTTool::formClusters(bool forward){
...
//
//=========================================================================
void PatVeloTTTool::simpleFit(PatVTTTrack& vuttr) {
...
//=========================================================================
void PatVeloTTTool::prepareOutputTracks(std::vector<LHCb::Track*>& outtracks){

  PatVTTTrack cand = *m_bestCand.begin();
...
//=============================================================================
void PatVeloTTTool::handle ( const Incident& incident ) {
...
//=============================================================================
bool PatVeloTTTool::acceptTrack(const LHCb::Track& track) 
{
