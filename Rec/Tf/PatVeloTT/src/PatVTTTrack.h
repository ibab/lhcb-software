// $Id: PatVTTTrack.h,v 1.1.1.1 2007-08-22 15:30:37 smenzeme Exp $
...
namespace Tf {
  ...
  public:
    ...
    LocalHit( VeloTTHit* hit, double dist ) {
      m_hit = hit;
      m_dist = dist;
  ...
  public: 
    ...
    void storeHit( double dist, VeloTTHit* hit ) {
    ...
    VeloTTHits& clusters() { return m_clusters;}
    ...
    //=========================================================================
    void bestLists(double tol, double tol_factor, std::vector<VeloTTHits> & hitsSolutions, MsgStream& msg){
	...
	msg << "Number of solutions: " << LocalHitsLists.size() << endreq;
      ...
      // Now create the different VeloTTHit combinations and add them to the vector of solutions
