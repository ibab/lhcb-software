...
//
  static double line_fit( const vector<double>& zcoord,
                          const vector<double>& xcoord,
                          const  vector<double>& error,
                          vector<double>& params,
                          vector<unsigned int>& removedhits);

  static double parabola_fit( const vector<double>& zcoord,
                              const vector<double>& xcoord,
                              const  vector<double>& error,
                              vector<double>& params,
                              vector<unsigned int>& removedhits );
...
// public member functions
 // always check it, I only set it true if hit and plane are correctly filled.
  	inline bool isIT() const { return m_SeedHit->m_isIT;};
 // always check it, I only set it true if hit and plane are correctly filled.
  	inline bool isOT() const { return m_SeedHit->m_isOT;};
