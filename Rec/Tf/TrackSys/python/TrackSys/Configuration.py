...
__version__ = "$Id: Configuration.py,v 1.13 2009-11-12 17:33:55 kholubye Exp $"
...
class TrackSys(LHCbConfigurableUser):
    ...
    KnownExpertTracking        = ["noDrifttimes", "simplifiedGeometry", "kalmanSmoother", "fastSequence"]
