...
StatusCode Velo::VeloIPResolutionMonitorNT::distance( const RecVertex* pv, State& state, 
...
//====================================================================
StatusCode Velo::VeloIPResolutionMonitorNT::fillHistos( double& ip3d, double& ipx, double& ipy, double& inversePT )
{
...
//====================================================================
StatusCode Velo::VeloIPResolutionMonitorNT::plotInBin( double& ip3d, double& ipx, double& ipy, int& binNo )
{
...
//=========================================================================
StatusCode Velo::VeloIPResolutionMonitorNT::plotRMS ( vector< TH1D* > sourceHistos, TH1D* outHisto ) {
...
//=========================================================================
StatusCode Velo::VeloIPResolutionMonitorNT::fitGaussAndPlotWidth ( vector< TH1D* > sourceHistos, TH1D* outHisto ) {
...
//=========================================================================
StatusCode Velo::VeloIPResolutionMonitorNT::fitDblGaussAndPlotWidth ( vector< TH1D* > sourceHistos, TH1D* outHisto ) {
...
//=========================================================================
StatusCode Velo::VeloIPResolutionMonitorNT::fitLandauAndPlotMPV ( vector< TH1D* > sourceHistos, TH1D* outHisto ) {
...
//=========================================================================
StatusCode Velo::VeloIPResolutionMonitorNT::fit2DGausAndPlotMean ( vector< TH1D* > sourceHistos, TH1D* outHisto ) {
...
//  Fit double 2D Gaussian to a set of histograms, and plot the fitted mean of the core in an output histo  
//=========================================================================
StatusCode Velo::VeloIPResolutionMonitorNT::fitDbl2DGausAndPlotMean ( vector< TH1D* > sourceHistos, TH1D* outHisto ) {
...
//=========================================================================
StatusCode Velo::VeloIPResolutionMonitorNT::plotMean ( vector< TH1D* > sourceHistos, TH1D* outHisto ) {
...
//====================================================================
std::pair< pair< Double_t, Double_t >, pair< Double_t, Double_t > > Velo::VeloIPResolutionMonitorNT::result1D( TH1D* h, int opt ){
...
//====================================================================
void Velo::VeloIPResolutionMonitorNT::fillMeanAndProfile( TH1D* mean, TH1D* sigma, TH1D** histos, int option ) {
...
//====================================================================
void Velo::VeloIPResolutionMonitorNT::getBinsFromTH2D( TH2D* h, string id, string title, string unit, TH1D** out ){
...
//====================================================================
void Velo::VeloIPResolutionMonitorNT::rebinHisto( TH1D* h, int nbins )
{
  if( nbins != 0 ){
    h->Rebin( nbins ) ;
  }
...
void Velo::VeloIPResolutionMonitorNT::rebinHistos( TH1D** histos, int nHistos, int nbins )
{
