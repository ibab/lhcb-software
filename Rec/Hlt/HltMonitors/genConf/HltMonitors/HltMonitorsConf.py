#Thu Sep  2 16:13:06 2010
"""Automatically generated. DO NOT EDIT please"""
from GaudiKernel.Proxy.Configurable import *

class HltRateMonitor( ConfigurableAlgorithm ) :
  __slots__ = { 
    'OutputLevel' : 0, # int
    'Enable' : True, # bool
    'ErrorMax' : 1, # int
    ...
    'HltDecReportsLocation' : 'Hlt/DecReports', # str
    'ODINLocation' : 'DAQ/ODIN', # str
    'Regexes' : [ 'Hlt2Express.*Decision' ], # list
    'RunParameterLocation' : 'Conditions/Online/LHCb/RunParameters', # str
    'ForceEnable' : False, # bool
    'SecondsPerBin' : 10, # int
  }
  _propertyDocDct = { 
  ...
  def __init__(self, name = Configurable.DefaultName, **kwargs):
      super(HltRateMonitor, self).__init__(name)
      for n,v in kwargs.items():
         setattr(self, n, v)
  def getDlls( self ):
      return 'HltMonitors'
  def getType( self ):
      return 'HltRateMonitor'
  pass # class HltRateMonitor

class HltMonitorBase( ConfigurableAlgorithm ) :
  __slots__ = { 
    'OutputLevel' : 0, # int
    'Enable' : True, # bool
    'ErrorMax' : 1, # int
  ...
  def __init__(self, name = Configurable.DefaultName, **kwargs):
      super(HltMonitorBase, self).__init__(name)
      for n,v in kwargs.items():
         setattr(self, n, v)
  def getDlls( self ):
      return 'HltMonitors'
  def getType( self ):
      return 'HltMonitorBase'
  pass # class HltMonitorBase

class HltCompositionMonitor( ConfigurableAlgorithm ) :
  __slots__ = { 
    'OutputLevel' : 0, # int
    'Enable' : True, # bool
    'ErrorMax' : 1, # int
  ...
  def __init__(self, name = Configurable.DefaultName, **kwargs):
      super(HltCompositionMonitor, self).__init__(name)
      for n,v in kwargs.items():
         setattr(self, n, v)
  def getDlls( self ):
      return 'HltMonitors'
  def getType( self ):
      return 'HltCompositionMonitor'
  pass # class HltCompositionMonitor
