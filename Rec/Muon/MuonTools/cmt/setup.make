...
MUONDETROOT = /afs/cern.ch/lhcb/software/NEW/Det/MuonDet/v1r1
...
use_requirements = requirements $(CMTROOT)/mgr/requirements $(MUONDETROOT)/cmt/requirements $(DETDESCROOT)/cmt/requirements $(MUONKERNELROOT)/cmt/requirements $(GAUDIKERNELROOT)/cmt/requirements $(GAUDIPOLICYROOT)/cmt/requirements $(AIDAROOT)/cmt/requirements $(CLHEPROOT)/cmt/requirements $(XERCESROOT)/cmt/requirements $(EXTERNALLIBSROOT)/cmt/requirements 
