...
DLL_flag = 5  #0=old; 1=DLL new; 3=hyperbolic tangent mapping (Do not use it for data type 2010 and 2011)
              #4==hyperbolic tangent for Muon prob form 2010 data + Landau fits MC2009 for NonMuon prob 
	      #5==hyperbolic tangent for both Muon and non-Muon prob tuned on 2011+2012 data 
...
# Momentum binning for muon hypothesis:
nMupBinsR1 = 6
nMupBinsR2 = 4
nMupBinsR3 = 4
nMupBinsR4 = 4
...
# Momentum binning for non-muon hypothesis:
nNonMupBinsR1 = 6
nNonMupBinsR2 = 4
nNonMupBinsR3 = 4
nNonMupBinsR4 = 2
NonMupBinsR1 = [10000., 20000., 30000., 40000., 50000., 60000.]
NonMupBinsR2 = [10000., 20000., 30000., 40000.]
NonMupBinsR3 = [7000., 8000., 10000., 15000.]
NonMupBinsR4 = [8000., 10000.]

# Load parameters for DLL_flag=5: 
from MuonID import tanh_2015
from tanh_2015 import *
