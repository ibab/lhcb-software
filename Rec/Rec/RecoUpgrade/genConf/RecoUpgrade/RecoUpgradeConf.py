...
class Tf__PatVeloPixFitLHCbIDs( ConfigurableAlgTool ) :
  __slots__ = { 
    'MonitorService' : 'MonitorSvc', # str
    'OutputLevel' : 7, # int
  ...
  def __init__(self, name = Configurable.DefaultName, **kwargs):
      super(Tf__PatVeloPixFitLHCbIDs, self).__init__(name)
      for n,v in kwargs.items():
         setattr(self, n, v)
  def getDlls( self ):
      return 'RecoUpgrade'
  def getType( self ):
      return 'Tf::PatVeloPixFitLHCbIDs'
  pass # class Tf__PatVeloPixFitLHCbIDs
