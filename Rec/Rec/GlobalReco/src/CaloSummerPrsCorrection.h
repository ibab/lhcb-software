// $Id: CaloSummerPrsCorrection.h,v 1.1 2002-12-20 16:29:49 gcorti Exp $
// ============================================================================
...
//
// ============================================================================
#ifndef CALOEX_CaloSummerPrsCorrection_H 
#define CALOEX_CaloSummerPrsCorrection_H 1
// Include files
// from STL
#include <string>
// from CaloKernel
...
/** @class CaloSummerPrsCorrection CaloSummerPrsCorrection.h
 *
 ...
 *  @author Vanya Belyaev Ivan.Belyaev@itep.ru
 *  @date   02/05/2002
 *  Renamed from CaloPrsCorrection to avoid conflict (G.Corti)
 */

class CaloSummerPrsCorrection: 
  public virtual ICaloHypoTool , 
  public              CaloTool  
{
  /// friend factory for instantiation
  friend class ToolFactory<CaloSummerPrsCorrection>;
...
protected:
   ...
   */
  CaloSummerPrsCorrection
  ( const std::string& type   , 
    const std::string& name   ,
    const IInterface*  parent );
  
  /// destructor (virtual and protected)
  virtual ~CaloSummerPrsCorrection() ;
    ...
    const Params& pars   ) const 
  {
    ...
    const double frac = prs / energy ;
    return energy * ( pars[0] + pars[1] * frac + pars[2] * frac * frac );
  };
    ...
    const Params&    pars    ) const 
  {
    ...
    const double frac = prs / energy ;
    return pars[0]  - pars[2] * frac * frac ;
  };
...
private:
  ...
  CaloSummerPrsCorrection( const CaloSummerPrsCorrection& );
  ///  assignement operator   is   private
  CaloSummerPrsCorrection& operator=( const CaloSummerPrsCorrection& );
...
// The END 
// ============================================================================
#endif // CaloSummerPrsCorrection_H
// ============================================================================
