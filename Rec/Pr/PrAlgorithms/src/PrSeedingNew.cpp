...
//
//=========================================================================
void PrSeedingNew::findXProjections( unsigned int zone ){
  m_xCandidates.clear();
...
//  
//=========================================================================
void PrSeedingNew::addStereo( unsigned int zone ) {
...
//=========================================================================
bool PrSeedingNew::fitTrack( PrSeedTrack& track ) {
...
//=========================================================================
bool PrSeedingNew::removeWorstAndRefit ( PrSeedTrack& track ) {
  float maxChi2 = 0.;
