...
#include "PrAddUTCoord.h"


//-----------------------------------------------------------------------------
// Implementation file for class : PrAddUTCoord
//
// 2010-02-12 : Michel De Cian, based on Olivier Callot's PrAddUTCoord
//
//-----------------------------------------------------------------------------

DECLARE_TOOL_FACTORY( PrAddUTCoord )

using ROOT::Math::CholeskyDecomp; // -- Maybe copy locally if not running at CERN?
//=============================================================================
// Standard constructor, initializes variables
//=============================================================================
PrAddUTCoord::PrAddUTCoord( const std::string& type,
...
// Destructor
//=============================================================================
PrAddUTCoord::~PrAddUTCoord() {}

//=========================================================================
//
//=========================================================================
StatusCode PrAddUTCoord::initialize ( ) {
...
//  Return the UT hits
//=========================================================================
StatusCode PrAddUTCoord::returnUTClusters( LHCb::State& state, PrUTHits& utHits, double& finalChi2, double p){
...
//=========================================================================
void PrAddUTCoord::selectHits(PrUTHits& selected, const LHCb::State& state, const double p){
...
// Calculate Chi2
//=========================================================================
void PrAddUTCoord::calculateChi2(PrUTHits& goodUT, double& chi2, const double& bestChi2,
...
// Print out info
//=========================================================================
void PrAddUTCoord::printInfo(const PrUTHits& goodUT, double dist, double chi2, const LHCb::State& state){
