...
//=========================================================================
double PrUTMagnetTool::zMidField() {
  if( m_noField ) { 
...
// averageDist2mom
//=========================================================================
double PrUTMagnetTool::averageDist2mom() {
  if( m_noField ) { 
...
//****************************************************************************
double PrUTMagnetTool::bdlIntegral(double ySlopeVelo, double zOrigin, double zVelo) {
...
//****************************************************************************
double PrUTMagnetTool::zBdlMiddle(double ySlopeVelo, double zOrigin, double zVelo) {
...
//****************************************************************************
double PrUTMagnetTool::dist2mom(double ySlope) {
...
//****************************************************************************
void PrUTMagnetTool::dxNormFactorsUT(double ySlope, std::vector<double>& nfact) {
...
//****************************************************************************
void PrUTMagnetTool::f_bdl( double slopeY, double zOrigin,
