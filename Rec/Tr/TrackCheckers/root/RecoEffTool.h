...
#ifndef RecoEffTool_h
#define RecoEffTool_h
...
#ifdef RecoEffTool_cxx
RecoEffTool::RecoEffTool(TTree *tree)
{
...
RecoEffTool::~RecoEffTool()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t RecoEffTool::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t RecoEffTool::LoadTree(Long64_t entry)
{
...
void RecoEffTool::Init(TTree *tree)
{
...
void RecoEffTool::Show(Long64_t entry)
{
...
Int_t RecoEffTool::Cut(Long64_t entry)
{
