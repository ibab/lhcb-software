...
Int_t TxTool::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TxTool::LoadTree(Long64_t entry)
{
...
void TxTool::Show(Long64_t entry)
{
...
Int_t TxTool::Cut(Long64_t entry)
{
