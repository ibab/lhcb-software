...
#ifndef HitEffPurTool_h
#define HitEffPurTool_h
...
public :
   ...
   HitEffPurTool(TTree *tree=0);
   virtual ~HitEffPurTool();
...
#ifdef HitEffPurTool_cxx
HitEffPurTool::HitEffPurTool(TTree *tree)
{
...
HitEffPurTool::~HitEffPurTool()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t HitEffPurTool::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t HitEffPurTool::LoadTree(Long64_t entry)
{
...
void HitEffPurTool::Init(TTree *tree)
{
...
void HitEffPurTool::Show(Long64_t entry)
{
...
Int_t HitEffPurTool::Cut(Long64_t entry)
{
