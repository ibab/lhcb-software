...
#ifndef MomentumResolutionTool_h
#define MomentumResolutionTool_h
...
public :
   ...
   MomentumResolutionTool(TTree *tree=0);
   virtual ~MomentumResolutionTool();
...
#ifdef MomentumResolutionTool_cxx
MomentumResolutionTool::MomentumResolutionTool(TTree *tree)
{
...
MomentumResolutionTool::~MomentumResolutionTool()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MomentumResolutionTool::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MomentumResolutionTool::LoadTree(Long64_t entry)
{
...
void MomentumResolutionTool::Init(TTree *tree)
{
...
Bool_t MomentumResolutionTool::Notify()
{
...
void MomentumResolutionTool::Show(Long64_t entry)
{
...
Int_t MomentumResolutionTool::Cut(Long64_t entry)
{
...
#endif // #ifdef MomentumResolutionTool_cxx
