#ifndef TRACKTOOLS_ITRACKRECONSTRUCTIBLE_H 
#define TRACKTOOLS_ITRACKRECONSTRUCTIBLE_H 1
...
/** @class ITrackReconstructible TrackTools/ITrackReconstructible.h
 *  
 *
...
#endif // TRACKTOOLS_ITRACKRECONSTRUCTIBLE_H 
