...
StatusCode PGPrimaryVertex::execute() {
  ...
  if( m_usePVResFile ) {
     ...
     smearX = 2.94863e-01 * (m_gaus()*2.14809e-02 - 1.64321e-04)
            + 9.19347e-01 * (1.-2.94863e-01) * (m_gaus()*9.28222e-03 - 2.07447e-05)
            + (1.-9.19347e-01) * (1.-2.94863e-01) * (m_gaus()*5.53627e-02 - 1.59372e-04);
     smearY = 2.91760e-01 * (m_gaus()*2.12752e-02 - 3.54945e-05)
            + 9.22621e-01 * (1.-2.91760e-01) * (m_gaus()*9.42666e-03 - 1.92725e-05)
            + (1.-9.22621e-01) * (1.-2.91760e-01) * (m_gaus()*5.50516e-02 - 7.60356e-05);
     smearZ = 3.01500e-01 * (m_gaus()*1.10641e-01 + 4.43561e-04)
            + 9.39764e-01 * (1.-3.01500e-01) * (m_gaus()*4.58140e-02 - 6.39404e-05)
            + (1.-9.39764e-01) * (1.-3.01500e-01) * (m_gaus()*2.93170e-01 + 1.92947e-03);
  }
