...
DECLARE_TOOL_FACTORY( TsaOTXSearch );

TsaOTXSearch::TsaOTXSearch(const std::string& type,
...
TsaOTXSearch::~TsaOTXSearch(){
  // destructer
  delete m_parabolaFit;
}


StatusCode TsaOTXSearch::initialize(){
...
StatusCode TsaOTXSearch::execute(std::vector<SeedTrack*>& seeds, std::vector<SeedHit*> hits[6]){
...
void TsaOTXSearch::loadData(std::vector<SeedHit*> hits[6]) const{
