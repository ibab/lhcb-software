...
public: 
  ...
  void setXHit1( SeedHit* value );
  void setXHit2( SeedHit* value );
  void setYHit1( SeedHit* value );
  void setYHit2( SeedHit* value );
...
SeedStub::SeedStub(double x, double y, double z1, double z2, double sx, double sy, 
          SeedHit* xHit1, SeedHit* xHit2, SeedHit* yHit1, SeedHit* yHit2):
 KeyedObject<int>(),
 m_live ( 1 ),
 m_x ( x),
