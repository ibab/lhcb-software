// $Id: TrajVeloPhiProjector.cpp,v 1.4 2006-04-06 13:15:35 jvantilb Exp $
// Include files 
...
static const  ToolFactory<TrajVeloPhiProjector>          s_factory ;
const        IToolFactory& TrajVeloPhiProjectorFactory = s_factory ;
