// $Id: OTTrackProjector.cpp,v 1.1 2005-04-08 15:45:46 erodrigu Exp $
// Include files 
...
// local
#include "TrackProjectors/OTTrackProjector.h"
#include "Event/OTMeasurement.h"

//-----------------------------------------------------------------------------
// Implementation file for class : OTTrackProjector
//
// 2005-04-08 : Jose Hernando, Eduardo Rodrigues
//-----------------------------------------------------------------------------

// Declaration of the Tool Factory
static const  ToolFactory<OTTrackProjector>          s_factory ;
const        IToolFactory& OTTrackProjectorFactory = s_factory ; 

//=============================================================================
//  Project a state onto a measurement.
// It returns the chi squared of the projection
//=============================================================================
double OTTrackProjector::project( const State& state,
                                  Measurement& meas )
{
  double x  = state.x();
  double y  = state.y();
...
// Initialize
//=============================================================================
StatusCode OTTrackProjector::initialize()
{
...
//=============================================================================
OTTrackProjector::OTTrackProjector( const std::string& type,
...
// Destructor
//=============================================================================
OTTrackProjector::~OTTrackProjector() {}; 
