// $Id: RichPhotonSignalHPD.h,v 1.1 2003-09-04 07:12:52 jonrob Exp $
#ifndef RICHRECTOOLS_RICHPHOTONSIGNALHPD_H
#define RICHRECTOOLS_RICHPHOTONSIGNALHPD_H 1
...
/** @class RichPhotonSignalHPD RichPhotonSignalHPD.h
 *
...
class RichPhotonSignalHPD : public RichRecToolBase,
                            virtual public IRichPhotonSignal {

public:

  /// Standard constructor
  RichPhotonSignalHPD( const std::string& type,
                       const std::string& name,
                       const IInterface* parent );

  /// Destructor
  virtual ~RichPhotonSignalHPD(){}
...
#endif // RICHRECTOOLS_RICHPHOTONSIGNALHPD_H
