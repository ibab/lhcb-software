// $Id: RichTabulatedSignalDetectionEffSICB.h,v 1.2 2003-12-11 16:33:36 cattanem Exp $
#ifndef RICHRECTOOLS_RICHTABULATEDSIGNALDETECTIONEFFSICB_H
#define RICHRECTOOLS_RICHTABULATEDSIGNALDETECTIONEFFSICB_H 1
...
/** @class RichTabulatedSignalDetectionEffSICB RichTabulatedSignalDetectionEffSICB.h
 *
...
class RichTabulatedSignalDetectionEffSICB : public RichRecToolBase,
                                            virtual public IRichSignalDetectionEff {

public:

  /// Standard constructor
  RichTabulatedSignalDetectionEffSICB( const std::string& type,
                                       const std::string& name,
                                       const IInterface* parent );

  /// Destructor
  virtual ~RichTabulatedSignalDetectionEffSICB() {};
...
#endif // RICHRECTOOLS_RICHTABULATEDSIGNALDETECTIONEFFSICB_H
