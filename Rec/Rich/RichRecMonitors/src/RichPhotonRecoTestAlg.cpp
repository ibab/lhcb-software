...
StatusCode PhotonRecoTestAlg::execute()
{
  ...
  // Aerogel segments
  intersects.clear();
  intersects.push_back( RichRadIntersection( Point(1.24572,99.0629,1110),
  ...
  // C4f10 segments
  intersects.clear();
  intersects.push_back( RichRadIntersection( Point(12.1593,43.7352,990),
  ...
  // Cf4 segments
  intersects.clear();
  intersects.push_back( RichRadIntersection( Point(-178.735,385.802,9501.4),
