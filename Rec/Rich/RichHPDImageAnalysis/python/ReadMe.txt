...
> SetupProject LHCbDirac
> SetupProject Brunel v42r3p2 pytools --use LCG_Interfaces/COOL --tag_add NEEDS_PYCOOL --runtime LHCbDirac --use LHCbDiracSys
#> SetupProject Brunel vv42r3p2 pytools --use LCG_Interfaces/COOL --tag_add NEEDS_PYCOOL
