##  -*- python -*-  
# db file automatically generated by genconf on: Tue Mar 16 14:40:37 2010
...
def _fillCfgDb():
    ...
    cfgDb.add( configurable = 'Rich__Mon__RichHPDImageSummary',
               package = 'RichHPDImageAnalysis',
               module  = 'RichHPDImageAnalysis.RichHPDImageAnalysisConf',
               lib     = 'RichHPDImageAnalysis' )
    return #_fillCfgDb
...
try:
    ...
    print "Py:ConfigurableDb   ERROR   ==> culprit is package [RichHPDImageAnalysis] !"
