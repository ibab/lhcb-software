...
namespace RichMarkov {
  ...
  private:
    class SampledTooEarly : public FinderExternalException {
    public:
      SampledTooEarly(const std::string & s) : FinderExternalException(s) {};
    };
    double totalProb;
  ...
  public:
    ...
    Index sampleAnIndex() const {
      if (cache.empty()) {
	throw SampledTooEarly("Your DominantFiniteRelativeProbabilityChooser was sampled too early.");
      };
