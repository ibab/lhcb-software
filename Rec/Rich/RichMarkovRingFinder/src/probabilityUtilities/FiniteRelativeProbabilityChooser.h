...
namespace RichMarkov {
  ...
  public:
    class NoSamplesPossible : public FinderExternalException{
    };
    class NoMaxExists: public FinderExternalException {
    };
  private:
    double totalProb;
  ...
  public:
    ...
    FiniteRelativeProbabilityChooser( const std::string & fileName, const std::string dir="") 
			: totalProb(0), cache() {
