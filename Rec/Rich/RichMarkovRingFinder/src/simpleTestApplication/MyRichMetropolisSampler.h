...
namespace Lester {
  ...
  private:
    ...
    inline PointType randomlyDeleteCircle() const {
    ...
    inline PointType randomlyAddCircle(const double s3) const {
...
private:
    inline PointType doNewThreePointCircleAdd() const {
      const int nDataPoints = data.hits.size();
    ...
    inline PointType doThreePointCircleAdd() const {
    ...
    inline PointType doReverseCircleAdd() const {
    ...
    inline PointType addOrRemoveCircle() const {
