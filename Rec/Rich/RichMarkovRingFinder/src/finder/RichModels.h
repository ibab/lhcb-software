...
namespace RichMarkov {
  ...
  extern const Rich1AThetaSampler          rich1AThetaSampler;
  extern const Rich1AThetaDistribtion      rich1AThetaDistribution;
  extern const Rich1AProbabilityThetaAbove rich1AProbabilityThetaAbove;
