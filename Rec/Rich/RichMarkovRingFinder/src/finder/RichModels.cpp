...
namespace Lester {
  ...
  const Rich1AThetaSampler rich1AThetaSampler(thetaFileR1DeJour,thetaDirDeJour);
  const Rich1AThetaDistribtion rich1AThetaDistribution(thetaFileR1DeJour,thetaDirDeJour);
  const Rich1AProbabilityThetaAbove rich1AProbabilityThetaAbove(thetaFileR1DeJour,thetaDirDeJour);
