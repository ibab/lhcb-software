...
namespace Lester {
  ...
  private:
    void moveToNextState() {
      ...
      //std::cerr << "               " << froggerIndex << " " << froggeeIndex << std::endl;
      // 
	...
	std::cerr << "Hey! Idiot!  Yes! You there!  Use a SENSIBLE Sharkfin proposal distribution!   Jumps of "<< sharkfinForwardFactor << " cannot be reversed!" << std::endl;
	m_last = froggerPlus.point;
	//std::cerr << "Rej id" << std::endl;
	return;	
      };
