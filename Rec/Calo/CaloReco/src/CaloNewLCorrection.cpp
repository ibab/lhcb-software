// $Id: CaloNewLCorrection.cpp,v 1.5 2005-11-07 12:12:42 odescham Exp $
// ============================================================================
...
// local
#include "CaloNewLCorrection.h"

/** @file 
 *  Implementation file for class : CaloNewLCorrection
 *  
 *  @date 2003-03-10 
 ...
 */
// ============================================================================
static const  ToolFactory<CaloNewLCorrection>         s_Factory ;
const        IToolFactory&CaloNewLCorrectionFactory = s_Factory ; 
// ============================================================================
 ...
 */
// ============================================================================
CaloNewLCorrection::CaloNewLCorrection 
 ...
 */
// ============================================================================
StatusCode CaloNewLCorrection::finalize   () 
{
  m_hypos.clear();
 ...
 */
// ============================================================================
StatusCode CaloNewLCorrection::initialize () 
{
 ...
 */  
// ============================================================================
StatusCode CaloNewLCorrection::operator() ( CaloHypo* hypo  ) const 
{ return process( hypo ); };
// ============================================================================
 ...
 */  
// ============================================================================
StatusCode CaloNewLCorrection::process    ( CaloHypo* hypo  ) const 
{
  ...
  */
  ...
  // Corrected angle
  int zon = 2 - area;
  double alpha = Par_Al1[zon] - exp( Par_Al2[zon] - Par_Al3[zon] * ePrs/MeV );
  double beta  = Par_Be1[zon] + exp( Par_Be2[zon] - Par_Be3[zon] * ePrs/MeV  );
