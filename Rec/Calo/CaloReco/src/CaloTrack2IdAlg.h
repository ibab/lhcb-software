// $Id: CaloTrack2IdAlg.h,v 1.1 2002-11-17 17:09:27 ibelyaev Exp $
// ============================================================================
...
private:
  ...
  // ouput location for "efficiency" table  
  std::string         m_efficiency     ;
  // ouput location for "rejection" table  
  ...
  IHistogram2D*       m_eff            ; // "efficiency" 
  IHistogram2D*       m_rej            ; // "rejection"
