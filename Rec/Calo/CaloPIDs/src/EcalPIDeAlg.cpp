// $Id: EcalPIDeAlg.cpp,v 1.4 2008-06-30 15:37:34 odescham Exp $
// ============================================================================
...
protected:
  ...
  {
    if("HLT"==context()){
      _setProperty ( "Input"  , LHCb::CaloIdLocation::EcalChi2Hlt  ) ;
      _setProperty ( "Output" , LHCb::CaloIdLocation::EcalPIDeHlt  ) ;
    }else{
      _setProperty ( "Input"  , LHCb::CaloIdLocation::EcalChi2  ) ;
      _setProperty ( "Output" , LHCb::CaloIdLocation::EcalPIDe  ) ;
    }
