// $Id: InHcalAcceptanceAlg.cpp,v 1.1 2006-06-18 18:35:29 ibelyaev Exp $
// ============================================================================
...
protected:
  ...
  {
    setProperty ( "Output" , LHCb::CaloIdLocation::InHcal     ) ;
    setProperty ( "Tool"   , "InHcalAcceptance/InHcal:PUBLIC" ) ;
    // track types:
