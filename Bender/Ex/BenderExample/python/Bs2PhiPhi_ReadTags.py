#!/usr/bin/env python
# =============================================================================
# $Id: Bs2PhiPhi_ReadTags.py,v 1.1 2004-08-06 12:12:03 ibelyaev Exp $
# =============================================================================
...
def configure () :
    ...
    bender.config( files   =
                   [ '$BENDEREXAMPLEOPTS/BenderExample.opts'  ,   # general options 
                     ...
                     '$BENDEREXAMPLEOPTS/Bs_phiphi_tags.opts' ] , # input data 
                   options =
    ...
    hsvc.OutputFile = 'phi_fromtags.hbook'
    # ntuples 
    nsvc = gaudi.iProperty( 'NTupleSvc' )
    nsvc.Output = [ "PHIPHI  DATAFILE='bs2phiphi_fromtags_tup.hbook' TYP='HBOOK' OPT='NEW'" ]
