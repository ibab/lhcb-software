#!/usr/bin/env python
# =============================================================================
# $Id: bendermcvertexcuts.py,v 1.2 2004-08-06 12:07:06 ibelyaev Exp $ 
# =============================================================================
# CVS tag $NAme:$ 
# =============================================================================
...
MCVMIN     = helper.loadFunMCV ( gbl.LoKi.Min ( 'const MCVertex*' ) )
MCVMAX     = helper.loadFunMCV ( gbl.LoKi.Max ( 'const MCVertex*' ) )
