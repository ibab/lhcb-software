...
# -*- coding: utf-8 -*-
# =============================================================================
# $Id: Test2DModels.py 173560 2014-06-09 10:03:52Z ibelyaev $ 
# =============================================================================
...
s1 = cpp.Gaudi.Math.BSpline  ( m_x.xmin(), m_x.xmax() , 1 , 1 ) 
s2 = cpp.Gaudi.Math.BSpline  ( m_y.xmin(), m_y.xmax() , 1 , 1 ) 
s3 = cpp.Gaudi.Math.Spline2D ( s1 , s2 )

sp_2D = Models.Spline2D_pdf ( 'S2D' , m_x , m_y, s3 )

with rooSilent() : 
    result = sp_2D.pdf.fitTo ( dataset , ROOT.RooFit.Save() )
    result = sp_2D.pdf.fitTo ( dataset , ROOT.RooFit.Save() )
...
with rooSilent() : 
    result = sps_2D.pdf.fitTo ( dataset , ROOT.RooFit.Save() )
    result = sps_2D.pdf.fitTo ( dataset , ROOT.RooFit.Save() )
