...
DECLARE_TOOL_FACTORY( TupleZViso )


//=============================================================================
// Standard constructor, initializes variables
//=============================================================================
TupleZViso::TupleZViso( const std::string& type,
...

{
  ...
  declareProperty("Cut_IPS"          , m_cut_ips = 5.0);
  declareProperty("Cut_IPS_VF"       , m_cut_ips_VF = 25.0);
  declareProperty("Cut_maxVF"        , m_cut = 0.5);
  
  
  declareProperty("Weights_BDTG_ZViso",m_Weights_BDTG_ZViso="TMVAClassification_BDTG.weights.xml");	
...
// Destructor
//=============================================================================
TupleZViso::~TupleZViso() {} 

//=============================================================================
// Initialization
//=============================================================================
StatusCode TupleZViso::initialize() {
...
//------------------Initialize TMVA reader--------------------------------
  ...
  cout<<"MAPPORCA "<<m_Weights_BDTG_ZViso<<endl;
...
StatusCode TupleZViso::finalize(){
...
// Fill the tuple
//=============================================================================
StatusCode TupleZViso::fill( const LHCb::Particle* /*top*/,
...
StatusCode TupleZViso::Initialize_tracksVF_ZVtop()
{
...
StatusCode TupleZViso::IsoTopo2Body(const LHCb::Particle *part, const std::string prefix, Tuples::Tuple& tuple )  //Isolation of Mathieu - uses only the Vertex Function
{
...
//  VfProfile
//=============================================================================
int TupleZViso::VfProfile(double zB,const LHCb::Particle* Part, std::vector<double> *v_Vf, std::vector<double>* v_Position){//
  v_Vf->clear();
  v_Position->clear();
  double dist = 0;
  double Vf = 0;
...
//  VfAlongTrackTrans
//=============================================================================
double TupleZViso::VfAlongTrack(double zB, const LHCb::Particle* Part, double delta, float* z_f_m ){//
...
StatusCode TupleZViso::GMPiso(const LHCb::Particle *part, const std::string prefix, Tuples::Tuple& tuple )//
{
...
std::vector<LHCb::RecVertex*> TupleZViso::zvtop(const LHCb::Particle* dau1,//
...
void  TupleZViso::zvtop_iso(const LHCb::Particle* dau,//
...
StatusCode TupleZViso::ZViso(const LHCb::Particle *part, const std::string prefix, Tuples::Tuple& tuple )//
{
...
Gaudi::XYZPoint TupleZViso::close_point(Gaudi::XYZPoint o,
