#ifndef TUPLETOOLBU2PHIMUNU_2_H 
#define TUPLETOOLBU2PHIMUNU_2_H 1
...
class TupleToolBu2phimunu_2 : public TupleToolBase, virtual public IParticleTupleTool {

public:
  
  /// Standard constructor
  TupleToolBu2phimunu_2( const std::string& type, 
                       const std::string& name,
                       const IInterface* parent);
  
  virtual ~TupleToolBu2phimunu_2( ){}; ///< Destructor
...
private:
  ...
  const LHCb::Particle* findID(unsigned int id, LHCb::Particle::ConstVector& v, int s=1);
