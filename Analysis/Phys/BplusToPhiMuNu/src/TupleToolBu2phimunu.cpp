...
#include "TupleToolBu2phimunu.h"
#include <utility>
#include <iostream>     
#include <algorithm>    

//-----------------------------------------------------------------------------
// Implementation file for class : TupleToolBu2phimunu
//
// Author: Basem KHANJI 
//-----------------------------------------------------------------------------
...
DECLARE_TOOL_FACTORY( TupleToolBu2phimunu )  //commented to adapt to DecayTreeTuple
//============================================================================
TupleToolBu2phimunu::TupleToolBu2phimunu(const std::string& type,
...
// =============================================================================
StatusCode TupleToolBu2phimunu::initialize() {
...
//=============================================================================
StatusCode TupleToolBu2phimunu::fill(const LHCb::Particle* mother 
                                     ...
                                     , Tuples::Tuple& tuple)
{
  ...
  const Particle* kaon2   = findID(-321, parts_cand); // added the second kaon
...
const Particle* TupleToolBu2phimunu::findID(unsigned int id,
...
//=============================================================================
double TupleToolBu2phimunu::get_MINIPCHI2(const Particle* p){  
  double minchi2 = -1 ;
...
//========================================================================
double TupleToolBu2phimunu::get_IPCHI2wrtDcyVtx(const Particle* B,
                                                const Particle* P){
...
//=============================================================================
void TupleToolBu2phimunu::InCone(Gaudi::XYZPoint o1,
...
//============================================================================
double TupleToolBu2phimunu::pointer (Gaudi::XYZVector vertex,
...
//============================================================================
void TupleToolBu2phimunu::closest_point(Gaudi::XYZPoint o,Gaudi::XYZVector p,
...
//============================================================================
double TupleToolBu2phimunu::arcosine(Gaudi::XYZVector p1,
...
//============================================================================
void TupleToolBu2phimunu::BDTvariableNames_bb_bkg_training(std::vector<std::string>& inNames) const {
  inNames.clear();
...
//============================================================================
//============================================================================
void TupleToolBu2phimunu::BDTvariableNames_Bplus_training(std::vector<std::string>& inNames) const {
  inNames.clear();
  inNames.push_back("track_minIPchi2" );
