...
class ZooOccupancy : public TObject
{
	 ...
	 */
	void getOccVelo(std::vector<std::vector<std::vector<int> > >& occVelo) const
	{
	    occVelo.clear();
	    occVelo.resize(23, std::vector<std::vector<int> >(2, std::vector<int>(2, 0)));
	 ...
	 *   modules with higher numbers are closer to beam pipe
	 */
	void getOccOT(std::vector<std::vector<std::vector<std::vector<int> > > >& occOT) const
	{
	    occOT.clear();
	 ...
	 *   sensor: same as in ZooOccupancyHelper::TTIndex, but starting at 0
	 */
	void getOccIT(std::vector<std::vector<std::vector<std::vector<int> > > >& occIT) const
	{
	    occIT.clear();
	 ...
	 *
         ...
         *   regions: C-side 0, B-side (beam pipe) 1, A-side 2
	 */
	void getOccTT(std::vector<std::vector<std::vector<std::vector<int> > > >& occTT) const
	{
	    occTT.clear();
