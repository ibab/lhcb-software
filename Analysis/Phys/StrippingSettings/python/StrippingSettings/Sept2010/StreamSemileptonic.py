# $Id: StreamSemileptonic.py,v 1.1 2010-09-07 11:57:00 gcowan Exp $
#
...
from StrippingSelections.StrippingB0q2DplusMuX import confdict as B0q2DplusMuXAllLinesConfDict
stream.appendLines( B0q2DplusMuXAllLinesConf(B0q2DplusMuXConfDict).Lines )
