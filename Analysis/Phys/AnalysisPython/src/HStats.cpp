 ...
 */
// ============================================================================
double Gaudi::Utils::HStats::moment        
( const TH1*         histo , 
  ...
  const double       value ) 
{
  ...
  for ( int i = 1 ; i <= nBins ; ++i ) 
  {
    ...
    //
    weight += yBin ;
    result += yBin * Gaudi::Math::pow ( xBin - value , order ) ;
  }    
  //
 ...
 */
// ============================================================================
double Gaudi::Utils::HStats::momentErr
( const TH1*         histo , 
  const unsigned int order ) 
{
  if ( 0 == histo ) { return s_bad ; }                   // RETURN 
 ...
 */
// ============================================================================
double Gaudi::Utils::HStats::centralMoment 
( const TH1*         histo , 
  const unsigned int order ) 
{
  if ( 0 == histo ) { return s_bad ; }                        // RETURN
 ...
 */
// ============================================================================
double Gaudi::Utils::HStats::centralMomentErr
( const TH1*         histo , 
  const unsigned int order ) 
{
  //
...
// ============================================================================
double Gaudi::Utils::HStats::skewness ( const TH1* histo ) 
{
  if ( 0 == histo ) { return s_bad ; }                      // RETURN
  //
...
// ============================================================================
double Gaudi::Utils::HStats::skewnessErr ( const TH1* histo ) 
{
  if ( 0 == histo ) { return s_bad ; }                     // RETURN 
  //
  const double n = nEff ( histo ) ;
...
// ============================================================================
double Gaudi::Utils::HStats::kurtosis ( const TH1* histo ) 
{
  if ( 0 == histo ) { return s_bad ; }                    // RETURN 
  //
...
// ============================================================================
double Gaudi::Utils::HStats::kurtosisErr ( const TH1* histo ) 
{
  if ( 0 == histo ) { return s_bad ; }                    // RETURN 
  const double n = nEff ( histo ) ;
...
// ============================================================================
double Gaudi::Utils::HStats::nEff ( const TH1* histo ) 
{
...
// ============================================================================
double Gaudi::Utils::HStats::mean ( const TH1* histo ) 
{
  if ( 0 == histo ) { return s_bad ; }
  //
...
// ============================================================================
double Gaudi::Utils::HStats::meanErr ( const TH1* histo ) 
{
  if ( 0 == histo ) { return s_bad ; }
  //
  const double n = nEff ( histo ) ;
...
// ============================================================================
double Gaudi::Utils::HStats::rms ( const TH1* histo ) 
{
  if ( 0 == histo ) { return s_bad ; }
  //
  return histo -> GetRMS () ;    
...
// ============================================================================
double Gaudi::Utils::HStats::rmsErr ( const TH1* histo ) 
{
  if ( 0 == histo ) { return s_bad ; }  
  //
  const double n = nEff ( histo ) ;    
