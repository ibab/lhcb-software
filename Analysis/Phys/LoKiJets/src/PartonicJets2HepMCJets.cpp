...
namespace LoKi
{
  ...
  public: 
    ...
    const IJets2Jets::Table makeRelation( const IJets2Jets::Jets& partonjets  , const IJets2Jets::Jets& hepmcjets) const ;
...
const IJets2Jets::Table LoKi::PartonicJets2HepMCJets::makeRelation
( const IJets2Jets::Jets& partonjets  , const IJets2Jets::Jets& hepmcjets ) const 
{
