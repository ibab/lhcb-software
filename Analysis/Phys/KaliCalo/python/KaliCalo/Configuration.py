#!/usr/bin/env python
# =============================================================================
# $Id: Configuration.py,v 1.8 2009-12-15 11:27:15 apuignav Exp $
# =============================================================================
...
#  @author Vanya BELYAEV Ivan.Belyaev@nikhef.nl
#  @date 2008-09-28
class  MyKaliPi0Conf(LHCbConfigurableUser):
    """
    The main Configurable for Calorimeter Iterative Calibration with pi0
    ...
    # configuration of application:
    form Gaudi.Configuration import *  
    from Configurables       import MyKaliPi0Conf
    ...
    def kaliPi0 ( self ) :
        ...
        The configuration for Kali-Pi0 algorithm
        """
        from Configurables import Kali__MyPi0, PhysDesktop        
        kali = Kali__MyPi0 (
            "KaliPi0"                                      ,
            NTupleLUN      = "KALIPI0"                     ,
            HistoPrint     = True                          ,
