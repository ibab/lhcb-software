...
HistogramPersistencySvc().OutputFile = "/afs/cern.ch/user/s/seaso/scratch0/DavinciData/histoMva/BsDsPi_RealData_test.root";

dv.UserAlgorithms = [SeqMvASelection]
dv.HistogramFile = "/afs/cern.ch/user/s/seaso/scratch0/DavinciData/histoMva/BsDsPi_RealData_test.root" 
