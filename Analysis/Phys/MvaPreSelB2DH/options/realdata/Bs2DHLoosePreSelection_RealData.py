...
PreSelCombBs2DsPiAlg.InputLocations = ["StdNoPIDsPions", "StdLooseDplus2KKPi"  ]
#PreSelCombBs2DsPiAlg.InputLocations = ["StdNoPIDsPions", "StdLooseDplus2KPiPi","StdLooseDplus2KKPi", "StdLooseDplus2PiPiPi","StdLooseDplus2KPiPiOppSignPi"  ]
#PreSelCombBs2DsPiAlg.InputLocations = ["/Event/Bhadron/Phys/StdNoPIDsPions", "Phys/CombineDs2KKPiLoosePreSel"]
#PreSelCombBs2DsPiAlg.DecayDescriptors = {"[B_s0 -> D- pi+]cc" , "[B_s0 -> D_s- pi+]cc" }
PreSelCombBs2DsPiAlg.DecayDescriptor = "[B_s0 -> D- pi+]cc"
