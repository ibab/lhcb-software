...
j.name = 'Zjet_MC_MagDown_MC11_' + DaVinciVersion
...
#-------------------------------------------------------------------------------
#help(BKQuery)
bkqzmumu = BKQuery( dqflag = "All" , path = "", type = "Path" )

bkqzmumu.path  = "/MC/MC11a/Beam3500GeV-2011-MagDown-Nu2-EmNoCuts/Sim05/Trig0x40760037Flagged/Reco12a/Stripping17NoPrescalingFlagged/42112020/ALLSTREAMS.DST"  # ( Z_mumujet )

datasetzmumu = bkqzmumu.getDataset()

print '\n Total \n ', datasetzmumu.files
j.inputdata = datasetzmumu
#-------------------------------------------------------------------------------
