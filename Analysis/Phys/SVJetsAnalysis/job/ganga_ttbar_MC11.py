...
j.name = 'ttbar_MC11_' + DaVinciVersion
...
j.splitter = DiracSplitter ( filesPerJob = 5, maxFiles = -1 , ignoremissing = True )
...
bkq_Up.path = "/MC/MC11a/Beam3500GeV-2011-MagUp-Nu2-EmNoCuts/Sim05a/Trig0x40760037Flagged/Reco12a/Stripping17NoPrescalingFlagged/41900005/ALLSTREAMS.DST"# ( tt_bb=1l,10GeV,2b )
bkq_Down = BKQuery( dqflag = "All" , path = "", type = "Path" )
bkq_Down.path = "/MC/MC11a/Beam3500GeV-2011-MagDown-Nu2-EmNoCuts/Sim05a/Trig0x40760037Flagged/Reco12a/Stripping17NoPrescalingFlagged/41900005/ALLSTREAMS.DST"# ( tt_bb=1l,10GeV,2b )
