...
j.name = 'VH_mH120_MC10_' + DaVinciVersion
...
#-------------------------------------------------------------------------------
#help(BKQuery)
bkq_40911006 = BKQuery( dqflag = "All" , path = "", type = "Path" )
bkq_40911006.path  = "/MC/MC10/Beam3500GeV-Oct2010-MagUp-Nu2,5/Sim01/Trig0x002e002aFlagged/Reco08/Stripping12Flagged/40911006/ALLSTREAMS.DST"#
bkq_40911012 = BKQuery( dqflag = "All" , path = "", type = "Path" )
bkq_40911012.path  = "/MC/MC10/Beam3500GeV-Oct2010-MagUp-Nu2,5/Sim01/Trig0x002e002aFlagged/Reco08/Stripping12Flagged/40911012/ALLSTREAMS.DST"#

dataset_All = LHCbDataset()
dataset_All = LHCbDataset(files = [ f for f in bkq_40911006.getDataset().files ] )
dataset_All.files.extend(bkq_40911012.getDataset().files)
