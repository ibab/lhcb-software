...
j.name = 'W(munu)jets_MC11_' + DaVinciVersion
...
bkq_Up.path = "/MC/MC11a/Beam3500GeV-2011-MagDown-Nu2-EmNoCuts/Sim05/Trig0x40760037Flagged/Reco12a/Stripping17NoPrescalingFlagged/42311010/ALLSTREAMS.DST" # ( W_munujet )
bkq_Down = BKQuery( dqflag = "All" , path = "", type = "Path" )
bkq_Down.path = "/MC/MC11a/Beam3500GeV-2011-MagUp-Nu2-EmNoCuts/Sim05/Trig0x40760037Flagged/Reco12a/Stripping17NoPrescalingFlagged/42311010/ALLSTREAMS.DST" #  ( W_munujet )
