...
class Jets2HEPMCJetsConf:
    ...
    def __init__(self, _name,
        ...
        from JetAccessoriesMC.MCJetMaker_Config import HEPMCJetMakerConf
        mcjetmaker = HEPMCJetMakerConf("StdMC", PartTypes , R  , PtMin, MotherCut  , ToBanCut ,  SimpleAcceptance , jetidnumber  ,algtype, MCJets2MCPTable , SaveMotherOnly )
