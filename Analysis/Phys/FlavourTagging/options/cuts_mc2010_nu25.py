########################################################################
#
# Tagging cuts to be optimized for mc2010 with nu=2.5
#
...
tag.BTaggingTool.TaggerKaonSameTool.KaonSame_Phi_cut = 1.0
tag.BTaggingTool.TaggerKaonSameTool.KaonSame_Eta_cut = 0.9
tag.BTaggingTool.TaggerKaonSameTool.KaonSame_dQ_cut  = 2000
tag.BTaggingTool.TaggerKaonSameTool.KaonS_LCS_cut    = 3.0
tag.BTaggingTool.TaggerKaonSameTool.KaonSPID_kS_cut  = 3.0
tag.BTaggingTool.TaggerKaonSameTool.KaonSPID_kpS_cut = -2.
