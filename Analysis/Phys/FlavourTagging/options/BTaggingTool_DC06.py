...
from Configurables import BTaggingTool, TaggerMuonTool, TaggerElectronTool, TaggerKaonSameTool, TaggerKaonOppositeTool, TaggerPionSameTool, TaggerVertexChargeTool

tag = BTaggingTool()

tag.addTool ( TaggerMuonTool )
tag.TaggerMuonTool.Muon_Pt_cut = 1.1 *1000
tag.TaggerMuonTool.Muon_P_cut  = 0.0 *1000
tag.TaggerMuonTool.Muon_lcs_cut= 4.0
tag.TaggerMuonTool.NeuralNetName = "NNetTool_DC06"

tag.addTool ( TaggerElectronTool )
tag.TaggerElectronTool.Ele_Pt_cut   = 1.1 * 1000
tag.TaggerElectronTool.Ele_P_cut    = 4.0 * 1000
...
tag.TaggerKaonOppositeTool.Kaon_Pt_cut  = 0.6 *1000
tag.TaggerKaonOppositeTool.Kaon_P_cut   = 4.0 *1000
...
tag.TaggerKaonSameTool.KaonSame_Pt_cut = 0.4 *1000
tag.TaggerKaonSameTool.KaonSame_P_cut  = 4.0 *1000
...
tag.TaggerKaonSameTool.KaonSame_dQ_cut = 1.4 *1000
...
tag.TaggerPionSameTool.PionSame_P_cut   = 0.2 *1000
tag.TaggerPionSameTool.PionSame_IPs_cut = 3.0
tag.TaggerPionSameTool.PionS_LCS_cut    = 3.0
tag.TaggerPionSameTool.PionSame_dQ_cut  = 3.0 *1000
tag.TaggerPionSameTool.PionSame_dQ_extra_cut= 1.5 *1000
