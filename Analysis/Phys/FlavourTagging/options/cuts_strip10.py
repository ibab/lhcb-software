...
tag.BTaggingTool.TaggerMuonTool.Muon_IPs_cut  = 2.0
tag.BTaggingTool.TaggerMuonTool.Muon_lcs_cut  = 3.5
tag.BTaggingTool.TaggerMuonTool.Muon_PIDm_cut = 3.0
tag.BTaggingTool.TaggerMuonTool.Muon_ipPU_cut = 3.0
tag.BTaggingTool.TaggerMuonTool.Muon_distPhi_cut = 0.04
...
tag.BTaggingTool.TaggerVertexChargeTool.MinimumVCharge= 0.15
