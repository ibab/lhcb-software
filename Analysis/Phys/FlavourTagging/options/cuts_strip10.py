########################################################################
#
# Tagging cuts optimized for Stripping10
#
...
tag.BTaggingTool.TaggerMuonTool.Muon_IPs_cut  = 2.2
...
tag.BTaggingTool.TaggerElectronTool.Ele_Pt_cut    = 0.8
...
tag.BTaggingTool.TaggerKaonOppositeTool.Kaon_Pt_cut   = 1.05
tag.BTaggingTool.TaggerKaonOppositeTool.Kaon_P_cut    = 4.0
tag.BTaggingTool.TaggerKaonOppositeTool.Kaon_IPs_cut  = 2.8
...
tag.BTaggingTool.TaggerPionSameTool.PionSame_IPs_cut      = 2.5
...
tag.BTaggingTool.TaggerVertexChargeTool.MinimumVCharge= 0.09
