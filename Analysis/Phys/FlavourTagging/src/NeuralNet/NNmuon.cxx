...
double NNmuon::neuron0x8615b98() {
   return input0;
}

double NNmuon::neuron0x8615d28() {
   return input1;
}

double NNmuon::neuron0x8615f00() {
   return input2;
}

double NNmuon::neuron0x86160f8() {
   return input3;
}

double NNmuon::input0x8616410() {
...
double NNmuon::neuron0x8616410() {
   double input = input0x8616410();
   return ((input < -709. ? 0. : (1/(1+exp(-input)))) * 1)+0;
}

double NNmuon::input0x8616618() {
...
double NNmuon::neuron0x8616618() {
   double input = input0x8616618();
   return ((input < -709. ? 0. : (1/(1+exp(-input)))) * 1)+0;
}

double NNmuon::input0x8616890() {
...
double NNmuon::neuron0x8616890() {
   double input = input0x8616890();
   return ((input < -709. ? 0. : (1/(1+exp(-input)))) * 1)+0;
}

double NNmuon::input0x8616b08() {
...
double NNmuon::neuron0x8616b08() {
   double input = input0x8616b08();
   return ((input < -709. ? 0. : (1/(1+exp(-input)))) * 1)+0;
}

double NNmuon::input0x8616d80() {
...
double NNmuon::neuron0x8616d80() {
   double input = input0x8616d80();
   return ((input < -709. ? 0. : (1/(1+exp(-input)))) * 1)+0;
}

double NNmuon::input0x86170a0() {
...
double NNmuon::neuron0x86170a0() {
   double input = input0x86170a0();
   return ((input < -709. ? 0. : (1/(1+exp(-input)))) * 1)+0;
}

double NNmuon::input0x8610d98() {
...
double NNmuon::neuron0x8610d98() {
   double input = input0x8610d98();
   return ((input < -709. ? 0. : (1/(1+exp(-input)))) * 1)+0;
}

double NNmuon::input0x8611030() {
...
double NNmuon::neuron0x8611030() {
   double input = input0x8611030();
   return ((input < -709. ? 0. : (1/(1+exp(-input)))) * 1)+0;
}

double NNmuon::input0x86112c8() {
...
double NNmuon::neuron0x86112c8() {
   double input = input0x86112c8();
   return ((input < -709. ? 0. : (1/(1+exp(-input)))) * 1)+0;
}

double NNmuon::input0x86115f0() {
...
double NNmuon::neuron0x86115f0() {
   double input = input0x86115f0();
   return ((input < -709. ? 0. : (1/(1+exp(-input)))) * 1)+0;
}

double NNmuon::input0x8611888() {
...
double NNmuon::neuron0x8611888() {
   double input = input0x8611888();
   return ((input < -709. ? 0. : (1/(1+exp(-input)))) * 1)+0;
}

double NNmuon::input0x8611b28() {
...
double NNmuon::neuron0x8611b28() {
   double input = input0x8611b28();
   return ((input < -709. ? 0. : (1/(1+exp(-input)))) * 1)+0;
}

double NNmuon::input0x8611dc8() {
