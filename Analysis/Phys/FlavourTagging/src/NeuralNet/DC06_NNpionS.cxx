#include "DC06_NNpionS.h"
#include <cmath>

double DC06_NNpionS::value(int index,double in0,double in1,double in2,double in3,double in4,double in5,double in6) {
   input0 = (in0 - 0)/1;
   input1 = (in1 - 0)/1;
   input2 = (in2 - 0)/1;
   input3 = (in3 - 0)/1;
...
double DC06_NNpionS::neuron0x8ba6a10() {
   return input0;
}

double DC06_NNpionS::neuron0x8ba6b58() {
   return input1;
}

double DC06_NNpionS::neuron0x8ba6d30() {
   return input2;
}

double DC06_NNpionS::neuron0x898a738() {
   return input3;
}

double DC06_NNpionS::neuron0x898a930() {
   return input4;
}

double DC06_NNpionS::neuron0x8c0ee38() {
   return input5;
}

double DC06_NNpionS::neuron0x8c0f030() {
   return input6;
}

double DC06_NNpionS::input0x890f3a8() {
...
double DC06_NNpionS::neuron0x890f3a8() {
   double input = input0x890f3a8();
   return ((input < -709. ? 0. : (1/(1+exp(-input)))) * 1)+0;
}

double DC06_NNpionS::input0x890f628() {
...
double DC06_NNpionS::neuron0x890f628() {
   double input = input0x890f628();
   return ((input < -709. ? 0. : (1/(1+exp(-input)))) * 1)+0;
}

double DC06_NNpionS::input0x88f3d68() {
...
double DC06_NNpionS::neuron0x88f3d68() {
   double input = input0x88f3d68();
   return ((input < -709. ? 0. : (1/(1+exp(-input)))) * 1)+0;
}

double DC06_NNpionS::input0x88f40e0() {
...
double DC06_NNpionS::neuron0x88f40e0() {
   double input = input0x88f40e0();
   return ((input < -709. ? 0. : (1/(1+exp(-input)))) * 1)+0;
}

double DC06_NNpionS::input0x891cef8() {
...
double DC06_NNpionS::neuron0x891cef8() {
   double input = input0x891cef8();
   return ((input < -709. ? 0. : (1/(1+exp(-input)))) * 1)+0;
}

double DC06_NNpionS::input0x891d2a0() {
...
double DC06_NNpionS::neuron0x891d2a0() {
   double input = input0x891d2a0();
   return ((input < -709. ? 0. : (1/(1+exp(-input)))) * 1)+0;
}

double DC06_NNpionS::input0x8c104f0() {
...
double DC06_NNpionS::neuron0x8c104f0() {
   double input = input0x8c104f0();
   return ((input < -709. ? 0. : (1/(1+exp(-input)))) * 1)+0;
}

double DC06_NNpionS::input0x8c0f228() {
...
double DC06_NNpionS::neuron0x8c0f228() {
   double input = input0x8c0f228();
   return (input * 0.497705)+0.547851;
}

double DC06_NNpionS::synapse0x85b0208() {
   return (neuron0x8ba6a10()*-0.948375);
}

double DC06_NNpionS::synapse0x890f538() {
   return (neuron0x8ba6b58()*-0.458527);
}

double DC06_NNpionS::synapse0x890f560() {
   return (neuron0x8ba6d30()*2.29839);
}

double DC06_NNpionS::synapse0x890f588() {
   return (neuron0x898a738()*0.404908);
}

double DC06_NNpionS::synapse0x890f5b0() {
   return (neuron0x898a930()*0.0400143);
}

double DC06_NNpionS::synapse0x890f5d8() {
   return (neuron0x8c0ee38()*-1.60591);
}

double DC06_NNpionS::synapse0x890f600() {
   return (neuron0x8c0f030()*-0.267925);
}

double DC06_NNpionS::synapse0x890f800() {
   return (neuron0x8ba6a10()*0.411926);
}

double DC06_NNpionS::synapse0x890f828() {
   return (neuron0x8ba6b58()*0.593631);
}

double DC06_NNpionS::synapse0x890f850() {
   return (neuron0x8ba6d30()*-1.05012);
}

double DC06_NNpionS::synapse0x890f878() {
   return (neuron0x898a738()*-0.0388521);
}

double DC06_NNpionS::synapse0x890f8a0() {
   return (neuron0x898a930()*0.292324);
}

double DC06_NNpionS::synapse0x890f8c8() {
   return (neuron0x8c0ee38()*1.00388);
}

double DC06_NNpionS::synapse0x8ba6e78() {
   return (neuron0x8c0f030()*1.71256);
}

double DC06_NNpionS::synapse0x88f3f40() {
   return (neuron0x8ba6a10()*0.816497);
}

double DC06_NNpionS::synapse0x88f3f68() {
   return (neuron0x8ba6b58()*1.10449);
}

double DC06_NNpionS::synapse0x88f3f90() {
   return (neuron0x8ba6d30()*-1.53016);
}

double DC06_NNpionS::synapse0x88f4040() {
   return (neuron0x898a738()*0.825792);
}

double DC06_NNpionS::synapse0x88f4068() {
   return (neuron0x898a930()*-0.0688984);
}

double DC06_NNpionS::synapse0x88f4090() {
   return (neuron0x8c0ee38()*1.30619);
}

double DC06_NNpionS::synapse0x88f40b8() {
   return (neuron0x8c0f030()*1.49551);
}

double DC06_NNpionS::synapse0x88f4270() {
   return (neuron0x8ba6a10()*0.153601);
}

double DC06_NNpionS::synapse0x898ab28() {
   return (neuron0x8ba6b58()*-0.340265);
}

double DC06_NNpionS::synapse0x898ab50() {
   return (neuron0x8ba6d30()*0.533843);
}

double DC06_NNpionS::synapse0x898ab78() {
   return (neuron0x898a738()*0.0323478);
}

double DC06_NNpionS::synapse0x891ce80() {
   return (neuron0x898a930()*-0.134412);
}

double DC06_NNpionS::synapse0x891cea8() {
   return (neuron0x8c0ee38()*-0.0691368);
}

double DC06_NNpionS::synapse0x891ced0() {
   return (neuron0x8c0f030()*-2.14241);
}

double DC06_NNpionS::synapse0x891d0d0() {
   return (neuron0x8ba6a10()*0.392295);
}

double DC06_NNpionS::synapse0x891d0f8() {
   return (neuron0x8ba6b58()*-0.0685067);
}

double DC06_NNpionS::synapse0x891d120() {
   return (neuron0x8ba6d30()*0.531245);
}

double DC06_NNpionS::synapse0x891d148() {
   return (neuron0x898a738()*-0.142545);
}

double DC06_NNpionS::synapse0x891d170() {
   return (neuron0x898a930()*0.137211);
}

double DC06_NNpionS::synapse0x88f3fb8() {
   return (neuron0x8c0ee38()*0.0931435);
}

double DC06_NNpionS::synapse0x88f3fe0() {
   return (neuron0x8c0f030()*-1.07535);
}

double DC06_NNpionS::synapse0x8c103d8() {
   return (neuron0x8ba6a10()*2.3091);
}

double DC06_NNpionS::synapse0x8c10400() {
   return (neuron0x8ba6b58()*0.298753);
}

double DC06_NNpionS::synapse0x8c10428() {
   return (neuron0x8ba6d30()*-2.15746);
}

double DC06_NNpionS::synapse0x8c10450() {
   return (neuron0x898a738()*0.772951);
}

double DC06_NNpionS::synapse0x8c10478() {
   return (neuron0x898a930()*-0.0102391);
}

double DC06_NNpionS::synapse0x8c104a0() {
   return (neuron0x8c0ee38()*1.97767);
}

double DC06_NNpionS::synapse0x8c104c8() {
   return (neuron0x8c0f030()*3.95349);
}

double DC06_NNpionS::synapse0x8c106c8() {
   return (neuron0x8ba6a10()*-0.354711);
}

double DC06_NNpionS::synapse0x8c106f0() {
   return (neuron0x8ba6b58()*-0.091695);
}

double DC06_NNpionS::synapse0x8c10718() {
   return (neuron0x8ba6d30()*-0.251027);
}

double DC06_NNpionS::synapse0x8c10740() {
   return (neuron0x898a738()*-0.0685042);
}

double DC06_NNpionS::synapse0x8c10768() {
   return (neuron0x898a930()*0.445152);
}

double DC06_NNpionS::synapse0x8c10790() {
   return (neuron0x8c0ee38()*0.207264);
}

double DC06_NNpionS::synapse0x8c107b8() {
   return (neuron0x8c0f030()*0.252589);
}

double DC06_NNpionS::synapse0x8c108b8() {
   return (neuron0x890f3a8()*-1.27094);
}

double DC06_NNpionS::synapse0x8c108e0() {
   return (neuron0x890f628()*0.115476);
}

double DC06_NNpionS::synapse0x8ba7fe8() {
   return (neuron0x88f3d68()*0.220656);
}

double DC06_NNpionS::synapse0x8ba8010() {
   return (neuron0x88f40e0()*2.06033);
}

double DC06_NNpionS::synapse0x8ba8038() {
   return (neuron0x891cef8()*1.9991);
}

double DC06_NNpionS::synapse0x8ba8060() {
   return (neuron0x891d2a0()*-2.27697);
}

double DC06_NNpionS::synapse0x8ba8088() {
