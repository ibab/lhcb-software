...
Strip_loose_Bd2KstarMuMu.MotherCut=( "(MIPDV(PRIMARY)<0.08) & (MIPCHI2DV(PRIMARY) < 150) & (PT>300*MeV) & (BPVDIRA>0.9998) & "+
			      ...
			      , "Filter"
		    	      ...
		    	      , Code = 
		    	        	...
		    	        	"(2 == NINTREE((ABSID=='mu+') & (MIPCHI2DV(PRIMARY)>4) & (TRCHI2DOF < 16))) & "+
		    	                "(INTREE((ABSID=='K*(892)0') & (BPVVDZ>-50) & (BPVVDCHI2>25) & (VFASPF(VCHI2/VDOF)<36))) & "+
...
filter_Bd2KstarMuMu_1Hz = StrippingMember (FilterDesktop
			      , "Filter"
		    	      ...
		    	      , Code = 
		    	        	...
		    	        	"(2 == NINTREE((ABSID=='mu+') & ((PIDmu-PIDpi)>-5) & (MIPDV(PRIMARY) > 0.08))) & "+
		    	                "(INTREE((ABSID=='K*(892)0') & (BPVVDZ>-5) & (PT>1000*MeV) & (MIPDV(PRIMARY) > 0.06))) & "+
		    	                "(BPVDIRA>0.99995) & (VFASPF(VMINVDDV(PRIMARY))>1*mm) & (MIPDV(PRIMARY) < 0.06)"
		             )
#
