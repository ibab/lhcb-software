...
#myApplication.make()
myApplication.optsfile = File ('/afs/cern.ch/user/s/seaso/cmtuser/DaVinci_v25r2p3/Phys/MvaSelections/options/grid/Bs2DsPi_grid.py')
...
myInputsandbox = []
#myOutputsandbox= []
myOutputsandbox= ['BsDsPiSignal_MvaSelections_MC09.root' ]
#myOutputData=['']
#-------------------------------------------------------------------------------
...
#myBackend    = Condor()
#-------------------------------------------------------------------------------
list=load('/afs/cern.ch/user/s/seaso/cmtuser/DaVinci_v25r2p3/Phys/MvaSelections/datafiles/Bs2DsPi/Bs2DsPi_MC09_Signal_PFN.ganga')
dataPFN=list[0]  
