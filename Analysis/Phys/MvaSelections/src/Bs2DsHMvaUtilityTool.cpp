// $Id: Bs2DsHMvaUtilityTool.cpp,v 1.1 2010/06/10 12:42:22 seaso Exp $
// Include files 
...
// local
#include "Bs2DsHMvaUtilityTool.h"
using namespace LHCb ;
using namespace Gaudi ;


//-----------------------------------------------------------------------------
// Implementation file for class : Bs2DsHMvaUtilityTool
//
// 2010-02-11 : Sajan EASO
//-----------------------------------------------------------------------------

// Declaration of the Tool Factory
DECLARE_TOOL_FACTORY( Bs2DsHMvaUtilityTool );


//=============================================================================
// Standard constructor, initializes variables
//=============================================================================
Bs2DsHMvaUtilityTool::Bs2DsHMvaUtilityTool( const std::string& type,
...
{
  declareInterface<IBs2DsHMvaUtilityTool>(this);
...
//=============================================================================
StatusCode Bs2DsHMvaUtilityTool::initialize() {
...
void Bs2DsHMvaUtilityTool::initializeDataSelectionPathStrings (){
  ...
  for(int i=0; i< m_num_Bs_Phys_Channels_Used; ++i ){
    ...
    if( i == 0 ) { // set Bs2DsK as physics channel number 0
      ...
      m_particle2RefittedPVRelationsLoc[i]=
         m_basicPhysStringPath+ m_bs2DsK_PvRefitAlgName +m_P2RefitPVRel;
      ...
      m_particle2RefittedPVRelationsLoc[i]=
         m_basicPhysStringPath+ m_bs2DsPi_PvRefitAlgName +m_P2RefitPVRel;
...
void Bs2DsHMvaUtilityTool::initializeStdParamForMvaSel() {
...
bool Bs2DsHMvaUtilityTool::getL0Decision () 
{
...
int Bs2DsHMvaUtilityTool::FindBestCandidateInEv(std::vector<int> aCandIndex,
  ...
  // info()<< "best cand check numcand prob ips "<<aNumCand<<"  "
...
std::string Bs2DsHMvaUtilityTool::fisherWeightsFullFileName(int channel ){
