...
int     Nmax, requireL0, requireHlt1, requireHlt2, requireTis, UseModBtime;
bool    IsControlChannel, checkDV, removeFiles;
double  m_IPPU_cut, m_thetaMin, m_distphi_cut, m_Pmaxtot_cut, m_Ptmaxtot_cut;
...
void taginit() {
  ...
  declareProperty( "RemoveCorruptedFiles", removeFiles  = 0 );
  ...
  declareProperty( "IPPU_cut",     m_IPPU_cut    = 1.0 );
  declareProperty( "thetaMin_cut", m_thetaMin    = 0.012 );
  declareProperty( "distphi_cut",  m_distphi_cut = 0.000 );
  declareProperty( "Pmaxtot",      m_Pmaxtot_cut = 200000 );
  declareProperty( "Ptmaxtot",     m_Ptmaxtot_cut = 10000 );
