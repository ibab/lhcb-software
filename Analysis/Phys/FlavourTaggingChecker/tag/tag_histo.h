...
//sara
TH1F* homega =  new TH1F("homega","Omega ",30, 0, 0.6);
TH1F* homega2 =  new TH1F("homega2","Omega ",30, 0, 0.6);
...
x1=-15; x2=15  ;//ipsign/s 
TH1F* hr_mu_ipssign = new TH1F("hr_mu_ipssign","ipssign right tags", 50, x1, x2);
TH1F* hw_mu_ipssign = new TH1F("hw_mu_ipssign","ipssign wrong tags", 50, x1, x2);
x1=0; x2=20  ; //ippu
...
x1=0.5; x2=2;//theta
TH1F* hr_mu_theta = new TH1F("hr_mu_theta","theta right tags", 50, x1, x2);
TH1F* hw_mu_theta = new TH1F("hw_mu_theta","theta wrong tags", 50, x1, x2);
x1=0; x2=1;//prob
TH1F* hr_mu_prob = new TH1F("hr_mu_prob","prob right tags", 50, x1, x2);
TH1F* hw_mu_prob = new TH1F("hw_mu_prob","prob wrong tags", 50, x1, x2);
x1=0; x2=1;//probComb
TH1F* hr_mu_probComb = new TH1F("hr_mu_probComb","probComb right tags", 50, x1, x2);
TH1F* hw_mu_probComb = new TH1F("hw_mu_probComb","probComb wrong tags", 50, x1, x2);
...
//x1=-15; x2=15  ;//ipsign/s 
x1=0; x2=15  ;//ipsign/s 
TH1F* hr_ele_ipssign = new TH1F("hr_ele_ipssign","ipssign right tags", 50, x1, x2);
TH1F* hw_ele_ipssign = new TH1F("hw_ele_ipssign","ipssign wrong tags", 50, x1, x2);
x1=-15; x2=0  ;//ipsign/s 
TH1F* hr_ele_ipssign1 = new TH1F("hr_ele_ipssign1","ipssign right tags", 50, x1, x2);
TH1F* hw_ele_ipssign1 = new TH1F("hw_ele_ipssign1","ipssign wrong tags", 50, x1, x2);
x1=0; x2=20  ; //ippu
...
x1=0.5; x2=2;//theta
TH1F* hr_ele_theta = new TH1F("hr_ele_theta","theta right tags", 50, x1, x2);
TH1F* hw_ele_theta = new TH1F("hw_ele_theta","theta wrong tags", 50, x1, x2);
x1=0; x2=1;//prob
TH1F* hr_ele_prob = new TH1F("hr_ele_prob","prob right tags", 50, x1, x2);
TH1F* hw_ele_prob = new TH1F("hw_ele_prob","prob wrong tags", 50, x1, x2);
x1=0; x2=1;//probComb
TH1F* hr_ele_probComb = new TH1F("hr_ele_probComb","probComb right tags", 50, x1, x2);
TH1F* hw_ele_probComb = new TH1F("hw_ele_probComb","probComb wrong tags", 50, x1, x2);
...
x1=0; x2=5  ; //ip
TH1F* hr_k_ip = new TH1F("hr_k_ip","ip right tags", 50, x1, x2);
TH1F* hw_k_ip = new TH1F("hw_k_ip","ip wrong tags", 50, x1, x2);
//x1=-15; x2=15  ;//ipsign/s 
x1=0; x2=15  ;//ipsign/s 
TH1F* hr_k_ipssign = new TH1F("hr_k_ipssign","ipssign right tags", 50, x1, x2);
TH1F* hw_k_ipssign = new TH1F("hw_k_ipssign","ipssign wrong tags", 50, x1, x2);
x1=-15; x2=0  ;//ipsign/s 
TH1F* hr_k_ipssign1 = new TH1F("hr_k_ipssign1","ipssign right tags", 50, x1, x2);
TH1F* hw_k_ipssign1 = new TH1F("hw_k_ipssign1","ipssign wrong tags", 50, x1, x2);
x1=0; x2=20  ; //ippu
...
x1=-25, x2=15; // PID
TH1F* hr_k_pidkp = new TH1F("hr_k_pidkp","pidkp right tags", 50, x1, x2);
TH1F* hw_k_pidkp = new TH1F("hw_k_pidkp","pidkp wrong tags", 50, x1, x2);
x1=-35; x2=0 ;// tsal ghost likel
...
x1=0.5; x2=2;//theta
TH1F* hr_k_theta = new TH1F("hr_k_theta","theta right tags", 50, x1, x2);
TH1F* hw_k_theta = new TH1F("hw_k_theta","theta wrong tags", 50, x1, x2);
x1=0; x2=1;//prob
TH1F* hr_k_prob = new TH1F("hr_k_prob","prob right tags", 50, x1, x2);
TH1F* hw_k_prob = new TH1F("hw_k_prob","prob wrong tags", 50, x1, x2);
x1=0; x2=1;//probComb
TH1F* hr_k_probComb = new TH1F("hr_k_probComb","probComb right tags", 50, x1, x2);
TH1F* hw_k_probComb = new TH1F("hw_k_probComb","probComb wrong tags", 50, x1, x2);
...
//x1=-15.5; x2=15.5  ;//ipsign/s 
x1=0.; x2=15.  ;//ipsign/s 
TH1F* hr_kS_ipssign = new TH1F("hr_kS_ipssign","ipssign right tags", 50, x1, x2);
TH1F* hw_kS_ipssign = new TH1F("hw_kS_ipssign","ipssign wrong tags", 50, x1, x2);
x1=-15; x2=0  ;//ipsign/s 
TH1F* hr_kS_ipssign1 = new TH1F("hr_kS_ipssign1","ipssign right tags", 50, x1, x2);
TH1F* hw_kS_ipssign1 = new TH1F("hw_kS_ipssign1","ipssign wrong tags", 50, x1, x2);
x1=-0.4; x2=0.4  ;//ipsign 
TH1F* hr_kS_ipsign = new TH1F("hr_kS_ipsign","ipsign right tags", 50, x1, x2);
TH1F* hw_kS_ipsign = new TH1F("hw_kS_ipsign","ipsign wrong tags", 50, x1, x2);
x1=0; x2=20  ; //ippu
...
x1=-50, x2=20; // PIDp
TH1F* hr_kS_pidp = new TH1F("hr_kS_pidp","pidp right tags", 50, x1, x2);
TH1F* hw_kS_pidp = new TH1F("hw_kS_pidp","pidp wrong tags", 50, x1, x2);
x1=-2, x2=2; // eta
TH1F* hr_kS_deta = new TH1F("hr_kS_deta","deta right tags", 50, x1, x2);
TH1F* hw_kS_deta = new TH1F("hw_kS_deta","deta wrong tags", 50, x1, x2);
x1=0, x2=2; // abs(eta)
TH1F* hr_kS_fabsdeta = new TH1F("hr_kS_fabsdeta","fabsdeta right tags", 50, x1, x2);
TH1F* hw_kS_fabsdeta = new TH1F("hw_kS_fabsdeta","fabsdeta wrong tags", 50, x1, x2);
x1=0, x2=1.8; // phi
TH1F* hr_kS_dphi = new TH1F("hr_kS_dphi","dphi right tags", 50, x1, x2);
TH1F* hw_kS_dphi = new TH1F("hw_kS_dphi","dphi wrong tags", 50, x1, x2);
x1=0, x2=3; // dr
TH1F* hr_kS_dr = new TH1F("hr_kS_dr","dr right tags", 50, x1, x2);
TH1F* hw_kS_dr = new TH1F("hw_kS_dr","dr wrong tags", 50, x1, x2);
x1=0, x2=4; // dq
...
x1=0.5; x2=2;//theta
TH1F* hr_kS_theta = new TH1F("hr_kS_theta","theta right tags", 50, x1, x2);
TH1F* hw_kS_theta = new TH1F("hw_kS_theta","theta wrong tags", 50, x1, x2);
x1=0; x2=1;//prob
TH1F* hr_kS_prob = new TH1F("hr_kS_prob","prob right tags", 50, x1, x2);
TH1F* hw_kS_prob = new TH1F("hw_kS_prob","prob wrong tags", 50, x1, x2);
x1=0; x2=1;//probComb
TH1F* hr_kS_probComb = new TH1F("hr_kS_probComb","probComb right tags", 50, x1, x2);
TH1F* hw_kS_probComb = new TH1F("hw_kS_probComb","probComb wrong tags", 50, x1, x2);
...
TH1F* hr_vtx_ch = new TH1F("hr_vtx_ch","vtxch", 50, x1, x2);
TH1F* hw_vtx_ch = new TH1F("hw_vtx_ch","vtxch", 50, x1, x2);
TH1F* hu_vtx_ch = new TH1F("hu_vtx_ch","vtxch", 50, x1, x2);
x1=0; x2=1;//prob
TH1F* hr_vtx_prob = new TH1F("hr_vtx_prob","prob right tags", 50, x1, x2);
TH1F* hw_vtx_prob = new TH1F("hw_vtx_prob","prob wrong tags", 50, x1, x2);
x1=0; x2=1;//probComb
TH1F* hr_vtx_probComb = new TH1F("hr_vtx_probComb","probComb right tags", 50, x1, x2);
TH1F* hw_vtx_probComb = new TH1F("hw_vtx_probComb","probComb wrong tags", 50, x1, x2);
x1=0; x2=1;
TH1F* hr_vtx_like = new TH1F("hr_vtx_like","vlike", 50, x1, x2);
TH1F* hw_vtx_like = new TH1F("hw_vtx_like","vlike", 50, x1, x2);
x1=0; x2=5;
TH1F* hr_vtx_dphidir = new TH1F("hr_vtx_dphidir","vdphidir", 50, x1, x2);
TH1F* hw_vtx_dphidir = new TH1F("hw_vtx_dphidir","vdphidir", 50, x1, x2);
x1=0; x2=10;
TH1F* hr_vtx_sumpt = new TH1F("hr_vtx_sumpt","vptsum", 50, x1, x2);
TH1F* hw_vtx_sumpt = new TH1F("hw_vtx_sumpt","vptsum", 50, x1, x2);
x1=0; x2=120;
TH1F* hr_vtx_sumips = new TH1F("hr_vtx_sumips","vipssum", 50, x1, x2);
TH1F* hw_vtx_sumips = new TH1F("hw_vtx_sumips","vipssum", 50, x1, x2);
x1=0; x2=0.7;
TH1F* hr_vtx_sumdoca = new TH1F("hr_vtx_sumdoca","vdocasum", 50, x1, x2);
TH1F* hw_vtx_sumdoca = new TH1F("hw_vtx_sumdoca","vdocasum", 50, x1, x2);
x1=0; x2=7;
TH1F* hr_vtx_M = new TH1F("hr_vtx_M","vM", 50, x1, x2);
TH1F* hw_vtx_M = new TH1F("hw_vtx_M","vM", 50, x1, x2);
x1=0; x2=70;
TH1F* hr_vtx_P = new TH1F("hr_vtx_P","vP", 50, x1, x2);
TH1F* hw_vtx_P = new TH1F("hw_vtx_P","vP", 50, x1, x2);
x1=0; x2=10;
TH1F* hr_vtx_Mag = new TH1F("hr_vtx_Mag","vMag", 50, x1, x2);
TH1F* hw_vtx_Mag = new TH1F("hw_vtx_Mag","vMag", 50, x1, x2);

//Omega
x1=0; x2=1;//probComb
TH1F* hr_probComb = new TH1F("hr_probComb","probComb right tags", 50, x1, x2);
TH1F* hw_probComb = new TH1F("hw_probComb","probComb wrong tags", 50, x1, x2);
TH1F* hr_probComb_OS = new TH1F("hr_probComb_OS","probComb_OS right tags", 50, x1, x2);
TH1F* hw_probComb_OS = new TH1F("hw_probComb_OS","probComb_OS wrong tags", 50, x1, x2);

//Correlations
TH2F* eta_corr[5][5];
string histo_name="";
string name[5]={"mu","ele","ko","vtx","sP"};
for(int i=0; i<5; ++i){
  for(int j=i+1; j<5; ++j){
    histo_name = "eta_corr_";
    histo_name+=name[i];
    histo_name+="_";
    histo_name+=name[j];
    eta_corr[i][j] = new TH2F(histo_name.c_str(),histo_name.c_str(),100,0,0,100,0,0);
  }
 }
