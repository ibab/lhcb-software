...
//============================================================================
void DisplVertices::StudyPreyIP( const LHCb::Particle * p, const RecVertex * PV ){
...
// Study Activity
//============================================================================
void DisplVertices::StudyActivity(){
...
//============================================================================
void DisplVertices::StudyDistanceBet2Interactions(){
...
//============================================================================
void DisplVertices::StudyDiffGenMC(){
...
//============================================================================
void DisplVertices::StudyHltEfficiency( const Gaudi::XYZPoint & pos ){
...
void DisplVertices::StudyPV(){
  ...
  Particle::ConstVector DV = desktop()->particles();
...
//============================================================================ 
void DisplVertices::StudyDgtsIP( const Particle * p ){
...
void DisplVertices::StudyDgtsIP( const LHCb::RecVertex * v ){
...
//============================================================================
void DisplVertices::StudyDispersion( const LHCb::Particle * p ){
...
void DisplVertices::StudyDispersion( const LHCb::Particle * p1, 
...
//=============================================================================
void DisplVertices::StudyPreyComposition( const Particle * p, string s ){
...
//=============================================================================
void DisplVertices::StudyParticleGun( Particle::ConstVector & preys ){
...
//============================================================================
StatusCode DisplVertices::GetHepMCInfos()
{
...
void DisplVertices::GetHepMCStable(HepMC::GenParticle* p, int & dgt, HepMC::ThreeVector* dec ) {
...
void DisplVertices::GetHepMCStable(HepMC::GenParticle* p, int & dgt, 
			       HepMC::GenVertex* dec ) {
...
//=============================================================================
string DisplVertices::Print( HepMC::ThreeVector v ){
  stringstream kss;
  kss<<" ( "<< v.x() <<", "<< v.y() <<", "<< v.z() <<" ) ";
  return kss.str();
}

string DisplVertices::Print( HepMC::FourVector v ){
  stringstream kss;
  kss<<" ( "<< v.x() <<", "<< v.y() <<", "<< v.z() <<", "<< v.t() <<" ) ";
  return kss.str();
}
...
//  MC Infos
//=============================================================================
StatusCode DisplVertices::GetMCInfos() {
...
//============================================================================
void DisplVertices::GetMCStable( const MCParticle * p, unsigned int & dgt ){
...
void DisplVertices::GetMCStable( const MCParticle * p, 
...
void DisplVertices::GetMCStable( const LHCb::MCVertex * vtx , int & nb, 
				 Gaudi::LorentzVector & mass ){
...
void  DisplVertices::GetMCStable( const MCVertex* V, string type ){
...
void  DisplVertices::GetMCStable( const MCVertex* V ){
...
//============================================================================
void DisplVertices::SaveMCPartinTuple( LHCb::MCParticles * mcparts){
...
//============================================================================
void DisplVertices::SaveGenPartinTuple( const HepMC::GenEvent* evt ){
...
//=============================================================================
 bool DisplVertices::IsitFromaPrey( const MCParticle * p) {
...
double DisplVertices::IsitFromaPrey( const MCParticle * p, 
				      const MCVertex * prod ) {
...
bool DisplVertices::IsitFromaPrey( HepMC::GenParticle * p ) {
...
//============================================================================
const MCParticle * DisplVertices::WhichMother( const Particle * p ){
...
const MCParticle * DisplVertices::WhichMother( const MCParticle * p ){
...
//============================================================================
bool DisplVertices::IsNeutrino( const MCParticle * p ){
...
bool DisplVertices::IsNeutrino( HepMC::GenParticle * p ){
...
//============================================================================
bool DisplVertices::IsQuark( HepMC::GenParticle * p ){
...
double DisplVertices::VertDistance( HepMC::ThreeVector & v1, 
...
double DisplVertices::VertDistance(HepMC::GenVertex* v1,HepMC::GenVertex* v2 ){
...
double DisplVertices::VertDistance(HepMC::ThreeVector * v1, Vertex * v2 ) {
...
double DisplVertices::VertDistance(HepMC::ThreeVector & v1, RecVertex & v2 ) {
  HepMC::ThreeVector point = 
    HepMC::ThreeVector( v2.position().x(), v2.position().y(),
			v2.position().z() );
  return VertDistance( v1, point );
...
double DisplVertices::VertDistance(HepMC::ThreeVector & point){
...
//============================================================================
double DisplVertices::ImpactParam( const MCParticle * p, const MCVertex * v0 ){
...
//=============================================================================
void DisplVertices::Resolution( const Gaudi::XYZPoint & pos ){
...
//=============================================================================
double DisplVertices::GetMCMass( MCParticle::ConstVector & daughters ){
...
StatusCode DisplVertices::SaveCaloInfos( Tuple& tuple ){
  GetCaloInfos( "Ecal", tuple );
  GetCaloInfos( "Hcal", tuple );
  GetCaloInfos( "Prs", tuple );
  GetCaloInfos( "Spd", tuple );
  GetCaloInfos( "Muon", tuple );
  return StatusCode::SUCCESS ;
}

void DisplVertices::GetCaloInfos( string CaloType, double En, double Et ){
  Tuple dummy = nTuple("dummy");
  return GetCaloInfos( CaloType, dummy, En, Et );
}

void DisplVertices::GetCaloInfos( string CaloType, Tuple & tuple,
				  double En, double Et ){
...
StatusCode DisplVertices::SaveTrigInfinTuple( Tuple & tuple ){
  ...
  //Is it a h->kk events, to be distinguished from a gen susy event ?
  HepMCEvents::const_iterator ie=events->begin();
  const HepMCEvent* event = *ie ;  //get first MC event in a collision
  const HepMC::GenEvent* theEvent = event->pGenEvt();
