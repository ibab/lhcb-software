...
options="\"from Configurables import L0App(); L0App().EvtMax=11; from Configurables import L0MuonAlg; L0MuonAlg( 'L0Muon' ).L0DUConfigProviderType = 'L0DUConfigProvider'; from Configurables import MessageSvc; MessageSvc().OutputLevel=WARNING; L0App().TCK = '##TCK##';\""
...
def runAndParse(self,l0):
    ...
    s,o=commands.getstatusoutput('gaudirun.py ../options/L0-Testing-Default --option='+options.replace("##TCK##",l0))
