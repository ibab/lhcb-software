...
commandoptions="'from Configurables import Moore; Moore().ForceSingleL0Configuration=False; Moore.generateConfig=True; Moore().EvtMax="+str(numEvents)+"; Moore().configLabel=\"Test TCK from nightly builds, auto-generated in nightlies based on some physics threshold setting.\"; Moore().TCKData=\""+configdest+"\";'"
...
import commands
status,output = commands.getstatusoutput("gaudirun.py ../options/Moore-Testing-Default.py --option="+commandoptions)
