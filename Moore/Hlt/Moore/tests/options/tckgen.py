...
commandoptions="'from Configurables import Moore; Moore().ForceSingleL0Configuration=False; Moore.generateConfig=True; Moore().EvtMax=0; Moore().configLabel=\"Test TCK from nightly builds, auto-generated in nightlies based on some physics threshold setting.\";'"
