##  -*- python -*-  
# db file automatically generated by genconf on: Thu Jul 21 14:21:32 2011## insulates outside world against anything bad that could happen
...
def _fillCfgDb():
    ...
    cfgDb.add( configurable = 'TupleHltDecReports',
               package = 'WriteMismatches',
               module  = 'WriteMismatches.WriteMismatchesConf',
               lib     = 'WriteMismatches' )
    return #_fillCfgDb
...
try:
    ...
    print "Py:ConfigurableDb   ERROR   ==> culprit is package [WriteMismatches] !"
