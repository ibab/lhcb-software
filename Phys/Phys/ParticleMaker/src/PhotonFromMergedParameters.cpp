// $Id: PhotonFromMergedParameters.cpp,v 1.1.1.1 2004-08-24 06:47:48 pkoppenb Exp $
// ============================================================================
...
//
//
//  new tools for Photons from Merged
// 
// ============================================================================
// Include files
// CLHEP 
...
// local
#include "PhotonFromMergedParameters.h"

/** @file 
 *  Implementation file for class : PhotonFromMergedParameters
 * 
 *  @date 2003-03-11 
 *  @author O. Deschamps from Vanya's PhotonParameter.cpp 
 */


// ============================================================================
/** @var  PhotonFromMergedParametersFactory
 *  Declaration of mandatory Tool Factory
 */
// ============================================================================
static const  ToolFactory<PhotonFromMergedParameters>         s_Factory ;
const        IToolFactory&PhotonFromMergedParametersFactory = s_Factory ; 
// ============================================================================
 ...
 */
// ============================================================================
PhotonFromMergedParameters::PhotonFromMergedParameters( const std::string& type,
  ...
  , m_C22      ( 0         )  // pointer to block of final covariance matrix 
{
  ...
  declareInterface<IPhotonFromMergedParams> ( this );
};
// ============================================================================
...
/// destructor 
// ============================================================================
PhotonFromMergedParameters::~PhotonFromMergedParameters() {}
// ============================================================================
 ...
 */
// ============================================================================
StatusCode PhotonFromMergedParameters::process 
( Particle*         photon , 
  ...
  const PrimVertex* vertex ) const 
{
  ...
  return process( photon , thehypo, vrtx );
};
// ============================================================================
  ...
  const Vertex*        vertex ) const 
{
  ...
  return  1.0 == m_scale ? 
    process ( photon , thehypo ,vertex->position() , vertex->positionErr()  ) :
    process ( photon,thehypo,vertex->position(),vertex->positionErr()*m_scale);
};
// ============================================================================

// ============================================================================
namespace PhotonFromMergedParametersLocal
{ 
  ...
  const HepSymMatrix&  vxcov  ) const 
{
  ...
  using namespace PhotonFromMergedParametersLocal ;
  ...
  // loop over hypos and find thehypo
  for(Hypos::const_iterator ihypo =hypos.begin();hypos.end()!=ihypo;++ihypo){

    const CaloHypo* hypo = *ihypo ;
    if( hypo != thehypo){continue;}
    if( hypos.end() == ihypo ) 
      {  return Error(" CaloHypothesis 'PhotonFromMerged' is not found " 
                      , 409 );}
 ...
 */
// ============================================================================
StatusCode PhotonFromMergedParameters::calculate 
