...
private: // definitions
  ...
  public:
    ...
    bool topLevel;                       ///< Was Particle in one of the original input location
  public:
...
private: // methods
  ...
  const LHCb::MCParticle * mcParticle( const LHCb::ProtoParticle * proto ) const;

  /// ProtoParticle selection
  bool selectProto( const LHCb::ProtoParticle * proto ) const;

  /// Returns the min MX association weight for the given ProtoParticle
