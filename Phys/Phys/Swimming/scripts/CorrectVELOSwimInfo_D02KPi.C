#define CorrectVELOSwimInfo_D02KPi_cxx
#include "CorrectVELOSwimInfo_D02KPi.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
void CorrectVELOSwimInfo_D02KPi::Loop(std::string outputfile, int first, int last)
{
//   In a ROOT session, you can do:
//      Root > .L CorrectVELOSwimInfo_D02KPi.C
//      Root > CorrectVELOSwimInfo_D02KPi t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
    ...
    cout << "Processing entries " << first << " to " << last << endl;
    for (Long64_t jentry=first; jentry<last;jentry++) {
        ...
        Float_t         tmp_D0_TP_DEC_Hlt2CharmHadD02HH_D02KPiDecision[200];   //[D0_nTP]
        Float_t         tmp_D0_TP_DEC_Hlt2CharmHadD02HH_D02KPiWideMassDecision[200];   //[D0_nTP]
        ...
        Float_t         tmp_dauplus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KPiDecision[200];   //[dauplus_Trigger_nTP]
        Float_t         tmp_dauplus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KPiWideMassDecision[200];   //[dauplus_Trigger_nTP]
        ...
        Float_t         tmp_dauminus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KPiDecision[200];   //[dauplus_Trigger_nTP]
        Float_t         tmp_dauminus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KPiWideMassDecision[200];   //[dauplus_Trigger_nTP]
        ...
        for (int thistp = 0; thistp < D0_Trigger_nTP; ++ thistp) {
                ...
                if (thistp == 0) { //First and last TP are a special case
                        ...
                        tmp_D0_TP_DEC_Hlt2CharmHadD02HH_D02KPiDecision[tmp_D0_Trigger_nTP] = 
                            D0_TP_DEC_Hlt2CharmHadD02HH_D02KPiDecision[thistp];   
                        tmp_D0_TP_DEC_Hlt2CharmHadD02HH_D02KPiWideMassDecision[tmp_D0_Trigger_nTP] = 
                            D0_TP_DEC_Hlt2CharmHadD02HH_D02KPiWideMassDecision[thistp];   
                        ...
                        tmp_dauplus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KPiDecision[tmp_D0_Trigger_nTP] = 
                            dauplus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KPiDecision[thistp];   
                        tmp_dauplus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KPiWideMassDecision[tmp_D0_Trigger_nTP] = 
                            dauplus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KPiWideMassDecision[thistp];   
                        ...
                        tmp_dauminus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KPiDecision[tmp_D0_Trigger_nTP] = 
                            dauminus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KPiDecision[thistp];   
                        tmp_dauminus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KPiWideMassDecision[tmp_D0_Trigger_nTP] = 
                            dauminus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KPiWideMassDecision[thistp];   
                        ...
                        while (!processed) {
                                ...
                                if (    (D0_Trigger_TP_RAW[thistp] <= (*(thesetps_dauplus_hlt1iter+1)).first) &&
                                        ...
                                        tmp_D0_TP_DEC_Hlt2CharmHadD02HH_D02KPiDecision[tmp_D0_Trigger_nTP] = 
                                            D0_TP_DEC_Hlt2CharmHadD02HH_D02KPiDecision[thistp-1];   
                                        tmp_D0_TP_DEC_Hlt2CharmHadD02HH_D02KPiWideMassDecision[tmp_D0_Trigger_nTP] = 
                                            D0_TP_DEC_Hlt2CharmHadD02HH_D02KPiWideMassDecision[thistp-1];   
                                        ...
                                        tmp_dauplus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KPiDecision[tmp_D0_Trigger_nTP] = 
                                            dauplus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KPiDecision[thistp-1];   
                                        tmp_dauplus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KPiWideMassDecision[tmp_D0_Trigger_nTP] = 
                                            dauplus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KPiWideMassDecision[thistp-1];   
                                        ...
                                        tmp_dauminus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KPiDecision[tmp_D0_Trigger_nTP] = 
                                            dauminus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KPiDecision[thistp-1];   
                                        tmp_dauminus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KPiWideMassDecision[tmp_D0_Trigger_nTP] = 
                                            dauminus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KPiWideMassDecision[thistp-1];   
      ...
      for (int thistptofill = 0; thistptofill < tmp_D0_Trigger_nTP; ++thistptofill) {
                ...
                D0_TP_DEC_Hlt2CharmHadD02HH_D02KPiDecision[thistptofill] = 
                    tmp_D0_TP_DEC_Hlt2CharmHadD02HH_D02KPiDecision[thistptofill];   
                D0_TP_DEC_Hlt2CharmHadD02HH_D02KPiWideMassDecision[thistptofill] = 
                    tmp_D0_TP_DEC_Hlt2CharmHadD02HH_D02KPiWideMassDecision[thistptofill];   
                ...
                dauplus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KPiDecision[thistptofill] = 
                    tmp_dauplus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KPiDecision[thistptofill];   
                dauplus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KPiWideMassDecision[thistptofill] = 
                    tmp_dauplus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KPiWideMassDecision[thistptofill];   
                ...
                dauminus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KPiDecision[thistptofill] = 
                    tmp_dauminus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KPiDecision[thistptofill];   
                dauminus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KPiWideMassDecision[thistptofill] = 
                    tmp_dauminus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KPiWideMassDecision[thistptofill];   
