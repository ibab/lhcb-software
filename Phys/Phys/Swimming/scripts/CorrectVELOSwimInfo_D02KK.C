#define CorrectVELOSwimInfo_D02KK_cxx
#include "CorrectVELOSwimInfo_D02KK.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
void CorrectVELOSwimInfo_D02KK::Loop(std::string outputfile)
{
//   In a ROOT session, you can do:
//      Root > .L CorrectVELOSwimInfo_D02KK.C
//      Root > CorrectVELOSwimInfo_D02KK t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
    ...
    for (Long64_t jentry=0; jentry<nentries;jentry++) {
        ...
        Float_t         tmp_D0_TP_DEC_Hlt2CharmHadD02HH_D02KKDecision[200];   //[D0_nTP]
        Float_t         tmp_D0_TP_DEC_Hlt2CharmHadD02HH_D02KKWideMassDecision[200];   //[D0_nTP]
        ...
        Float_t         tmp_dauplus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KKDecision[200];   //[dauplus_Trigger_nTP]
        Float_t         tmp_dauplus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KKWideMassDecision[200];   //[dauplus_Trigger_nTP]
        ...
        Float_t         tmp_dauminus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KKDecision[200];   //[dauplus_Trigger_nTP]
        Float_t         tmp_dauminus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KKWideMassDecision[200];   //[dauplus_Trigger_nTP]
        ...
        for (int thistp = 0; thistp < D0_Trigger_nTP; ++ thistp) {
                ...
                if (thistp == 0) { //First and last TP are a special case
                        ...
                        tmp_D0_TP_DEC_Hlt2CharmHadD02HH_D02KKDecision[tmp_D0_Trigger_nTP] = 
                            D0_TP_DEC_Hlt2CharmHadD02HH_D02KKDecision[thistp];   
                        tmp_D0_TP_DEC_Hlt2CharmHadD02HH_D02KKWideMassDecision[tmp_D0_Trigger_nTP] = 
                            D0_TP_DEC_Hlt2CharmHadD02HH_D02KKWideMassDecision[thistp];   
                        ...
                        tmp_dauplus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KKDecision[tmp_D0_Trigger_nTP] = 
                            dauplus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KKDecision[thistp];   
                        tmp_dauplus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KKWideMassDecision[tmp_D0_Trigger_nTP] = 
                            dauplus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KKWideMassDecision[thistp];   
                        ...
                        tmp_dauminus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KKDecision[tmp_D0_Trigger_nTP] = 
                            dauminus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KKDecision[thistp];   
                        tmp_dauminus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KKWideMassDecision[tmp_D0_Trigger_nTP] = 
                            dauminus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KKWideMassDecision[thistp];   
                        ...
                        while (!processed) {
                                ...
                                if (    (D0_Trigger_TP_RAW[thistp] <= (*(thesetps_dauplus_hlt1iter+1)).first) &&
                                        ...
                                        tmp_D0_TP_DEC_Hlt2CharmHadD02HH_D02KKDecision[tmp_D0_Trigger_nTP] = 
                                            D0_TP_DEC_Hlt2CharmHadD02HH_D02KKDecision[thistp-1];   
                                        tmp_D0_TP_DEC_Hlt2CharmHadD02HH_D02KKWideMassDecision[tmp_D0_Trigger_nTP] = 
                                            D0_TP_DEC_Hlt2CharmHadD02HH_D02KKWideMassDecision[thistp-1];   
                                        ...
                                        tmp_dauplus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KKDecision[tmp_D0_Trigger_nTP] = 
                                            dauplus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KKDecision[thistp-1];   
                                        tmp_dauplus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KKWideMassDecision[tmp_D0_Trigger_nTP] = 
                                            dauplus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KKWideMassDecision[thistp-1];   
                                        ...
                                        tmp_dauminus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KKDecision[tmp_D0_Trigger_nTP] = 
                                            dauminus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KKDecision[thistp-1];   
                                        tmp_dauminus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KKWideMassDecision[tmp_D0_Trigger_nTP] = 
                                            dauminus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KKWideMassDecision[thistp-1];   
      ...
      for (int thistptofill = 0; thistptofill < tmp_D0_Trigger_nTP; ++thistptofill) {
                ...
                D0_TP_DEC_Hlt2CharmHadD02HH_D02KKDecision[thistptofill] = 
                    tmp_D0_TP_DEC_Hlt2CharmHadD02HH_D02KKDecision[thistptofill];   
                D0_TP_DEC_Hlt2CharmHadD02HH_D02KKWideMassDecision[thistptofill] = 
                    tmp_D0_TP_DEC_Hlt2CharmHadD02HH_D02KKWideMassDecision[thistptofill];   
                ...
                dauplus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KKDecision[thistptofill] = 
                    tmp_dauplus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KKDecision[thistptofill];   
                dauplus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KKWideMassDecision[thistptofill] = 
                    tmp_dauplus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KKWideMassDecision[thistptofill];   
                ...
                dauminus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KKDecision[thistptofill] = 
                    tmp_dauminus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KKDecision[thistptofill];   
                dauminus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KKWideMassDecision[thistptofill] = 
                    tmp_dauminus_Trigger_TP_DEC_trTOS_Hlt2CharmHadD02HH_D02KKWideMassDecision[thistptofill];   
