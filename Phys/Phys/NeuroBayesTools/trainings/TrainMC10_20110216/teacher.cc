...
void teacher() 
{
  ...
  // setup NeuroBayes
  //
	const int nvar = 16;                  // number of input variables 
...
//      continue;
    ...
    InputArray[  2 ] =  hPlusDllK; 
    InputArray[  3 ] =  hMinusDllK;                      
    InputArray[  4 ] =  minPt;     
    InputArray[  5 ] =  maxPt;     
    InputArray[  6 ] =  hPlusP;    
    InputArray[  7 ] =  hMinusP;                         
    InputArray[  8 ] =  chi2B;     
    InputArray[  9 ] =  mErrB;     
    InputArray[ 10 ] =  pB;        
    InputArray[ 11 ] =  docaB;
    InputArray[ 12 ] =  hPlusTrackChi2;
    InputArray[ 13 ] =  hMinusTrackChi2;
    InputArray[ 14 ] =  TMath::Abs(ntuple.B_s0_CosTheta); 
    InputArray[ 15 ] =  ptB; //doesn't help
