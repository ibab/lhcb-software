// $Id: LoKi_P2MC.cpp,v 1.4 2007-02-23 20:15:40 ibelyaev Exp $
// ============================================================================
...
/// initialize the algorithm
// ============================================================================
StatusCode LoKi_P2MC::initialize () 
{
  ...
  switch ( m_method ) 
  {
  case Particle2MCMethod::Chi2      : break ;
  case Particle2MCMethod::Links     : break ;
  case Particle2MCMethod::Composite : break ;
