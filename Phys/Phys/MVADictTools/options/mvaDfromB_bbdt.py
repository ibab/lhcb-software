...
__author__ = ["Sam Hall", "Sebastian Neubert", "Andrey Ustyuzhanin", "Egor Khairullin"]
__email__ = ["shall@cern.ch", "sneubert@cern.ch", "austyuzh@cern.ch", "egor.khairullin@cern.ch"]
...
addBBDecTreeclassifierTuple(tpl.D, 'bbdt.f', get_bdt_vars(),
