...
class RelatedInfoNamed : public LHCb::RelatedInfoMap {
  ...
  public: 
    ...
    enum index { 
      ...
      //BSTAUTAU ISO
      BSTAUTAUTRKISOBDTFIRSTVALUE = TRKISOBDTTHIRDVALUE + 1,
      BSTAUTAUTRKISOBDTSECONDVALUE = TRKISOBDTTHIRDVALUE + 2,
      BSTAUTAUTRKISOBDTTHIRDVALUE = TRKISOBDTTHIRDVALUE + 3,
      BSTAUTAUTAUISOBDTFIRSTVALUE = TRKISOBDTTHIRDVALUE + 4,
      BSTAUTAUTAUISOBDTSECONDVALUE = TRKISOBDTTHIRDVALUE + 5,
      BSTAUTAUTAUISOBDTTHIRDVALUE = TRKISOBDTTHIRDVALUE + 6,
      BSTAUTAUMUONISOBDTFIRSTVALUE = TRKISOBDTTHIRDVALUE + 7,
      BSTAUTAUMUONISOBDTSECONDVALUE = TRKISOBDTTHIRDVALUE + 8,
      BSTAUTAUMUONISOBDTTHIRDVALUE = TRKISOBDTTHIRDVALUE + 9,
      BSTAUTAUTRKISOFIRSTVALUE = TRKISOBDTTHIRDVALUE + 10,
      BSTAUTAUTAUISOFIRSTVALUE = TRKISOBDTTHIRDVALUE + 11,
      BSTAUTAUTAUISOSECONDVALUE = TRKISOBDTTHIRDVALUE + 12,
      BSTAUTAUMUONISOFIRSTVALUE = TRKISOBDTTHIRDVALUE + 13,
      BSTAUTAUMUONISOSECONDVALUE = TRKISOBDTTHIRDVALUE + 14,
      BSTAUTAUCDFISO = TRKISOBDTTHIRDVALUE + 15
