// $Id: OldCombineParticles.h,v 1.1 2008-04-23 20:28:27 pkoppenb Exp $
...
/** @class OldCombineParticles OldCombineParticles.h
 *  
...
class OldCombineParticles : public DVAlgorithm {

  class Decay;

public: 
  /// Standard constructor
  OldCombineParticles( const std::string& name, ISvcLocator* pSvcLocator );

  virtual ~OldCombineParticles( ); ///< Destructor
...
private:
  ...
  unsigned int  m_maxCandidates ;            ///< Maximal number of candidates accepted
