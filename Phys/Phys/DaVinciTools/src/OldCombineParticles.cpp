// $Id: OldCombineParticles.cpp,v 1.1 2008-04-23 20:28:27 pkoppenb Exp $
// Include files 
...
// local
#include "OldCombineParticles.h"

//-----------------------------------------------------------------------------
// Implementation file for class : OldCombineParticles
//
// 2007-06-26 : Juan Palacios
//-----------------------------------------------------------------------------

// Declaration of the Algorithm Factory
DECLARE_ALGORITHM_FACTORY( OldCombineParticles );


//=============================================================================
// Standard constructor, initializes variables
//=============================================================================
OldCombineParticles::OldCombineParticles( const std::string& name,
...
// Destructor
//=============================================================================
OldCombineParticles::~OldCombineParticles() {} 

//=============================================================================
// Initialization
//=============================================================================
StatusCode OldCombineParticles::initialize() {
...
//=============================================================================
StatusCode OldCombineParticles::initializePlotters() 
{
  if ( produceHistos() ){
...
//=============================================================================
StatusCode OldCombineParticles::initializePlotter(IPlotTool*& plotter, 
...
// Main execution
//=============================================================================
StatusCode OldCombineParticles::execute() {
...
// Filter particles
//=============================================================================
StatusCode OldCombineParticles::applyFilter(const LHCb::Particle::ConstVector& vIn, 
...
// Apply one decay
//=============================================================================
StatusCode OldCombineParticles::applyDecay(Decay& decay, 
...
//=============================================================================
const LHCb::Particle* 
OldCombineParticles::makeMother(const LHCb::Particle::ConstVector& Daughters,
...
//=============================================================================
StatusCode OldCombineParticles::makePlots(const LHCb::Particle::ConstVector& PV,
                                       IPlotTool* PT) {
...
//  Finalize
//=============================================================================
StatusCode OldCombineParticles::finalize() {
...
//=============================================================================
StatusCode OldCombineParticles::createDecays(){
...
//=============================================================================
StatusCode OldCombineParticles::createDecay(const std::string& mother, 
...
// Decay class
//#############################################################################
StatusCode OldCombineParticles::Decay::initialize(const std::vector<int>& pids){ 
...
//=============================================================================
bool OldCombineParticles::Decay::fillPidParticles(const LHCb::Particle::ConstVector& PV){
...
//=============================================================================
bool OldCombineParticles::Decay::getFirstCandidates(LHCb::Particle::ConstVector& DaughterVector){
  return getCandidates(DaughterVector);
}
//=============================================================================
// Get next set of daughters candidates 
//=============================================================================
bool OldCombineParticles::Decay::getNextCandidates(LHCb::Particle::ConstVector& DaughterVector){
...
//=============================================================================
bool OldCombineParticles::Decay::getCandidates(LHCb::Particle::ConstVector& DaughterVector){
  ...
  while ( refusedcombination ){    
    ...
    for ( std::vector<PidParticles>::const_iterator pp = m_pidParticles.begin() ;
      ...
      if (!P) { 
        std::cout << "OldCombineParticles::Decay::getNextCandidates : This should never happen (1)" << std::endl;
        return false ;
      } else {
        if ( m_checkOrder && pp->samePid() ) {  
          if (*(DaughterVector.rbegin())) {
            ...
            std::cout << "OldCombineParticles::Decay::getNextCandidates : This should never happen (2)" << std::endl;
            return false ;
          } 
        }
...
//=============================================================================
bool OldCombineParticles::Decay::foundOverlap(const LHCb::Particle::ConstVector& DaughterVector){
...
//=============================================================================
void OldCombineParticles::Decay::replaceResonanceByDaughters(LHCb::Particle::ConstVector& Children){
...
//=============================================================================
bool OldCombineParticles::Decay::iterate(){
