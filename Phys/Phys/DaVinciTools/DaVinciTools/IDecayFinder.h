// $Id: IDecayFinder.h,v 1.1 2002-05-20 23:05:14 gcorti Exp $
...
public:
  ...
  virtual bool hasDecay( const std::vector<Particle*> &event ) = 0;
  virtual bool findDecay( const std::vector<Particle*> &event,
