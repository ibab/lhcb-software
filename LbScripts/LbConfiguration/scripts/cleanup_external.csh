#!/bin/tcsh
# $Id: cleanup_external.csh,v 1.1 2008-02-22 10:39:48 hmdegaud Exp $
# Author: Marco Clemencic

set savedcmtroot=$CMTROOT
...
if ( $?LCG_release_area ) then
	...
	echo "Usage: source cleanup_external.csh [options] package1 [package2 ...]"
	echo ""
    ...
    # prepare the fake package, configure it and source cleanup.csh
	...
	if ( $? == 1 ) then
	    ...
	    source $__my__tempdir/cleanup.csh
