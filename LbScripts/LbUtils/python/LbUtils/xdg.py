# Free desktop specifications implementation
"""
...
Typical usage:
    ...
    for dir in load_config_paths('mydomain.org', 'MyProg', 'Options'):
...
xdg_log_home = os.environ.get('XDG_LOG_HOME',
            os.path.join(_home, '.log'))
