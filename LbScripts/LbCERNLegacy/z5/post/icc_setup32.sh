...
intelplat=`cd $LCG_Interfaces_gcc ; CMTCONFIG=i686-slc5-icc11-dbg cmt show set_value intelplat`
intel_home=`cd $LCG_Interfaces_gcc ; CMTCONFIG=i686-slc5-icc11-dbg cmt show set_value intel_home`
icc_c_home=`cd $LCG_Interfaces_gcc ; CMTCONFIG=i686-slc5-icc11-dbg cmt show set_value icc_c_home`
icc_f_home=`cd $LCG_Interfaces_gcc ; CMTCONFIG=i686-slc5-icc11-dbg cmt show set_value icc_f_home`
