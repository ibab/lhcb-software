...
if inputType == "MDF":
    ...
    EventSelector().Input = ["COLLECTION='TagCreator/EventTuple' DATAFILE='PFN:castor:/castor/cern.ch/user/c/cattanem/MC09-tests/" + datasetName + ".fetc'  TYP='POOL_ROOT' SEL='(StrippingGlobal==1)'"] # Generated by Stuart from MC09 DST
