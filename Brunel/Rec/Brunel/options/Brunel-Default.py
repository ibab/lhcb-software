...
###############################################################################
Brunel().EvtMax       = 10    # Number of events to process
...
# Brunel().veloOpen      = True # set to True for Velo open data
...
# Brunel().usePatSeeding = False # switch on PatSeeding, switch off TsaSeeding
