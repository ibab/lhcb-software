...
if inputType == "MDF":
    ...
    EventSelector().Input = ["COLLECTION='TagCreator/1' DATAFILE='PFN:root://castorlhcb.cern.ch//castor/cern.ch/user/p/pkoppenb/Stripping/" + datasetName + ".root?svcClass=default'  TYP='POOL_ROOTTREE' SEL='(GlobalOr>=1)'"] # Generated by Joel from DC06 rDSTs
