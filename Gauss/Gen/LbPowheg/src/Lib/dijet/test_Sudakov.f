...
c the two results are compared.
      ...
      real * 8 dijet_random,dijet_pwhg_pt2,dijet_powheginput
      character * 35 string
      external dijet_random,dijet_pwhg_pt2,dijet_powheginput
      ...
      if(ini) then
         ...
         open(unit=iun,file='dijet_testsuda.top',
     #        status='unknown')
