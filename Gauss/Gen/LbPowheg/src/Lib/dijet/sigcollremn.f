      subroutine dijet_btildecoll(xrad,rescoll,www)
      implicit none
...
c same, with dijet_soft limit s
...
c get pdfs at underlying born x/z value values
      call dijet_pdfcall(1,kn_xb1/z1,pdfs1)
      call dijet_pdfcall(2,kn_xb2/z2,pdfs2)
...
c gq remnant
     ...
     #    *br_born(jb)*st_alpha/(2*pi)*kn_jacborn
      ...
      if(flg_nlotest) then
         tot=tot*www
         call dijet_analysis_driver(tot,0)
      endif
      end
