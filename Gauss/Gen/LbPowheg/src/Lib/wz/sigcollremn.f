      subroutine wz_btildecoll(xrad,rescoll,www)
      implicit none
...
c get pdfs at underlying born x/z value values
      call wz_pdfcall(1,kn_xb1/z1,pdfs1)
      call wz_pdfcall(2,kn_xb2/z2,pdfs2)
