      subroutine ww_btildecoll(xrad,rescoll,www)
      implicit none
...
c get pdfs at underlying born x/z value values
      call ww_pdfcall(1,kn_xb1/z1,pdfs1)
      call ww_pdfcall(2,kn_xb2/z2,pdfs2)
