      subroutine ww_phi1_2(x3,x4,p1,p2,p3,
     .     m2,m3,wt)
...
c     (2 pi) delta(p2^2-m2^2) (2 pi) delta(p3^2-m3^2)
      ...
      if (s1 .lt. 0d0) stop 'ww_phi1_2: s1 < 0 ' 
      m1=dsqrt(s1)
...
c         write(*,*) 'ww_phi1_2: one of E1,E2,E3 < 0'
c         call exit(-1)
c      endif
