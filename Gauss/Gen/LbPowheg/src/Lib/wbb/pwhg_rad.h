...
c 1 for wbb_btilde event, 2 for remnant, 3 for regular
      integer rad_type
c Signed total, absolute value total, positive total and negative total
c obtained in the integration of wbb_btilde
      real * 8
...
c value of wbb_btilde for each given underlying Born;
...
c a call to wbb_sigreal_rad, according to the mapping rad_realalr
...
c radiation variables in wbb_sigremnant call
