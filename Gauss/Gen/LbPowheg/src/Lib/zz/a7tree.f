      double complex function zz_A7trees(j1,j2,j3,j4,j5,j6,j7,za,zb)
      implicit none
!      include 'src/Lib/zz/constants.f'
      include 'src/Lib/zz/zprods_decl.h'
c---  DKS Eq. 3.15
      integer j1,j2,j3,j4,j5,j6,j7
      double complex zz_A7treea
     
      zz_A7trees=zz_A7treea(j1,j2,j3,j4,j5,j6,j7,za,zb)
     .       +zz_A7treea(j1,j2,j6,j5,j4,j3,j7,za,zb)
        
      return
      end
        
      double complex function zz_A7treea(j1,j2,j3,j4,j5,j6,j7,za,zb)
