      subroutine zz_gen_leshouches_reg
      implicit none
...
c     Don'zz_t forget to set scale for scalup equal to the pt of the 
c     radiation (whatever it is now!)
c     set color connections for all particles
      write(*,*) 'zz_gen_leshouches_reg: dummy interface to regular'//
     1           ' contributions'
