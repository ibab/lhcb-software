      subroutine vbf_h_gen_born_phsp(xborn)
      implicit none
      include 'src/Lib/vbf_h/nlegborn.h'
      include 'src/Lib/vbf_h/pwhg_flst.h'
      real * 8 xborn(ndiminteg-3)
      call vbf_h_born_phsp(xborn)
      call vbf_h_compute_csimax_fsr
      end


      subroutine vbf_h_compute_csimax_fsr
      implicit none
