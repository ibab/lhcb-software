...
c 1 for w_btilde event, 2 for remnant, 3 for regular
      integer rad_type
c Signed total, absolute value total, positive total and negative total
c obtained in the integration of w_btilde
      real * 8
...
c value of w_btilde for each given underlying Born;
...
c a call to w_sigreal_rad, according to the mapping rad_realalr
...
c radiation variables in w_sigremnant call
