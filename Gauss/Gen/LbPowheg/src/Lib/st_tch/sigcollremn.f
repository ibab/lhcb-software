      subroutine st_tch_btildecoll(xrad,rescoll,www)
      implicit none
...
c same, with st_tch_soft limit s
...
c get pdfs at underlying born x st_tch_values
      call st_tch_pdfcall(1,kn_xb1,pdfb1)
      call st_tch_pdfcall(2,kn_xb2,pdfb2)
c get pdfs at underlying born x/z value st_tch_values
      call st_tch_pdfcall(1,kn_xb1/z1,pdfs1)
      call st_tch_pdfcall(2,kn_xb2/z2,pdfs2)
...
c gq remnant
     ...
     #    *br_born(jb)*st_alpha/(2*pi)*kn_jacborn
      ...
      if(flg_nlotest) then
         tot=tot*www
         call st_tch_analysis_driver(tot,0)
      endif
      end
