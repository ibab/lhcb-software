      SUBROUTINE st_tch_Sudx_tbx(P1,ANS)
C  
...
C  
      ...
      common/st_tch_to_amps_udx_tbx/  amp2udx_tbx,       jamp2udx_tbx
      ...
      common/st_tch_to_matrix_udx_tbx/isum_hel, multi_channel
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=st_tch_udx_tbx(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     $             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION st_tch_udx_tbx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL st_tch_jioxxx(W(1,1   ),W(1,2   ),GWF ,WMASS   ,WWIDTH  ,W(1,5   ))    
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          st_tch_udx_tbx =st_tch_udx_tbx+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
