...
c 1 for st_tch_btilde event, 2 for remnant, 3 for regular
      integer rad_type
c Signed total, absolute value total, positive total and negative total
c obtained in the integration of st_tch_btilde
      real * 8
...
c value of st_tch_btilde for each given underlying Born;
...
c a call to st_tch_sigreal_rad, according to the mapping rad_realalr
...
c radiation variables in st_tch_sigremnant call
