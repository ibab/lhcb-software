...
c the two results are compared.
      ...
      real * 8 st_tch_random,st_tch_pwhg_pt2,st_tch_powheginput
      character * 35 string
      external st_tch_random,st_tch_pwhg_pt2,st_tch_powheginput
      ...
      if(ini) then
         ...
         open(unit=iun,file='st_tch_testsuda.top',
     #        status='unknown')
