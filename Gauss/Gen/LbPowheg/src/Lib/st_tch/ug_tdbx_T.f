      SUBROUTINE st_tch_Sug_tdbx_T(P1,ANS)
C  
...
C  
      ...
      common/st_tch_to_amps_ug_tdbx_T/  amp2ug_tdbx_T,       jamp2ug_tdbx_T
      ...
      common/st_tch_to_matrix_ug_tdbx_T/isum_hel, multi_channel
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=st_tch_ug_tdbx_T(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     $             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION st_tch_ug_tdbx_T(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      st_tch_ug_tdbx_T = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          st_tch_ug_tdbx_T =st_tch_ug_tdbx_T+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      !st_tch_ug_tdbx_T=12d0*jamp(2)*dconjg(jamp(2)) !!!!!!!!!!!!!!!!!!!
      Do I = 1, NGRAPHS
