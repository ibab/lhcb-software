      SUBROUTINE st_tch_Sgdx_epvebuxbx_T(P1,ANS)
C  
...
C  
      ...
      common/st_tch_to_amps_gdx_epvebuxbx_T/  amp2gdx_epvebuxbx_T,       jamp2gdx_epvebuxbx_T
      ...
      common/st_tch_to_matrix_gdx_epvebuxbx_T/isum_hel, multi_channel
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=st_tch_gdx_epvebuxbx_T(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     $             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION st_tch_gdx_epvebuxbx_T(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
!ER:      CALL st_tch_fvoxxx(W(1,9   ),W(1,1   ),GG ,TMASS   ,TWIDTH  ,W(1,14  ))     
      ...
      JAMP(   2) = -AMP(   2)-AMP(   3)
      st_tch_gdx_epvebuxbx_T = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          st_tch_gdx_epvebuxbx_T =st_tch_gdx_epvebuxbx_T+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
