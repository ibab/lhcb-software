c     !ER:
      SUBROUTINE st_tch_Sgdx_tuxbx_S(P1,ANS)
C  
...
C  
      ...
      common/st_tch_to_amps_gdx_tuxbx_S/  amp2gdx_tuxbx_S,       jamp2gdx_tuxbx_S
      ...
      common/st_tch_to_matrix_gdx_tuxbx_S/isum_hel, multi_channel
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=st_tch_gdx_tuxbx_S(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     $             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION st_tch_gdx_tuxbx_S(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL st_tch_fvixxx(W(1,4   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,6   ))     
      CALL st_tch_jioxxx(W(1,5   ),W(1,3   ),GWF ,WMASS   ,WWIDTH  ,W(1,7   ))    
      CALL st_tch_iovxxx(W(1,6   ),W(1,2   ),W(1,7   ),GWF ,AMP(1   ))            
      CALL st_tch_jioxxx(W(1,4   ),W(1,2   ),GWF ,WMASS   ,WWIDTH  ,W(1,8   ))    
      CALL st_tch_fvixxx(W(1,5   ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,9   ))     
      CALL st_tch_iovxxx(W(1,9   ),W(1,3   ),W(1,8   ),GWF ,AMP(2   ))            
      CALL st_tch_fvoxxx(W(1,3   ),W(1,1   ),GG ,TMASS   ,TWIDTH  ,W(1,10  ))     
      CALL st_tch_iovxxx(W(1,5   ),W(1,10  ),W(1,8   ),GWF ,AMP(3   ))            
      CALL st_tch_fvoxxx(W(1,2   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,11  ))     
      CALL st_tch_jioxxx(W(1,4   ),W(1,11  ),GWF ,WMASS   ,WWIDTH  ,W(1,12  ))    
      CALL st_tch_iovxxx(W(1,5   ),W(1,3   ),W(1,12  ),GWF ,AMP(4   ))            
      JAMP(   1) = -AMP(   1)-AMP(   4)
      JAMP(   2) = (0d0,0d0)!ER:-AMP(   2)-AMP(   3)
      st_tch_gdx_tuxbx_S = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          st_tch_gdx_tuxbx_S =st_tch_gdx_tuxbx_S+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
