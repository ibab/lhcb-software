      SUBROUTINE st_tch_Sub_tdg(P1,ANS)
C  
...
C  
      ...
      common/st_tch_to_amps_ub_tdg/  amp2ub_tdg,       jamp2ub_tdg
      ...
      common/st_tch_to_matrix_ub_tdg/isum_hel, multi_channel
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=st_tch_ub_tdg(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     $             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION st_tch_ub_tdg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL st_tch_fvoxxx(W(1,4   ),W(1,6   ),GWF ,ZERO    ,ZERO    ,W(1,7   ))    
      CALL st_tch_iovxxx(W(1,1   ),W(1,7   ),W(1,5   ),GG ,AMP(1   ))             
      CALL st_tch_jioxxx(W(1,1   ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,8   ))    
      ...
      CALL st_tch_fvixxx(W(1,1   ),W(1,6   ),GWF ,ZERO    ,ZERO    ,W(1,11  ))    
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          st_tch_ub_tdg =st_tch_ub_tdg+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
