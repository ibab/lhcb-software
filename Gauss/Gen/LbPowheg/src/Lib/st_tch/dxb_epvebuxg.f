      SUBROUTINE st_tch_Sdxb_epvebuxg(P1,ANS)
C  
...
C  
C FOR PROCESS : d~ b -> e+ ve b u~ g  
C  
C Crossing   1 is d~ b -> e+ ve b u~ g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C GLOBAL VARIABLES
C  
      Double Precision amp2dxb_epvebuxg(maxamps), jamp2dxb_epvebuxg(0:maxamps)
      common/st_tch_to_amps_dxb_epvebuxg/  amp2dxb_epvebuxg,       jamp2dxb_epvebuxg
      ...
      common/st_tch_to_matrix_dxb_epvebuxg/isum_hel, multi_channel
...
C ----------
      ...
      IF (.false.) THEN
          DO IHEL=1,NGRAPHS
              amp2dxb_epvebuxg(ihel)=0d0
              jamp2dxb_epvebuxg(ihel)=0d0
          ENDDO
          DO IHEL=1,int(jamp2dxb_epvebuxg(0))
              jamp2dxb_epvebuxg(ihel)=0d0
          ENDDO
      ENDIF
      ANS(IPROC) = 0D0
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=st_tch_dxb_epvebuxg(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     $             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      IF (.false.) THEN
          ...
          DO IHEL=1,MAPCONFIG(0)
              XTOT=XTOT+amp2dxb_epvebuxg(MAPCONFIG(IHEL))
          ENDDO
          IF (XTOT.NE.0D0) THEN
              ANS(IPROC)=ANS(IPROC)*amp2dxb_epvebuxg(MAPCONFIG(ICONFIG))/XTOT
          ELSE
              ANS(IPROC)=0D0
          ENDIF
      ENDIF
      ...
      REAL*8 FUNCTION st_tch_dxb_epvebuxg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C BEGIN CODE
C ----------
      CALL st_tch_oxxxxx(P(0,1   ),ZERO ,NHEL(1   ),-1*IC(1   ),W(1,1   ))        
      CALL st_tch_ixxxxx(P(0,2   ),BMASS ,NHEL(2   ),+1*IC(2   ),W(1,2   ))       
      CALL st_tch_ixxxxx(P(0,3   ),ZERO ,NHEL(3   ),-1*IC(3   ),W(1,3   ))        
      CALL st_tch_oxxxxx(P(0,4   ),ZERO ,NHEL(4   ),+1*IC(4   ),W(1,4   ))        
      CALL st_tch_oxxxxx(P(0,5   ),BMASS ,NHEL(5   ),+1*IC(5   ),W(1,5   ))       
      CALL st_tch_ixxxxx(P(0,6   ),ZERO ,NHEL(6   ),-1*IC(6   ),W(1,6   ))        
      CALL st_tch_vxxxxx(P(0,7   ),ZERO ,NHEL(7   ),+1*IC(7   ),W(1,7   ))        
      CALL st_tch_jioxxx(W(1,3   ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,8   ))    
      CALL st_tch_fvoxxx(W(1,5   ),W(1,8   ),GWF ,TMASS   ,TWIDTH  ,W(1,9   ))    
      CALL st_tch_fvoxxx(W(1,1   ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,10  ))     
      CALL st_tch_jioxxx(W(1,2   ),W(1,9   ),GWF ,WMASS   ,WWIDTH  ,W(1,11  ))    
      CALL st_tch_iovxxx(W(1,6   ),W(1,10  ),W(1,11  ),GWF ,AMP(1   ))            
      CALL st_tch_fvixxx(W(1,2   ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,12  ))     
      CALL st_tch_jioxxx(W(1,12  ),W(1,9   ),GWF ,WMASS   ,WWIDTH  ,W(1,13  ))    
      CALL st_tch_iovxxx(W(1,6   ),W(1,1   ),W(1,13  ),GWF ,AMP(2   ))            
      CALL st_tch_fvoxxx(W(1,5   ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,14  ))     
      CALL st_tch_fvoxxx(W(1,14  ),W(1,8   ),GWF ,TMASS   ,TWIDTH  ,W(1,15  ))    
      CALL st_tch_jioxxx(W(1,2   ),W(1,15  ),GWF ,WMASS   ,WWIDTH  ,W(1,16  ))    
      CALL st_tch_iovxxx(W(1,6   ),W(1,1   ),W(1,16  ),GWF ,AMP(3   ))            
      CALL st_tch_fvoxxx(W(1,1   ),W(1,11  ),GWF ,ZERO    ,ZERO    ,W(1,17  ))    
      CALL st_tch_iovxxx(W(1,6   ),W(1,17  ),W(1,7   ),GG ,AMP(4   ))             
c!ER:      CALL st_tch_fvoxxx(W(1,9   ),W(1,7   ),GG ,TMASS   ,TWIDTH  ,W(1,18  ))     
      CALL st_tch_fvoxxx(W(1,9   ),W(1,7   ),GG ,TMASS   ,ZERO  ,W(1,18  ))     
      CALL st_tch_jioxxx(W(1,2   ),W(1,18  ),GWF ,WMASS   ,WWIDTH  ,W(1,19  ))    
      CALL st_tch_iovxxx(W(1,6   ),W(1,1   ),W(1,19  ),GWF ,AMP(5   ))            
      JAMP(   1) = -AMP(   1)-AMP(   4)
c     !ER: removed gluon emission from decay leg
c      JAMP(   2) = -AMP(   2)-AMP(   3)-AMP(   5)
      JAMP(   2) = -AMP(   2)-AMP(   5)
      st_tch_dxb_epvebuxg = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          st_tch_dxb_epvebuxg =st_tch_dxb_epvebuxg+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
          amp2dxb_epvebuxg(i)=amp2dxb_epvebuxg(i)+amp(i)*dconjg(amp(i))
      Enddo
      Do I = 1, NCOLOR
          Jamp2dxb_epvebuxg(i)=Jamp2dxb_epvebuxg(i)+Jamp(i)*dconjg(Jamp(i))
      Enddo
