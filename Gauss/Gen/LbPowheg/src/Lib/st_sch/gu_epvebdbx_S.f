      SUBROUTINE st_sch_Sgu_epvebdbx_S(P1,ANS)
C  
...
C  
      ...
      common/st_sch_to_amps_gu_epvebdbx_S/  amp2gu_epvebdbx_S,       jamp2gu_epvebdbx_S
      ...
      common/st_sch_to_matrix_gu_epvebdbx_S/isum_hel, multi_channel
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=st_sch_gu_epvebdbx_S(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     $             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION st_sch_gu_epvebdbx_S(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL st_sch_fvixxx(W(1,2   ),W(1,10  ),GWF ,ZERO    ,ZERO    ,W(1,11  ))    
      CALL st_sch_iovxxx(W(1,11  ),W(1,6   ),W(1,1   ),GG ,AMP(1   ))             
      CALL st_sch_fvixxx(W(1,7   ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,12  ))     
      CALL st_sch_jioxxx(W(1,12  ),W(1,9   ),GWF ,WMASS   ,WWIDTH  ,W(1,13  ))    
      CALL st_sch_iovxxx(W(1,2   ),W(1,6   ),W(1,13  ),GWF ,AMP(2   ))            
      CALL st_sch_fvoxxx(W(1,9   ),W(1,1   ),GG ,TMASS   ,TWIDTH  ,W(1,14  ))     
      CALL st_sch_jioxxx(W(1,7   ),W(1,14  ),GWF ,WMASS   ,WWIDTH  ,W(1,15  ))    
      CALL st_sch_iovxxx(W(1,2   ),W(1,6   ),W(1,15  ),GWF ,AMP(3   ))            
      CALL st_sch_fvixxx(W(1,2   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,16  ))     
      CALL st_sch_iovxxx(W(1,16  ),W(1,6   ),W(1,10  ),GWF ,AMP(4   ))            
      JAMP(   1) = +AMP(   1)+AMP(   4)
      JAMP(   2) = (0d0,0d0)!ER:+AMP(   2)+AMP(   3)
      st_sch_gu_epvebdbx_S = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          st_sch_gu_epvebdbx_S =st_sch_gu_epvebdbx_S+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
