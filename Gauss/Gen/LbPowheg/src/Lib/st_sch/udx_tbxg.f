      SUBROUTINE st_sch_Sudx_tbxg(P1,ANS)
C  
...
C  
      ...
      common/st_sch_to_amps_udx_tbxg/  amp2udx_tbxg,       jamp2udx_tbxg
      ...
      common/st_sch_to_matrix_udx_tbxg/isum_hel, multi_channel
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=st_sch_udx_tbxg(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     $             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION st_sch_udx_tbxg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL st_sch_fvixxx(W(1,1   ),W(1,5   ),GG ,ZERO    ,ZERO    ,W(1,7   ))     
      CALL st_sch_iovxxx(W(1,7   ),W(1,2   ),W(1,6   ),GWF ,AMP(1   ))            
      CALL st_sch_fvoxxx(W(1,2   ),W(1,5   ),GG ,ZERO    ,ZERO    ,W(1,8   ))     
      CALL st_sch_iovxxx(W(1,1   ),W(1,8   ),W(1,6   ),GWF ,AMP(2   ))            
      CALL st_sch_jioxxx(W(1,1   ),W(1,2   ),GWF ,WMASS   ,WWIDTH  ,W(1,9   ))    
      ...
      JAMP(   1) = -AMP(   1)-AMP(   2)
      JAMP(   2) = -AMP(   3)-AMP(   4)
      st_sch_udx_tbxg = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          st_sch_udx_tbxg =st_sch_udx_tbxg+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
