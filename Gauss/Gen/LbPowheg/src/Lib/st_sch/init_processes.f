      subroutine st_sch_init_processes
      implicit none
...
c     decide t or tbar process
      ttype=st_sch_powheginput('ttype')
      if(abs(ttype).ne.1) then
         write(*,*) 'Unrecognised ttype in input file'
         write(*,*) 'admitted st_sch_values: 1 for t, -1 for tbar'
         call exit(1)
      endif
ccccccccccccccccccccccccccccccc      
...
cccccccccccccccccccccccccccccccccccccc
      ...
      return
 998  write(*,*) 'st_sch_init_processes: increase maxprocreal'
      call exit(1)
 999  write(*,*) 'st_sch_init_processes: increase maxprocborn'
      call exit(1)
      end
