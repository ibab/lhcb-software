      SUBROUTINE st_sch_Sdxb_tux(P1,ANS)
C  
...
C  
      ...
      common/st_sch_to_amps_dxb_tux/  amp2dxb_tux,       jamp2dxb_tux
      ...
      common/st_sch_to_matrix_dxb_tux/isum_hel, multi_channel
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=st_sch_dxb_tux(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     $             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION st_sch_dxb_tux(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL st_sch_iovxxx(W(1,4   ),W(1,1   ),W(1,5   ),GWF ,AMP(1   ))            
      JAMP(   1) = -AMP(   1)
      st_sch_dxb_tux = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          ...
          ENDDO
          st_sch_dxb_tux =st_sch_dxb_tux+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
