...
c     POWHEG COMMON BLOCK (PHYSICAL PARAMETERS)
      common/st_sch_cewparam/alphaem_pow,gfermi_pow,sthw2_pow,topmass_pow,
     ...
     #     zmass_pow,wmass_pow
      ...
      common/st_sch_cwidth/topwidth_pow,wwidth_pow
      real *8 topwidth_pow,wwidth_pow

      common/st_sch_cckm/CKM_pow,CKM,dCKM_pow
      real *8 CKM_pow(3,3),CKM(1:6,1:6),dCKM_pow(3,3)

c     POWHEG COMMON BLOCK (PHASE SPACE GENERATION)
      integer psgen
      real *8 numgamma(2)
      common/st_sch_cphasespace/numgamma,psgen

c     T/TBAR
      integer ttype
      common/st_sch_cttype/ttype
