      SUBROUTINE st_sch_Sgu_epvebdbx_T(P1,ANS)
C  
...
C  
      ...
      common/st_sch_to_amps_gu_epvebdbx_T/  amp2gu_epvebdbx_T,       jamp2gu_epvebdbx_T
      ...
      common/st_sch_to_matrix_gu_epvebdbx_T/isum_hel, multi_channel
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=st_sch_gu_epvebdbx_T(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     $             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION st_sch_gu_epvebdbx_T(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
!ER:      CALL st_sch_fvoxxx(W(1,9   ),W(1,1   ),GG ,TMASS   ,TWIDTH  ,W(1,14  ))     
      ...
      JAMP(   2) = +AMP(   2)+AMP(   3)
      st_sch_gu_epvebdbx_T = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          st_sch_gu_epvebdbx_T =st_sch_gu_epvebdbx_T+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
