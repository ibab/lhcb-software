...
c the two results are compared.
      ...
      real * 8 st_sch_random,st_sch_pwhg_pt2,st_sch_powheginput
      character * 35 string
      external st_sch_random,st_sch_pwhg_pt2,st_sch_powheginput
      ...
      if(ini) then
         ...
         open(unit=iun,file='st_sch_testsuda.top',
     #        status='unknown')
