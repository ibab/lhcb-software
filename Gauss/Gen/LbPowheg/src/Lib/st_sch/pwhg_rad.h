...
c 1 for st_sch_btilde event, 2 for remnant, 3 for regular
      integer rad_type
c Signed total, absolute value total, positive total and negative total
c obtained in the integration of st_sch_btilde
      real * 8
...
c value of st_sch_btilde for each given underlying Born;
...
c a call to st_sch_sigreal_rad, according to the mapping rad_realalr
...
c radiation variables in st_sch_sigremnant call
