...
c the two results are compared.
      ...
      real * 8 hvq_random,hvq_pwhg_pt2,hvq_powheginput
      character * 35 string
      external hvq_random,hvq_pwhg_pt2,hvq_powheginput
      ...
      if(ini) then
         ...
         open(unit=iun,file='hvq_testsuda.top',
     #        status='unknown')
