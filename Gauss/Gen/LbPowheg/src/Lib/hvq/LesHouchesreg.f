      subroutine hvq_gen_leshouches_reg
      implicit none
...
c     set color connections for all particles
      write(*,*) 'hvq_gen_leshouches_reg: dummy interface to regular'//
     1           ' contributions'
      write(*,*) ' Replace with your own hvq_process-dependent one, to be'
      write(*,*) ' put in the hvq_process-specific directory (e.g. /W,'//'
     #     /Z, /VBF_H...)'
      write(*,*) ' The Makefile will automatically compile the version'
      write(*,*) ' in the hvq_process-specific directory'
      call exit(1)
      end
