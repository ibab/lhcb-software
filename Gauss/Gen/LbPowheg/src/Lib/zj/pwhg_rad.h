...
c 1 for zj_btilde event, 2 for remnant, 3 for regular
      integer rad_type
c Signed total, absolute value total, positive total and negative total
c obtained in the integration of zj_btilde
      real * 8
...
c value of zj_btilde for each given underlying Born;
...
c a call to zj_sigreal_rad, according to the mapping rad_realalr
...
c radiation variables in zj_sigremnant call
