      subroutine zj_gen_leshouches_reg
      implicit none
...
c     Don't forget to set zj_scale for scalup equal to the pt of the 
c     radiation (whatever it is now!)
c     set color connections for all particles
      write(*,*) 'zj_gen_leshouches_reg: dummy interface to regular'//
     1           ' contributions'
