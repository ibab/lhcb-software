...
c independent flavour structures for the vbf_wp_wp_born and real process.
c
...
c of the vbf_wp_wp_born and real subprocesses.
...
c It is required that legs in the vbf_wp_wp_born and real processes
...
c be the same for all real and vbf_wp_wp_born subprocesses.
...
c     born2alr(0,k) = number of alpha_r with underlying vbf_wp_wp_born k
c     born2alr(1.. born2alr(0,k),k)= pointer to corresponding alpha_r
      ...
      common/vbf_wp_wp_pwhg_flst/flst_nborn, flst_born,flst_borntags,
