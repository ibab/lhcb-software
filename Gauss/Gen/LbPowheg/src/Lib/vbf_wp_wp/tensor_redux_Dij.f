...
C                vbf_wp_wp_tens_red4 = 4-point tensors
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      subroutine vbf_wp_wp_tens_red4(psq, qsq, lsq, pq, pl, ql, 
...
C         C0_123 = vbf_wp_wp_C0(1,2,3) = vbf_wp_wp_C0(p,q)     scalar three point 
C         C0_124 = vbf_wp_wp_C0(1,2,4) = vbf_wp_wp_C0(p,q+l)  functions in PV notation
C         C0_134 = vbf_wp_wp_C0(1,3,4) = vbf_wp_wp_C0(p+q,l)
C         C0_234 = vbf_wp_wp_C0(2,3,4) = vbf_wp_wp_C0(q,l)
C         Cij_123(n,m) = C_nm(1,2,3) ....    higher C_nm form factors
C                                            as in vbf_wp_wp_tens_red3
...
c
      ...
      call vbf_wp_wp_prod_mat_col3(Xm1,R(1),res)
      Dij(1,1) = res(1)
      Dij(1,2) = res(2)
      Dij(1,3) = res(3)
...
c Dij(1,10)=D419, Dij(1,11)=D420, Dij(1,12)=D421, D(1,13)=D422
     ...
     \     2d0*ql*Dij(1,12))/6d0
      ...
      subroutine vbf_wp_wp_prod_mat_col3(M,col,res)
      implicit none
      real * 8 M(1:3,1:3)
