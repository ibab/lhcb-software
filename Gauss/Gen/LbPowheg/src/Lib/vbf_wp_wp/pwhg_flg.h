...
c flg_withdamp: vbf_wp_wp_born zero procedure
c flg_withreg: if regular regions exist or not
c flg_smartsig: remember or not equal squared amplitude
c flg_bornonly: do the vbf_wp_wp_born contribution only

c flg_lightpart_check: in vbf_wp_wp_genflavreglist perform or not perform the check
c                     that there are no coloured light partons before flst_lightpart
     ...
     3     flg_lightpart_check
      common/vbf_wp_wp_pwhg_flg/flg_nlotest,flg_withsubtr,flg_withdamp,
