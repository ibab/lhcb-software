...
C                vbf_wp_wp_tens_red3 = 3-point tensors
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      subroutine vbf_wp_wp_tens_red3(psq, qsq, pq_sq, B0_23, B0_13, B0_12, 
     #                     vbf_wp_wp_C0, Cij)
      implicit none
      real * 8  psq, qsq, pq_sq
      complex*16 B0_23, B0_13, B0_12, vbf_wp_wp_C0, Cij(2,4), Cijp(2,4)
c
c  determine the Passarino-Veltman tensor decomposition for the three-point
c  tensor integrals
c
c                       d^4k           1;  k_mu;   k_mu k_nu
c vbf_wp_wp_C0;C_mu;C_munu =Int -------  -----------------------------------------
...
c                                  in PV notation:
c         vbf_wp_wp_B0(1) = vbf_wp_wp_B0(1,2) = vbf_wp_wp_B0(p)  B_0 function with subtraction of 
c         vbf_wp_wp_B0(2) = vbf_wp_wp_B0(2,3) = vbf_wp_wp_B0(q)  divergent term
c         vbf_wp_wp_B0(3) = vbf_wp_wp_B0(1,3) = vbf_wp_wp_B0(p+q)
c
...
c      B0_12 = vbf_wp_wp_B0(1)
c      B0_23 = vbf_wp_wp_B0(2)
c      B0_13 = vbf_wp_wp_B0(3)
...
c 1-2
      R(1) = 0.5d0*(B0_13-B0_23+f1*vbf_wp_wp_C0)
      R(2) = 0.5d0*(B0_12-B0_13+f2*vbf_wp_wp_C0)
      call vbf_wp_wp_prod_mat_col2(Xm1,R(1),res)
      Cij(1,1) = res(1)
      Cij(1,2) = res(2)
...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      Cij(2,4) = 0.5d0*( + 0.5d0*B0_23 + m**2*vbf_wp_wp_C0
...
c 4-6
      ...
      subroutine vbf_wp_wp_prod_mat_col2(M,col,res)
      implicit none
      real * 8 M(1:2,1:2)
