      function vbf_wp_wp_virt_pent(q1s,q2s,pq1,pq2,ppp,ppq1,ppq2,q1q2)
      implicit none
      complex * 16 vbf_wp_wp_virt_pent
     ...
     #     gp_mu1,gp_l_q_mu1,gp_mu3_q_mu1,gp_l_mu2_mu1
      include 'src/Lib/vbf_wp_wp/virtuals.h'
     ...
     #12345(4,4)
      vbf_wp_wp_virt_pent = t885+t1552+t2282+t2854+t3395+t3820+t4471+t5048
      end
