...
C                vbf_wp_wp_tens_red5 = 5-point tensors
C    (Dieter Zeppenfeld and Giuseppe Bozzi - November 2006)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      subroutine vbf_wp_wp_tens_red5(psq, qsq, lsq, tsq,
     #                     pq, pl, pt, ql, qt, lt, 
...
c          (this is done in vbf_wp_wp_d2pvtodd subroutine) 
...
C                                               as in vbf_wp_wp_tens_red3 and vbf_wp_wp_tens_red4
...
c  Rank-2
     ...
     &              detx04t*(dij_1234(2,7)-dij_2345(2,7)) )/detx4
      ...
      call vbf_wp_wp_d2pvtodd(4,d0_1234,dij_1234,dd1,dd2,dd3,dd300,dd400,dd40000)
      call vbf_wp_wp_d2pvtodd(3,d0_1235,dij_1235,dd1,dd2,dd3,dd300,dd400,dd40000)
      call vbf_wp_wp_d2pvtodd(2,d0_1245,dij_1245,dd1,dd2,dd3,dd300,dd400,dd40000)
      call vbf_wp_wp_d2pvtodd(1,d0_1345,dij_1345,dd1,dd2,dd3,dd300,dd400,dd40000)
      call vbf_wp_wp_d2pvtodd(0,d0_2345,dij_2345,dd1,dd2,dd3,dd300,dd400,dd40000)
...
c      endif
      ...
      subroutine vbf_wp_wp_prod_mat_col4(M,col,res)
      implicit none
      real * 8 M(1:4,1:4)
      ...
      subroutine vbf_wp_wp_d2pvtodd(n,d0,dij,dd1,dd2,dd3,dd300,dd400,dd40000)
      implicit none
