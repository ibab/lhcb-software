      DOUBLE PRECISION FUNCTION vbf_wp_wp_DILOG(X)                                       
                                                                                
      DOUBLE PRECISION X,Y,T,S,A,PI3,PI6,ZERO,ONE,HALF,MALF,MONE,MTWO           
      DOUBLE PRECISION C(0:18),H,vbf_wp_wp_alfa,vbf_wp_wp_B0,B1,B2                                  
      ...
      B2=B1                                                                     
    1 B1=vbf_wp_wp_B0                                                                     
      vbf_wp_wp_DILOG=-(S*(vbf_wp_wp_B0-H*B2)+A)                                                   
      RETURN                                                                    
      END                                                                       
