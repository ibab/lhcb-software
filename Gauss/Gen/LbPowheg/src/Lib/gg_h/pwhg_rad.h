...
c 1 for gg_h_btilde event, 2 for remnant, 3 for regular
      integer rad_type
c Signed total, absolute value total, positive total and negative total
c obtained in the integration of gg_h_btilde
      real * 8
...
c value of gg_h_btilde for each given underlying Born;
...
c a call to gg_h_sigreal_rad, according to the mapping rad_realalr
...
c radiation variables in gg_h_sigremnant call
