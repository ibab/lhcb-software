...
c the two results are compared.
      ...
      real * 8 gg_h_random,gg_h_pwhg_pt2,gg_h_powheginput
      character * 35 string
      external gg_h_random,gg_h_pwhg_pt2,gg_h_powheginput
      ...
      if(ini) then
         ...
         open(unit=iun,file='gg_h_testsuda.top',
     #        status='unknown')
