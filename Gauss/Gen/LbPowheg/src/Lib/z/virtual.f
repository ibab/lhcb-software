...
c     The as/(2pi) factor is attached at a later point
      subroutine z_setvirtual(p,vflav,virtual)
      implicit none
      ...
      s=2d0*z_dotp(p(0,1),p(0,2))
      call z_compborn(p,vflav,born,dummy)
...
c$$$
c$$$c     Like z_setvirtual, but it calculates only the independent
...
c$$$      implicit none
c$$$      include 'src/Lib/z/nlegborn.h'
c$$$      include 'src/Lib/z/pwhg_flst.h'
