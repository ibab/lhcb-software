...
c 1 for z_btilde event, 2 for remnant, 3 for regular
      integer rad_type
c Signed total, absolute value total, positive total and negative total
c obtained in the integration of z_btilde
      real * 8
...
c value of z_btilde for each given underlying Born;
...
c a call to z_sigreal_rad, according to the mapping rad_realalr
...
c radiation variables in z_sigremnant call
