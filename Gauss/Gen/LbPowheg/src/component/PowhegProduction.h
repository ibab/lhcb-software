...
protected: 
  ...
  void powhegInitialize( const std::string& process_name ) ;
...
private:
  ...
  StatusCode GenCutLHE(const std::string & process_name);
  ...
  int m_numevts; 	// number of events to be generated set on Gauss
  int pwhg_numevts; 	// number of events to be generated by PowhegProduction, this different from m_numevts because
			// GenerationCutsLHE efficiency is less that 100% (eg. Wbb -> ~20%) !!!
  ...
  std::string m_vdecaymodeWZ;			// decay mode for WZ and ZZ produztion, that comes from Powheg-BOX-V2
									// is a string variable to be independent from the name that will be put on the level of PB-V2 compilation
  ...
  std::string m_vdecaymodeZZ;			// decay mode for WZ and ZZ produztion, that comes from Powheg-BOX-V2
									// is a string variable to be independent from the name that will be put on the level of PB-V2 compilation
  
  // heavy quark production parameters  ( bb, cc, tt )
  //=============================================================================
