// $Id: DumpMC.cpp,v 1.4 2007-01-12 15:17:35 ranjard Exp $
// ============================================================================
...
// Print ordered HepMC
//=============================================================================
void DumpMC::orderedPrint( const HepMC::GenEvent * theEvent , 
                           std::ostream & ostr ) 
  const {
...
//=============================================================================
void DumpMC::orderedVertexPrint( HepMC::GenVertex * theVertex , 
                                 std::ostream & ostr ) const {
  char outline[80];
  if ( theVertex -> barcode()!=0 ) {
    if ( theVertex -> position() != HepLorentzVector(0,0,0,0) ) {
      sprintf( outline,
