// $Id: DumpMCDecay.cpp,v 1.6 2008-06-09 16:46:45 gcorti Exp $
...
//-----------------------------------------------------------------------------
// Implementation file for class : DumpMCDecay
//
...
//=============================================================================
DumpMCDecay::DumpMCDecay( const std::string& name , 
                          ISvcLocator*       isvc ) 
...
//=============================================================================
StatusCode DumpMCDecay::printDecay( const HepMC::GenParticle* particle, 
                                    std::ostream&  stream, 
