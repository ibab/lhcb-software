// $Id: EvtGenDecayInPhSp.cpp,v 1.23 2010-05-05 19:38:36 robbep Exp $
// Header file
#include "EvtGenDecayInPhSp.h"
//BOOST
...
//-----------------------------------------------------------------------------
// Implementation file for class : EvtGenDecayInPhSp
//
// 2011-08-16 : Alex Shires
//-----------------------------------------------------------------------------
// Declaration of the Tool Factory

DECLARE_TOOL_FACTORY( EvtGenDecayInPhSp );

//=============================================================================
// Standard constructor, initializes variables
//=============================================================================
EvtGenDecayInPhSp::EvtGenDecayInPhSp( const std::string& type,
  ...
  : EvtGenDecay ( type, name , parent ),
    ...
    m_limit ( 1000 )
{
    // Declare IEvtGenDecayInPhSp interface
...
// Destructor
//=============================================================================
EvtGenDecayInPhSp::~EvtGenDecayInPhSp( ) { }
//=============================================================================
// Initialize method
//=============================================================================
StatusCode EvtGenDecayInPhSp::initialize( ) {
  ...
  if ( msgLevel ( MSG::DEBUG ) )  debug() << "EvtGenDecayInPhSp initialized" << endmsg ;
...
// Finalize method
//=============================================================================
StatusCode EvtGenDecayInPhSp::finalize() {
  
  if ( msgLevel ( MSG::DEBUG ) )   debug() << "EvtGenDecayInPhSp finalized" << endmsg ;
...
StatusCode EvtGenDecayInPhSp::loadMap( ) {
...
//=============================================================================
StatusCode EvtGenDecayInPhSp::doEvtGenLoop( EvtParticle* & part , 
...
//=============================================================================
StatusCode EvtGenDecayInPhSp::generateSignalDecay( HepMC::GenParticle * theMother ,
                                             bool & flip) const {
