// $Id: DaughtersInLHCb.cpp,v 1.1 2006-10-01 22:41:29 robbep Exp $
// Include files 
...
static const  ToolFactory<DaughtersInLHCb>          s_factory ;
const        IToolFactory& DaughtersInLHCbFactory = s_factory ; 
