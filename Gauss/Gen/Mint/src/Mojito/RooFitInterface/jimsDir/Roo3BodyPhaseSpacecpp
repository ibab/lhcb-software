...
bool Roo3BodyPhaseSpace::boundaries(Double_t& s12Min
				    , Double_t& s12Max
				    , Double_t _s23
				    , Double_t _mumM
				    , Double_t _d1M
...
Roo3BodyPhaseSpace::Roo3BodyPhaseSpace(const char* name
				       , const char* title
				       , RooAbsReal& _m12sq
				       , RooAbsReal& _m23sq
				       , RooAbsReal& _mumM
...
Roo3BodyPhaseSpace::Roo3BodyPhaseSpace(const Roo3BodyPhaseSpace& other
					   , const char* name
				       )
...
bool Roo3BodyPhaseSpace::m12Boundaries(Double_t& m12sqMin
				       , Double_t& m12sqMax
				       ) const{
...
Int_t Roo3BodyPhaseSpace::getAnalyticalIntegral(RooArgSet& allVars
						, RooArgSet& analVars
...
Double_t Roo3BodyPhaseSpace::analyticalIntegral(Int_t code
						, const char* rangeName
						) const{
...
Int_t Roo3BodyPhaseSpace::getGenerator(const RooArgSet &dirVars
				       , RooArgSet &genVars
				       , Bool_t staticInitOK
				       ) const{
...
void Roo3BodyPhaseSpace::generateEvent(Int_t code){
  ...
  if(code == 3){
    ...
    //cout << " for m12sq = " << m12sq << ", [" << mi << ", " << ma
    //	 << "], I generated "
    //	 << genM23 << endl;
    m23sq = genM23;
    //cout << " generated m12, m23 " << m12sq << ", " << m23sq << endl;
  }else if(code == 1){
...
Double_t Roo3BodyPhaseSpace::evaluate() const{
