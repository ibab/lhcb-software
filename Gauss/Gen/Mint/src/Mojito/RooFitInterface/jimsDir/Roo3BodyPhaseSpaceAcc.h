...
#ifndef JROO3BODYPHASESPACEACC_H
#define JROO3BODYPHASESPACEACC_H
...
class Roo3BodyPhaseSpaceAcc : public RooAbsPhaseSpace{
 public: 
  Roo3BodyPhaseSpaceAcc(const char* name
		     , const char* title
		     , RooAbsReal& _m12sq
		     , RooAbsReal& _m23sq
		     , RooAbsReal& _mumM
  ...
  Roo3BodyPhaseSpaceAcc(const Roo3BodyPhaseSpaceAcc& copyMe
		     , const char* name=0);
  virtual TObject* clone(  const char* newname) const{
    return new Roo3BodyPhaseSpaceAcc(*this, newname);}
  inline virtual ~Roo3BodyPhaseSpaceAcc(){}
 ...
 private:
  ClassDef(Roo3BodyPhaseSpaceAcc, 0)
};
#endif
//
