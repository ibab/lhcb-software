...
bool readntuple()
{
	...
	output_ntuple->SetBranchAddress("kmcpx",&fpm[0]);
	output_ntuple->SetBranchAddress("kmcpy",&fpm[1]);
	output_ntuple->SetBranchAddress("kmcpz",&fpm[2]);
	
	
	output_ntuple->SetBranchAddress("ppcpx",&pp[0]);
	output_ntuple->SetBranchAddress("ppcpy",&pp[1]);
	output_ntuple->SetBranchAddress("ppcpz",&pp[2]);
