...
RooArgList& makeResonance(RooAbsReal& m12sq
 ...
 /*  SF_DtoVP* SF_omega
  ...
  // TArrayD realamp = KmkAmpR();
  //TArrayD imagamp= KmkAmpI();
  //Kamp Kdcy((Prefix+"Kdcy").c_str() ,(Prefix+"Kdcy").c_str()
  //          , m13sq, realamp,imagamp); 
  ...
  //  ResonanceList.add(*((Kamp*) Kdcy.clone()));
