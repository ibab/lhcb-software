...
namespace DKsPiPiResonances{
  ...
  RooRealVar omegaA ("omegaA","omegaAmplitude", 0.0390);
  RooRealVar omegaP ("omegaP","omegaPhase",     122.1*deg);
  RooRealVar omegaM ("omegaM","omegaMass", 0.7826);
  RooRealVar omegaW ("omegaW","omegaWidth", 0.0085);

  RooRealVar sigma1A ("sigma1A","sigma1Amplitude", 1.339);
  RooRealVar sigma1P ("sigma1P","sigma1Phase",     -174.6*deg);
  RooRealVar sigma1M ("sigma1M","sigma1Mass", 0.490);
  RooRealVar sigma1W ("sigma1W","sigma1Width", 0.406);

  RooRealVar sigma2A ("sigma2A","sigma2Amplitude", 0.263);
  RooRealVar sigma2P ("sigma2P","sigma2Phase",     176.7*deg);
  RooRealVar sigma2M ("sigma2M","sigma2Mass", 1.0244);
  RooRealVar sigma2W ("sigma2W","sigma2Width", 0.0892);

  RooRealVar f0_980A ("f0_980A","f0_980Amplitude", 0.448);
  RooRealVar f0_980P ("f0_980P","f0_980Phase",     -152.8*deg);
  RooRealVar f0_980M ("f0_980M","f0_980Mass", 0.975);
  RooRealVar f0_980W ("f0_980W","f0_980Width", 0.044); // badly known. PDG: 40-100 MeV
  RooRealVar f2_1270A ("f2_1270A","f2_1270Amplitude", 0.943);
  RooRealVar f2_1270P ("f2_1270P","f2_1270Phase",     -24.2*deg);
  RooRealVar f2_1270M ("f2_1270M","f2_1270Mass", 1.2754);
  RooRealVar f2_1270W ("f2_1270W","f2_1270Width", 0.1851);

  RooRealVar f0_1370A ("f0_1370A","f0_1370Amplitude", 1.361);
  RooRealVar f0_1370P ("f0_1370P","f0_1370Phase",     100.2*deg);
  ...
  RooRealVar rho1450A ("rho1450A","rho1450Amplitude",0.436);
  RooRealVar rho1450P ("rho1450P","rho1450Phase",37.3*deg);
  RooRealVar rho1450M ("rho1450M","rho1450Mass",1.406);
  RooRealVar rho1450W ("rho1450W","rho1450Width",0.455);

  RooRealVar Kstar892A ("Kstar892A","Kstar892Amplitude", 1.760);
  RooRealVar Kstar892P ("Kstar892P","Kstar892Phase",     130.5*deg);
  RooRealVar Kstar892ACs ("Kstar892ACs","Kstar892 Cab-sup Amplitude", 0.169);
  RooRealVar Kstar892PCs ("Kstar892PCs","Kstar892 Cab-sup Phase", -50.0*deg);
  RooRealVar Kstar892M ("Kstar892M","Kstar892Mass", 0.89166);
  RooRealVar Kstar892W ("Kstar892W","Kstar892Width", 0.0508);

  RooRealVar Kstar_1410A ("Kstar_1410A","Kstar_1410Amplitude", 0.208);
  RooRealVar Kstar_1410P ("Kstar_1410P","Kstar_1410Phase",     -166.4*deg);
  RooRealVar Kstar_1410M ("Kstar_1410M","Kstar_1410Mass", 1.414);
  RooRealVar Kstar_1410W ("Kstar_1410W","Kstar_1410Width", 0.232);

  RooRealVar Kstar0_1430A ("Kstar0_1430A","Kstar0_1430Amplitude", 2.394);
  RooRealVar Kstar0_1430P ("Kstar0_1430P","Kstar0_1430Phase",     -15.4*deg);
  RooRealVar Kstar0_1430ACs ("Kstar0_1430ACs","Kstar0_1430 Cab-sup Amplitude", 0.281);
  RooRealVar Kstar0_1430PCs ("Kstar0_1430PCs","Kstar0_1430 Cab-sup Phase", 5.10*deg);
  RooRealVar Kstar0_1430M ("Kstar0_1430M","Kstar0_1430Mass", 1.412);
  RooRealVar Kstar0_1430W ("Kstar0_1430W","Kstar0_1430Width", 0.294);

  
  RooRealVar Kstar2_1430A ("Kstar2_1430A","Kstar2_1430Amplitude", 1.129);
  RooRealVar Kstar2_1430P ("Kstar2_1430P","Kstar2_1430Phase",     -56.3*deg);
  RooRealVar Kstar2_1430ACs ("Kstar2_1430ACs","Kstar2_1430 Cab-sup Amplitude", 0.0847);
  RooRealVar Kstar2_1430PCs ("Kstar2_1430PCs","Kstar2_1430 Cab-sup Phase",-112.9*deg);
  RooRealVar Kstar2_1430M ("Kstar2_1430M","Kstar2_1430Mass", 1.4256);
  RooRealVar Kstar2_1430W ("Kstar2_1430W","Kstar2_1430Width", 0.0985);

  RooRealVar Kstar1680A ("Kstar1680A","Kstar1680Amplitude", 0.827);
  RooRealVar Kstar1680P ("Kstar1680P","Kstar1680Phase",     -147.8*deg);
  RooRealVar Kstar1680M ("Kstar1680M","Kstar1680Mass", 1.717);
  RooRealVar Kstar1680W ("Kstar1680W","Kstar1680Width", 0.322);
  
  RooRealVar NonResA ("NonResA","NonResAmplitude",4.911);
  RooRealVar NonResP ("NonResP","NonResPhase",131.3*deg);
  /*
  RooRealVar rhoA ("rhoA","rhoAmplitude", 1.0);
