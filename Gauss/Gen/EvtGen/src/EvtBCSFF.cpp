  ...
  if (idScalar == EvtPDL::getId("chi_c0").getId() ) { // Bc -> chi_c0
    if (whichfit == 3) { // FF from Wang et al 10.1103/PhysRevD.79.114018
      ...
      *f0f = f0f_0*exp(f0f_c1*ratio+f0f_c2*ratio*ratio);
      ...
      report(ERROR,"EvtGen") << "Must choose 0 (fpf = 1) or 3 (Wang).\n";  
      ::abort();
    }
  } else {
    report(ERROR,"EvtGen") << "Only chi_c0 implemented in EvtBCSFF.\n";  
    ::abort();
  }
}
...
void EvtBCSFF::getvectorff(EvtId, EvtId, double, double,
  ...
  report(ERROR,"EvtGen") << "Not implemented :getvectorff in EvtBCSFF.\n";  
  ::abort();
...
void EvtBCSFF::gettensorff(EvtId /*p*/, EvtId /*d*/, double /*t*/, double /*mass*/,
  ...
  report(ERROR,"EvtGen") << "Not implemented :gettensorff in EvtBCSFF.\n";  
  ::abort();
...
void EvtBCSFF::getbaryonff(EvtId, EvtId, double, double,
  ...
  report(ERROR,"EvtGen") << "Not implemented :getbaryonff in EvtBCSFF.\n";  
  ::abort();
...
void EvtBCSFF::getdiracff(EvtId, EvtId, double, double,
  ...
  report(ERROR,"EvtGen") << "Not implemented :getdiracff in EvtBCSFF.\n";
  ::abort();
...
void EvtBCSFF::getraritaff(EvtId, EvtId, double, double,
  ...
  report(ERROR,"EvtGen") << "Not implemented :getraritaff in EvtBCSFF.\n";
  ::abort();
