##  -*- python -*-  
# db file automatically generated by genconf on: Mon May 30 16:25:06 2011
...
def _fillCfgDb():
    ...
    cfgDb.add( configurable = 'OniaPairsProduction',
               package = 'LbOniaPairs',
               module  = 'LbOniaPairs.LbOniaPairsConf',
               lib     = 'LbOniaPairs' )
    return #_fillCfgDb
...
try:
    ...
    print "Py:ConfigurableDb   ERROR   ==> culprit is package [LbOniaPairs] !"
