// $Id: DaughtersInLHCbAndFromB.h,v 1.1.1.1 2009-01-20 13:27:50 wreece Exp $
#ifndef GENERATORS_DAUGHTERSINLHCBANDFROMB_H
#define GENERATORS_DAUGHTERSINLHCBANDFROMB_H 1
