# File for setting Beam conditions for April 2012 4 TeV forcing always a single
# interaction per bunch crossing
# Beam 4.0 TeV, beta* = 3m , emittance(normalized) ~ 2 micron
#
# Requires Gauss v40r0 or higher.
#
# Syntax is: 
#  gaudirun.py $APPCONFIGOPTS/Gauss/Beam4000GeV-md100-Apr2012-fix1.py
