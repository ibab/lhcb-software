#ifndef GENCUTS_DAUGHTERSINLHCBANDCUTSFORDSTAR3PI_H 
#define GENCUTS_DAUGHTERSINLHCBANDCUTSFORDSTAR3PI_H 1
...
/** @class DaughtersInLHCbAndCutsForDstar DaughtersInLHCbAndCutsForDstar3pi.h 
 *  
 ...
 *  @date   2012-02-07
 */
class DaughtersInLHCbAndCutsForDstar3pi : public GaudiTool, virtual public IGenCutTool {
public:
  /// Standard constructor
  DaughtersInLHCbAndCutsForDstar3pi( const std::string& type, 
                                     const std::string& name,
                                     const IInterface* parent);
  
  virtual ~DaughtersInLHCbAndCutsForDstar3pi( ); ///< Destructor
...
#endif // GENCUTS_DAUGHTERSINLHCDANDCUTSFORDSTAR3PI_H
