...
//
//
// $Id: CkvG4OpBoundaryProcess.hh,v 1.7 2009-07-03 11:59:49 seaso Exp $
...
////////////////////////////////////////////////////////////////////////
//
// File:        CkvG4OpBoundaryProcess.hh
...
// mail:        gum@triumf.ca
// modified for LHCb and renamed CkvG4OpBoundaryprocess  SE 1-4-2005.
// CVS version tag: 
////////////////////////////////////////////////////////////////////////

#ifndef GaussCherenkov_CkvG4OpBoundaryProcess_h
#define GaussCherenkov_CkvG4OpBoundaryProcess_h 1
...
enum CkvG4OpBoundaryProcessStatus {  Undefined,
...
class CkvG4OpBoundaryProcess : public G4VDiscreteProcess 
{
...
private:
        ...
        // CkvG4OpBoundaryProcess(const CkvG4OpBoundaryProcess &right);
...
public: // Without description
        ...
        CkvG4OpBoundaryProcess(const G4String& processName = "CkvG4OpBoundary",
                    G4ProcessType aType = fOptical);

	~CkvG4OpBoundaryProcess();
...
public: // With description
	...
	G4OpticalSurfaceModel GetModel() const;
        ...
        CkvG4OpBoundaryProcessStatus GetStatus() const;
...
private:
	...
	CkvG4OpBoundaryProcessStatus theStatus;
...
inline
void CkvG4OpBoundaryProcess::G4Swap(G4double* a, G4double* b) const
{
...
inline
void CkvG4OpBoundaryProcess::G4Swap(G4Material* a, G4Material* b) const
{
...
inline
void CkvG4OpBoundaryProcess::G4VectorSwap(G4ThreeVector* vec1,
...
inline
G4bool CkvG4OpBoundaryProcess::G4BooleanRand(const G4double prob) const
{
...
inline
G4ThreeVector CkvG4OpBoundaryProcess::G4IsotropicRand() const
{
...
inline
G4ThreeVector CkvG4OpBoundaryProcess::
...
inline
G4bool CkvG4OpBoundaryProcess::IsApplicable(const G4ParticleDefinition& 
					               aParticleType)
{
...
inline
G4OpticalSurfaceModel CkvG4OpBoundaryProcess::GetModel() const
{
   return theModel;
}

inline
CkvG4OpBoundaryProcessStatus CkvG4OpBoundaryProcess::GetStatus() const
{
   return theStatus;
}

inline
void CkvG4OpBoundaryProcess::SetModel(G4OpticalSurfaceModel model)
{
   theModel = model;
}

inline
void CkvG4OpBoundaryProcess::ChooseReflection()
{
...
inline
void CkvG4OpBoundaryProcess::DoAbsorption()
{
...
inline
void CkvG4OpBoundaryProcess::DoReflection()
{
...
#endif /* GaussCherenkov_CkvG4OpBoundaryProcess_h */
