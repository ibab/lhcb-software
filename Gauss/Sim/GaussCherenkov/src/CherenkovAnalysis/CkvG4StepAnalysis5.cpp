  ...
  if(aPostStepPoint->GetStepStatus() == fGeomBoundary ) {
    ...
    if(aParticle->GetDefinition() == G4OpticalPhoton::OpticalPhoton() ) {
	  ...
	  //            G4String  aPostVolNameM =std::string(aPostVolName,0,52);
       ...
       //           G4cout<<"G4stepanalysis5 : Now at rich2 mirror1  copynum "<< aPreVolName<<"   "
       //            <<aPostVolName<<"  "<< aPreVolNameSubStrSize<<"  "<< aPostVolNameSubStrSize
       //               <<"    "<<aCurrentCopyNum<< G4endl;
         ...
         //           <<aPostVolName<<"  "<<aPreVolNameSCSize<<"   "<< aPostVolNameSCSize
         //            <<"  Copy Num  "<< aCurrentCopyNum  << G4endl;
