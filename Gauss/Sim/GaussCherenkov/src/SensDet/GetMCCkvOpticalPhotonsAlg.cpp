// $Id: GetMCCkvOpticalPhotonsAlg.cpp,v 1.16 2009-07-17 13:46:12 jonrob Exp $
// Include files 
...
//-----------------------------------------------------------------------------
// Implementation file for class : GetMCCkvOpticalPhotonsAlg
//
...
//=============================================================================
GetMCCkvOpticalPhotonsAlg::GetMCCkvOpticalPhotonsAlg( const std::string& name,
...
// Destructor
//=============================================================================
GetMCCkvOpticalPhotonsAlg::~GetMCCkvOpticalPhotonsAlg() { }

//=============================================================================
// Main execution
//=============================================================================
StatusCode GetMCCkvOpticalPhotonsAlg::execute()
{
  ...
  *gigaSvc() >> hitscollections;
  ...
  if ( 0 != hitscollections )
  {
    ...
    for ( int iii=0; iii < RichG4HitCollectionName()->RichHCSize(); ++iii )
    {
      ...
      const CkvG4HitsCollection * myCollection =
...
//  Finalize
//=============================================================================
StatusCode GetMCCkvOpticalPhotonsAlg::finalize()
{
