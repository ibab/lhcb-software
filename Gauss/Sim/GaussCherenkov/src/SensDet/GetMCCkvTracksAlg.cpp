// $Id: GetMCCkvTracksAlg.cpp,v 1.8 2009-03-26 21:49:47 robbep Exp $
// Include files
...
//-----------------------------------------------------------------------------
// Implementation file for class : GetMCCkvTracksAlg
//
// 2014-08-30  : Sajan Easo, Modification for GaussCherenkov
...
//=============================================================================
GetMCCkvTracksAlg::GetMCCkvTracksAlg( const std::string& name,
...
// Destructor
//=============================================================================
GetMCCkvTracksAlg::~GetMCCkvTracksAlg() { }

//=============================================================================
// Initialization
//=============================================================================
StatusCode GetMCCkvTracksAlg::initialize()
{
...
// Main execution
//=============================================================================
StatusCode GetMCCkvTracksAlg::execute()
{
  debug() << "Execute" << endmsg;

  // Create the MCCkvTracks and put them in the TES
...
//  Finalize
//=============================================================================
StatusCode GetMCCkvTracksAlg::finalize()
{
