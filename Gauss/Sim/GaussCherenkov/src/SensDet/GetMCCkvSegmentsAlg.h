// $Id: GetMCCkvSegmentsAlg.h,v 1.4 2009-07-17 13:46:13 jonrob Exp $
#ifndef SENSDET_GetMCCkvSegmentsAlg_H
#define SENSDET_GetMCCkvSegmentsAlg_H 1
...
class GetMCCkvSegmentsAlg : public GetMCCkvInfoBase
{

public:

  /// Standard constructor
  GetMCCkvSegmentsAlg( const std::string& name, ISvcLocator* pSvcLocator );

  virtual ~GetMCCkvSegmentsAlg( ); ///< Destructor
...
#endif // SENSDET_GetMCCkvSegmentsAlg_H
