...
#ParticleGun.MaterialEval.PdgCode = 480000000 #geantino particle
...
# A regular grid of ng control the parameters for the generation in eta-phi.
...
#ParticleGun.MaterialEval.MaxEta = 4.5
