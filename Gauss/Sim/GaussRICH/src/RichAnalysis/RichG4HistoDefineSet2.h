...
private:
  ...
  IHistogram1D*         m_hNumHitCF4SatRandBackgr;
  IHistogram1D*         m_hNumHitCF4SatNoReflNoScintWithRandBackgr;
  IHistogram1D*          m_hNumTotHitCF4FullAcceptSatNonScintNoReflWithRandomBackgr ;
