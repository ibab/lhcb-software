...
G4int RichG4GeomProp::PixelXNumFromCoord(G4double localX) 
{
  return PixelPosFinder(localX,m_PixelXBoundary);
}

G4int RichG4GeomProp::PixelYNumFromCoord(G4double localY) 
{
  return PixelPosFinder(localY,m_PixelYBoundary);
}

G4int RichG4GeomProp::PixelPosFinder(G4double Xc, std::vector<G4double>aBound )
{
