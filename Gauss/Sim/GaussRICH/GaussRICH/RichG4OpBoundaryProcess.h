...
#ifndef RichG4OpBoundaryProcess_h
#define RichG4OpBoundaryProcess_h 1
...
enum RichG4OpBoundaryProcessStatus {  Undefined,
...
private:
        ...
        // RichG4OpBoundaryProcess(const RichG4OpBoundaryProcess &right);
...
public: // With description
	...
	G4OpticalSurfaceModel GetModel() const;
        ...
        RichG4OpBoundaryProcessStatus GetStatus() const;
...
private:
	...
	RichG4OpBoundaryProcessStatus theStatus;
...
inline
void RichG4OpBoundaryProcess::G4Swap(G4Material* a, G4Material* b) const
{
...
inline
void RichG4OpBoundaryProcess::G4VectorSwap(G4ThreeVector* vec1,
...
inline
G4bool RichG4OpBoundaryProcess::G4BooleanRand(const G4double prob) const
{
...
inline
G4ThreeVector RichG4OpBoundaryProcess::G4IsotropicRand() const
{
...
inline
G4ThreeVector RichG4OpBoundaryProcess::
...
inline
G4bool RichG4OpBoundaryProcess::IsApplicable(const G4ParticleDefinition& 
					               aParticleType)
{
...
inline
G4OpticalSurfaceModel RichG4OpBoundaryProcess::GetModel() const
{
   return theModel;
}

inline
RichG4OpBoundaryProcessStatus RichG4OpBoundaryProcess::GetStatus() const
{
   return theStatus;
}

inline
void RichG4OpBoundaryProcess::SetModel(G4OpticalSurfaceModel model)
{
   theModel = model;
}

inline
void RichG4OpBoundaryProcess::ChooseReflection()
{
...
inline
void RichG4OpBoundaryProcess::DoAbsorption()
{
...
inline
void RichG4OpBoundaryProcess::DoReflection()
{
...
#endif /* RichG4OpBoundaryProcess_h */
