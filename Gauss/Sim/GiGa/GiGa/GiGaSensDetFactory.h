...
/** @class GiGaSensDetFactory GiGaSensDetFactory.h 
 *
...
public:
  ...
  /// create the instance 
  virtual IGiGaSensDet*    instantiate( const std::string& name, 
  ...
  virtual StatusCode queryInterface(const InterfaceID& riid, void** ppI) 
  {
    ...
    ppI = 0 ; 
    if      ( IID_IGiGaSensDetFactory == riid ) 
      { *ppI = static_cast<IGiGaSensDetFactory*> (this); }
