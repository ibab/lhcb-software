...
StatusCode GiGaElementCnv::createRep( DataObject*     Object  , 
...
///
StatusCode GiGaElementCnv::updateRep( DataObject*     Object       , 
                                      IOpaqueAddress* /* Address */) 
{
  ///
  ...
  if( 0 != G4Element::GetElement( element->fullpath() ) ) 
  ...
  if( 0 == element->nOfIsotopes() ) /// simple element 
    ...
    {                                                               
      ...
      for( Iterator it = element->isotopes().begin() ;
        ...
        {
          G4Isotope* isotope = 
            G4Isotope::GetIsotope( it->second->fullpath() ); 
          if( 0 == isotope ) 
  ...
  if( 0 != G4Material::GetMaterial( element->fullpath() ) ) 
    { return StatusCode::SUCCESS; } 
