...
MuonDigitizationData(const std::string & path, MsgStream* mlog, IDataProviderSvc* eveSvc,
...
{std::string("M1/R1"),std::string("M1/R2"),std::string("M1/R3"),std::string("M1/R4"),
std::string("M2/R1"),std::string("M2/R2"),std::string("M2/R3"),std::string("M2/R4"),
std::string("M3/R1"),std::string("M3/R2"),std::string("M3/R3"),std::string("M3/R4"),
std::string("M4/R1"),std::string("M4/R2"),std::string("M4/R3"),std::string("M4/R4"),
std::string("M5/R1"),std::string("M5/R2"),std::string("M5/R3"),std::string("M5/R4")}; 
