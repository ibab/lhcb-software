#ifndef VPNEWDIGITCREATOR_H 
#define VPNEWDIGITCREATOR_H 1
...
/** @class VPNewDigitCreator VPNewDigitCreator.h
 *  
 *
...
#ifdef DEBUG_HISTO
class VPNewDigitCreator : public GaudiTupleAlg {
#else
class VPNewDigitCreator : public GaudiAlgorithm {
#endif

public: 
  /// Standard constructor
  VPNewDigitCreator(const std::string& name, ISvcLocator* pSvcLocator);
  /// Destructor
  virtual ~VPNewDigitCreator();
