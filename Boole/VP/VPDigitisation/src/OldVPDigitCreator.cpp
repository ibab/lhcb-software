...
// Local
#include "OldVPDigitCreator.h"

using namespace LHCb;

//------------------------------------------------------------
// Implementation file for class : OldVPDigitCreator
//
// 20/09/2009 : Marcin Kucharczyk
//------------------------------------------------------------

// Declaration of the Algorithm Factory
DECLARE_ALGORITHM_FACTORY(OldVPDigitCreator)

//=============================================================================
// Constructor
//=============================================================================
OldVPDigitCreator::OldVPDigitCreator(const std::string& name, 
...
// Destructor
//=============================================================================
OldVPDigitCreator::~OldVPDigitCreator(){}

//=============================================================================
// Initialisation
//=============================================================================
StatusCode OldVPDigitCreator::initialize() {
...
//  Execution
//=============================================================================
StatusCode OldVPDigitCreator::execute() {
...
// Create VPDigits
//============================================================================
void OldVPDigitCreator::createDigits(const MCVPDigits* digitsMC, 
                                       LHCb::VPDigits* digitsCont)
{ // printf("OldVPDigitCreator::createDigits() =>\n");
  ...
  for(; iterMC != digitsMC->end(); ++iterMC) {                                   // for every MC hit
    ...
    if(totCharge>=500.0)
    { int Chip = aChan.chip();
      plot2D( Station, Chip, "HitsPerChip", "OldVPDigitCreator: number of hits/chip (all events)",
             -24.0, 24.0, 0.0, 12.0, 49, 12);
      plot(totCharge, "ChargePerPixel", "OldVPDigitCreator: charge/pixel [e]", 250.0, 25000.0, 99); }
#endif
