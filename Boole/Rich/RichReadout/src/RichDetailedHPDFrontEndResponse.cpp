...
#include "RichDetailedHPDFrontEndResponse.h"

// Declaration of the Algorithm Factory
static const  AlgFactory<RichDetailedHPDFrontEndResponse>  s_factory ;
const         IAlgFactory& RichDetailedHPDFrontEndResponseFactory = s_factory ;

// Standard constructor, initializes variables
RichDetailedHPDFrontEndResponse::RichDetailedHPDFrontEndResponse( const std::string& name,
...
RichDetailedHPDFrontEndResponse::~RichDetailedHPDFrontEndResponse (){ };

StatusCode RichDetailedHPDFrontEndResponse::initialize() {
...
StatusCode RichDetailedHPDFrontEndResponse::finalize()
{
  MsgStream log(msgSvc(), name());
...
StatusCode RichDetailedHPDFrontEndResponse::execute() {
...
StatusCode RichDetailedHPDFrontEndResponse::Analog() {
...
StatusCode RichDetailedHPDFrontEndResponse::Digital(){
