...
#include "RichSimpleHPDFrontEndResponse.h"

// Declaration of the Algorithm Factory
static const  AlgFactory<RichSimpleHPDFrontEndResponse>  s_factory ;
const         IAlgFactory& RichSimpleHPDFrontEndResponseFactory = s_factory ;

// Standard constructor, initializes variables
RichSimpleHPDFrontEndResponse::RichSimpleHPDFrontEndResponse( const std::string& name,
...
RichSimpleHPDFrontEndResponse::~RichSimpleHPDFrontEndResponse (){ };

StatusCode RichSimpleHPDFrontEndResponse::initialize() {
...
StatusCode RichSimpleHPDFrontEndResponse::finalize() {
...
StatusCode RichSimpleHPDFrontEndResponse::execute() {
...
StatusCode RichSimpleHPDFrontEndResponse::Simple() {
